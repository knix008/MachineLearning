...
demo = gr.Interface(
    ...
    inputs=[
        gr.Textbox(
            label="프롬프트 (Prompt)",
            value="A highly realistic, high-quality photo of a beautiful skinny girl on vacation. She is walking on a sunny beach wearing a red bikini, with a natural smile. The image should capture her in a full-body shot, with perfect anatomy. The overall atmosphere is bright and joyful.",
            lines=5,
        ),
        gr.Slider(
