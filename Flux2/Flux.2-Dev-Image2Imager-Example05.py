...
with gr.Blocks(title="FLUX.1 Image-to-Image") as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            prompt = gr.Textbox(
                label="Prompt",
                value="Make the bikini color to dark blue, move her face to see the viewer, make the image 8k resolution quality, high detail, high quality, best quality, masterpiece, cinematic lighting.",
                lines=3,
            )
