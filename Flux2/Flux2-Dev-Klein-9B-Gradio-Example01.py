...
device = "cpu"
dtype = torch.float32  # Use float16 instead of bfloat16 for MPS compatibility
...
with gr.Blocks(title="Flux 2 Klein 9B Image Generator") as demo:
    gr.Markdown("# Flux 2 Klein 9B Image Generator")
    ...
    with gr.Row():
        ...
        with gr.Column():
            # Output components
            output_image = gr.Image(label="Generated Image", type="pil", height=768)
