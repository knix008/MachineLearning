...
with gr.Blocks(title="Flux 2 Klein 9B Text-to-Image Generator") as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            # Output components
            output_image = gr.Image(label="Generated Image", type="pil", height=512, width=512)
