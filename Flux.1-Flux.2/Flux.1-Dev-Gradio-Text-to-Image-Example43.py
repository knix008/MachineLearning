...
DEFAULT_NEGATIVE = "Perfect anatomy, no extra fingers, no missing fingers, no fused fingers, no deformed fingers, no extra limbs, no distorted body, no blurry face, no bad anatomy, no anime, no cartoon, no illustration."
...
DEFAULT_POSE = "Kneeling on the wet floor, sitting back on her heels with both knees spread very wide apart, legs open as wide as possible. Thighs spread outward at a wide angle. Upright torso, back straight, chest forward. Full body visible from head to toe including both spread knees. Confident and sensual kneeling pose with legs wide open."
...
DEFAULT_LIGHTING = "Extremely low-key, near-dark overall lighting. Very dim single key light positioned to her left side, casting a faint, narrow beam of light across her body. The majority of the scene is shrouded in deep darkness. Only subtle highlights visible on her skin, hair, and the wet floor reflection. Heavy shadow dominates the entire image. Underexposed, dark and brooding cinematic atmosphere. Barely visible silhouette emerging from the shadows."
DEFAULT_CAMERA = "Canon EOS R5, 35mm f/2.8, ISO 200, 1/200s shutter. Camera positioned at a moderate distance from the subject, at eye level. Full body portrait shot from head to toe. Entire figure clearly visible with surrounding studio space. Background well-exposed and clearly visible."
