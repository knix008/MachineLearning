...
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic portrait of a young Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, softly wavy jet-black hair with gentle waves flowing down, with thick, straight-cut bangs (fringe) that frame her face. Her eyes are large and expressive, with long eyelashes. She has a small, delicate nose and full lips with a natural pink hue. Her cheeks have a subtle rosy blush, enhancing her youthful appearance. The overall look is elegant and captivating, with a focus on her facial features and the striking blue of her eyes."
...
DEFAULT_POSE = "She is sitting relaxed and naturally on a cozy café chair, holding a coffee cup with both hands, taking a sip. A wooden café table is placed in front of her with a coffee cup resting on a saucer. Her posture is comfortable and at ease. Body angled slightly toward the camera, legs crossed elegantly. A warm and candid café moment."
...
DEFAULT_CAMERA = "Eye-level shot capturing her from head to toe or a comfortable three-quarter shot. 85mm portrait lens with shallow depth of field, softly blurring the café background while keeping her in sharp focus. Natural, candid photography style."
