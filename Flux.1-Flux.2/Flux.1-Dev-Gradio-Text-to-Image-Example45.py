...
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic portrait of a young Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is warm and relaxed, looking naturally at the camera with a gentle smile. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face. Her eyes are large and expressive, with long lashes."
DEFAULT_OUTFIT = "Wearing a beautiful white dress (one-piece), elegant and feminine silhouette. The white fabric is clean and bright, flowing gracefully. Casual yet chic style suitable for a café outing."
