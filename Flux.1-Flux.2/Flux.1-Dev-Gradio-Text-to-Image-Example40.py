...
# https://prompthero.com/prompt/d0b4117cc74-flux-flux-11-pro-a-breathtaking-full-body-portrait-of-a-wolf-girl-wearing-a-dazzling-intricately-designed-gold-and-crystal-lingerie-set-that

# Default values for each prompt section
DEFAULT_QUALITY = "Breathtaking full-body portrait, 4k, ultra detail, high resolution, photorealistic, RAW photo, intricate details, sharp focus, cinematic and radiant composition, award-winning photography."
DEFAULT_NEGATIVE = "No extra fingers, no missing fingers, no fused fingers, no extra limbs, no distorted body, no blurry face, no bad anatomy."
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her silver hair. Her expression is innocent and curious, looking directly at the camera. She has long flowing silver hair cascading past her waist, with a few soft strands framing her face. She has fluffy silver wolf ears on top of her head. She has a fluffy silver wolf tail. Her overall look is youthful, ethereal, and captivating."
DEFAULT_OUTFIT = "Wearing a dazzling, intricately designed gold and crystal lingerie set that sparkles in the soft sunlight. The ensemble features ornate beadwork and a flowing, semi-transparent golden fabric that cascades to the floor like a train. The outfit is radiant with intricate details and rich textures."
DEFAULT_POSE = "Professional high-fashion model pose, body fully facing the camera. Weight shifted onto her right leg, left leg slightly extended forward with knee softly bent, creating an elegant S-curve silhouette. Right hand resting delicately on her right hip with fingers gently curved. Left arm hanging naturally with wrist slightly turned outward, fingers elegantly relaxed. Chin slightly tilted down, eyes looking directly and confidently into the camera. Shoulders back, posture perfect and elongated. Her silver wolf tail curling gracefully in the air behind her. Full body visible from head to toe."
DEFAULT_SETTING = "Standing in a luxurious bedroom with ornate vintage decor. Tall windows with sheer curtains in the background. Soft morning light streaming through the windows. Rich textures throughout the room including ornate furniture and warm-toned decor."
DEFAULT_LIGHTING = "Soft morning sunlight streaming through sheer curtains. Warm golden glow illuminating the room. Dreamy and elegant atmosphere with a balance of natural light and warm ambient glow. Soft shadows enhancing the cinematic mood."
DEFAULT_CAMERA = "Full-body portrait composition. Camera positioned at a slight angle to emphasize the side-on pose. Focus on the interplay of light, shadow, and the intricate details of the outfit. Cinematic depth with soft bokeh background."
