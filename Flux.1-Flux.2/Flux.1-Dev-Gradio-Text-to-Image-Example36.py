...
DEFAULT_QUALITY = "4k, ultra detail, high resolution, photorealistic, RAW photo, DSLR photography, realistic skin texture, not anime, not illustration, not cartoon."
...
DEFAULT_OUTFIT = "Very small, micro pink string bikini with minimal coverage, barely covering. Slender and toned figure. Delicate gold necklace, small gold hoop earrings. No hat. No sunglasses."
DEFAULT_POSE = "Lying fully relaxed on a luxury white padded sunbed, full body visible, facing upward. Looking directly at the camera with a soft and natural gaze. One arm beside body, other arm gently raised above head. One leg fully extended, the other leg slightly bent at the knee, not crossed or overlapping. Hair spread naturally around head on the pillow."
...
DEFAULT_CAMERA = "Canon EOS R5, 50mm f/2.0, ISO 200, 1/500s shutter. Camera positioned slightly above the subject, angled gently downward, not overhead. Shallow depth of field, beach and ocean softly blurred in background."
