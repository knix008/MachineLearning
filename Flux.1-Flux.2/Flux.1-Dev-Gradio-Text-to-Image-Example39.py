...
# https://prompthero.com/prompt/f29dfeda4cb-flux-flux-11-pro-ultra-a-professional-photo-of-a-exceptionally-of-the-most-beautiful-russian-girl-in-the-world-age-18-futuristicmasterpiece-realistic-perfect

# Default values for each prompt section
DEFAULT_QUALITY = "Perfect anatomy, no extra fingers, no missing fingers, no fused fingers, no extra limbs, no distorted body, no blurry face."
DEFAULT_NEGATIVE = "Perfect anatomy, no extra fingers, no missing fingers, no fused fingers, no extra limbs, no distorted body, no blurry face, no anime, no cartoon, no illustration, no manga, no CGI, no digital art, no painting."
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long flowing silver hair, loose and cascading naturally past her waist, with soft waves and a few strands gently framing her face. Her face is heart-shaped with a small, delicate nose, full lips, and large, expressive eyes. She appears to be around 20 years old. Her overall look is youthful, fresh, and captivating."
DEFAULT_OUTFIT = "Wearing an extremely tiny black sheer mesh bikini, black see-through mesh fabric, almost no coverage at all. Ultra-minimal black sheer mesh triangle top with thin black string ties, barely covering, completely see-through. Ultra-minimal black sheer mesh G-string bikini bottoms with thin black string sides, barely covering, completely see-through. The delicate black mesh fabric is translucent and reveals the body beneath. Slender, fit, and toned figure. Delicate gold necklace."
DEFAULT_POSE = "Standing tall and confident on the beach, body fully facing the camera. Weight shifted slightly onto one leg in a relaxed stance. One hand resting lightly on her hip, the other hanging naturally at her side. Head held high, looking directly at the camera with a confident and composed expression. Full body visible from head to toe, front-facing.  Her one hand is touch her hair."
DEFAULT_SETTING = "Standing on a pristine white sandy beach. The background shows a wide open sparkling turquoise ocean with gentle rolling waves and a clear blue sky with soft wispy clouds. The beach stretches endlessly behind her. Fine white sand beneath her feet. No city. No buildings. No palm trees."
DEFAULT_LIGHTING = "Bright warm tropical sunlight from slightly above and behind the camera. Golden glow on her skin with soft natural highlights. Radiant sun-kissed luminosity. Light ocean breeze. Soft shadows beneath her. Clean, vibrant, and fresh beach atmosphere."
DEFAULT_CAMERA = ""
