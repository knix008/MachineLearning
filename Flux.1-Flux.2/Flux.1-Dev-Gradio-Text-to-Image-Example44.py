...
DEFAULT_QUALITY = "Ultra HD, photorealistic, 8K resolution, sharp focus, detailed skin texture, natural outdoor lighting, luxury lifestyle photography."
DEFAULT_NEGATIVE = "Perfect anatomy, no extra fingers, no missing fingers, no deformed fingers, no fused fingers, no extra limbs, no distorted body. Perfect body structure."
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic cosplay portrait of a young Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair completely drenched and soaking wet, strands clinging to her face, neck, shoulders and back. Wet hair dripping water down her body. Her eyes are large and expressive, with long lashes. Her entire body is dripping wet, water beads rolling down her skin. Glistening wet skin reflecting sunlight. Water streaming down her arms, torso, and legs. The overall look is elegant and alluring, with a hint of playfulness."
DEFAULT_OUTFIT = "Wearing an extremely tiny string pink bikini with barely-there coverage. The bikini top consists of minuscule triangles held by ultra-thin strings, barely covering her chest. The matching bottoms are extremely minimal with thin side-tie strings, just enough to cover. The soaking wet fabric clings tightly to her body, the wet material shimmering in the sunlight. Water dripping from the wet fabric."
DEFAULT_POSE = "Just emerged from the swimming pool, standing at the pool edge. Body arched slightly backward with one hand running through her wet hair. Hip tilted to one side in a provocative stance. Chest forward, back gently arched. Seductive and confident pose, water streaming down her curves."
DEFAULT_SETTING = "Luxurious five-star hotel outdoor swimming pool. Crystal clear turquoise pool water glistening behind her. Bright blue sky with soft clouds. Exclusive resort ambiance."
DEFAULT_LIGHTING = "Bright warm golden afternoon sunlight. Sun directly overhead creating a beautiful shimmer on her wet skin and soaked bikini. Pool water reflecting rippling light caustics onto her body. High-key bright and vibrant exposure. Soft fill light from the pool surface eliminating harsh shadows."
DEFAULT_CAMERA = ""
