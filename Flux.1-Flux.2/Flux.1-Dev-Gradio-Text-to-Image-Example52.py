...
# https://prompthero.com/prompt/df796aae15d-gonzalomo-dmd-v20-flux-d-aio-a-tall-curvy-young-female-with-long-sun-kissed-wavy-red-hair-cascading-over-her-shoulders-stands-on-a-sunlit
...
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her head is facing directly forward, eyes looking straight into the camera with an innocent and curious expression. She has long, slightly wavy jet-black hair neatly tied back in a loose ponytail, with a glossy, healthy shine. A few soft strands frame her face gently."
DEFAULT_OUTFIT = "She wears a sheer, flowing robe that flutters in the salty breeze, revealing a minimal, micro-sized plain see-through pink bra and thong panty underneath, barely covering, delicate and sensual."
DEFAULT_POSE = "Full body shot, standing on a sunlit balcony in a confident model pose. Body and head both facing directly forward toward the camera. Shoulders squared, chin slightly lifted, weight evenly balanced. One hand resting lightly on the balcony railing. Posture tall, poised, and elegant like a professional fashion model. Hair tied back neatly."
DEFAULT_SETTING = "A beach house balcony overlooking a vast, shimmering ocean. The balcony is framed by weathered wood and glass panels, warm golden sunlight flooding the scene."
DEFAULT_LIGHTING = "Sunlight casting warm golden highlights across the scene. Modern cinematic and impressionistic lighting, capturing both the intimacy of the moment and the grandeur of the seascape."
DEFAULT_CAMERA = "Documentary photographic style, hyper-realistic detail. Full body portrait, eye-level shot, shallow depth of field with the ocean horizon softly blurred in the background."
