...
DEFAULT_OUTFIT = "She is wearing a loose, flowing white sundress. The dress slips loosely off one shoulder, casually exposing one bare shoulder and collarbone in a natural, effortless way. The soft white fabric drapes elegantly over her figure."
DEFAULT_POSE = "Full body shot, walking gracefully along the beach shoreline toward the camera. Natural and relaxed walking gait, one foot stepping forward. Both arms hanging naturally down at her sides, swinging loosely with the rhythm of walking. Body and head facing directly forward toward the camera. Head held high, gazing straight into the camera with a confident expression. Hair flowing freely in the sea breeze."
...
DEFAULT_CAMERA = "Full body candid shot from a moderate distance, as if photographed from afar without her awareness. 200mm telephoto lens, slight zoom compression. Natural documentary style, resort buildings and ocean softly blurred in the background. Candid lifestyle beach photography."
