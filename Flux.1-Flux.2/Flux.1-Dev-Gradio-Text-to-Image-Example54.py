...
DEFAULT_APPEARANCE = "A high-quality, photorealistic portrait of a Korean woman, approximately 38 years old, with a tall and slender figure standing around 174cm. She has a fair, clear complexion with a mature yet youthful beauty. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is confident and alluring, gazing naturally. She has long, voluminous wavy jet-black hair with beautiful soft waves and curls, dramatically flowing and billowing in the wind, strands sweeping through the air with natural movement and body, full of life and dynamism."
DEFAULT_OUTFIT = "She is wearing an extremely tiny and nearly transparent sheer black lingerie set, barely covering her body. The ultra-thin black fabric is almost see-through, delicate and sensual. The lingerie consists of a sheer black bralette and matching sheer black micro panties, the transparent fabric clinging softly to her skin."
