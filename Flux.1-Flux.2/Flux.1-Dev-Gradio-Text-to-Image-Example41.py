...
DEFAULT_QUALITY = "4k, ultra detail, high resolution, photorealistic, RAW photo, ultra-realistic skin texture, sharp focus, award-winning photography, kpop idol."
...
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her black hair. Her expression is innocent and curious, looking directly at the camera. She has long flowing black hair cascading past her waist, with a few soft strands framing her face. Her overall look is youthful, ethereal, and captivating. 38-year-old Korean female idol. She has fair skin and a brightly smiling expression. Beautiful eyes with a moist and gentle look, long slit eyes. Thin lips. Realistic girl face. Beautiful skin with ultra-realistic skin texture."
DEFAULT_OUTFIT = "She is wearing a stylish tiny string light blue bikini with minimal coverage."
DEFAULT_POSE = "Standing on the beach, full body visible, facing the camera. Natural and confident pose."
DEFAULT_SETTING = "On the beach, sandy shore, ocean in the background, clear sky."
DEFAULT_LIGHTING = "Wet body with moisture effect. Bright natural sunlight. Cinematic lighting."
