...
DEFAULT_POSE = "Standing directly facing the camera on the beach in a seductive model pose. Full body shot, body fully facing forward. Hips pushed forward and tilted slightly to one side, accentuating curves. Both hands resting on hips with elbows out. Chest subtly pushed forward. Weight on one leg with the other leg slightly bent and stepped to the side. Head held high, lips slightly parted, gazing directly into the camera with a confident and alluring expression. Hair flowing gently in the sea breeze."
