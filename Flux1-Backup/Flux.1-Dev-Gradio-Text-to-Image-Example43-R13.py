...
DEFAULT_POSE = "She is standing upright on the wet floor with her knees. Her knees spread wide apart, thighs stand upright and spread open at a wide angle, full body facing the camera. Both arms raised and spread wide apart, elbows pointing far outward to each side. Both hands hidden behind the head, not visible from the camera angle. Elbows open wide. Back arched seductively, chest thrust forward, waist pulled in tightly to emphasize the hourglass curve. Hips tilted to one side with a prominent S-curve. Chin slightly lowered, lips parted softly, heavy-lidded eyes gazing down at the camera with an intensely smoldering, seductive expression."
