...
DEFAULT_POSE = "Standing upright with both knees on the floor, Both arms raised upward, hands interlaced behind the neck, elbows pointing outward and upward. Head tilted slightly to one side. Camera angle is low, looking up at her from near the floor, emphasizing her long legs and high hips. Her gaze is directed down toward the camera with a sultry expression. The pose accentuates her curves and creates a dynamic, seductive composition."
...
DEFAULT_CAMERA = "Full body shot from head to toe. Low-angle shot, camera positioned near the floor pointing steeply upward. Subject fills the frame. Sharp focus on the subject. Shallow depth of field, soft bokeh background. Professional studio photography. Shot with a 35mm lens."
