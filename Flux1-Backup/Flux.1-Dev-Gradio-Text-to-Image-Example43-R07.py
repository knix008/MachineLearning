...
DEFAULT_QUALITY = "8k resolution, photorealistic, high quality, gravure photography style, cinematic soft focus"

DEFAULT_NEGATIVE = ""

DEFAULT_SUBJECT = "A high-resolution studio photograph of a young Korean woman kneeling on a wet reflective floor, arms raised with hands behind her head, in a confident and alluring pose."
DEFAULT_APPEARANCE = "She has a fair, clear complexion with soft natural makeup and slightly rosy cheeks. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is calm and confident, gazing directly and steadily into the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face, falling naturally over her shoulders."

DEFAULT_OUTFIT = "Wearing a tiny, minimalist metallic shimmery blue triangle bikini top with thin string ties at the neck and sides, barely covering her chest. The matching bottoms are small string bikini bottoms with thin side ties. The metallic blue fabric has a sparkly, shimmery texture that glistens under the studio light. Barefoot, kneeling directly on the floor."

DEFAULT_POSE = "Tall-kneeling upright on both knees on the floor, thighs vertical, body tall and straight. Both arms raised upward, both hands placed behind her head with fingers loosely interlaced, elbows pointing outward to the sides. Upper body fully erect, torso facing directly forward toward the camera. Chest open and forward. Framing from just below the knees to above the head. Confident, composed, alluring kneeling pose."

DEFAULT_SETTING = "Minimalist dark studio setting. Deep dark gray to near-black seamless background. The floor is covered with a thin layer of water, creating a highly reflective wet surface with small puddles and water droplets glistening around the knees. Moody and cinematic atmosphere."

DEFAULT_LIGHTING = "Soft front studio lighting evenly illuminating the subject. Gentle key light from slightly above and front, giving the skin a clean, luminous glow. Subtle edge highlight along the silhouette. Dark background with moderate contrast. Clean and polished studio photography look."

DEFAULT_CAMERA = "Three-quarter body shot from just below the knees to the top of the head. Camera positioned at eye level to the kneeling subject. Sharp focus on the face and body. Shallow depth of field, soft bokeh on the dark background. Professional studio photography. Shot with a 50mm lens."
...
def combine_prompt_sections(
    quality, negative, subject, appearance, outfit, pose, setting, lighting, camera
):
    """Combine separate prompt sections into one final prompt string."""
    sections = [quality, negative, subject, appearance, outfit, pose, setting, lighting, camera]
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                prompt_subject = gr.Textbox(
                    ...
                    lines=2,
                    placeholder="예: A stunning photorealistic image of a young woman",
