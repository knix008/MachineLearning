...
DEFAULT_SUBJECT = "A photorealistic gravure-style full-body portrait of a beautiful young skinny Korean woman with a soft, idol aesthetic."

DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious. She has long, wavy jet-black hair with thick, straight-cut bangs (fringe) that frame her face."

DEFAULT_POSE = "Standing naturally facing forward in a bright white room, with her entire body fully visible from head to toe. Her hips are slightly tilted to one side to accentuate her curves. One hand is gently touching the rim of her glasses, while her other arm is raised to support her chest. Her posture is upright and relaxed, looking directly at the camera. She exudes elegance and confidence in a natural way."

DEFAULT_OUTFIT = "Wearing a stylish office outfit: an extremely short, tight black mini skirt and a skin-tight, highly transparent white blouse that perfectly hugs her body, making her black bra clearly visible underneath. Wearing sheer black stockings. Wearing golden edged glasses. Wearing black high heels."

DEFAULT_SETTING = "The background features sheer white curtains and a blurred city view through the window grid. Bright white room, window seat, faux fur texture."

DEFAULT_LIGHTING = "Bright natural daylight, high-key lighting, elegant boudoir aesthetic. Photorealistic, gravure style, elegant, airy."

DEFAULT_CAMERA = "85mm telephoto, chest-level full body shot, tack-sharp focus on subject, soft bokeh background."
