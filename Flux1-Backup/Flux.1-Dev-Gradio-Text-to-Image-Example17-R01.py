...
DEFAULT_SUBJECT = "A photorealistic, high-quality image of a young skinny Korean woman with a soft, idol aesthetic."
...
DEFAULT_OUTFIT = "She wears a very small, minimal light pink triangle bra with extremely thin and matching light pink micro panties. She wears tall, upright blue fabric bunny ears with white inner lining and a delicate white headband base, accented with a small white bow. Around her neck is a blue bow tie attached to a white collar. She wears long, white mesh fingerless arm sleeves that extend past her elbows, finished with blue cuffs and small black decorative ribbons. She wears white mesh stockings held up by blue and white ruffled garters adorned with small white bows."
DEFAULT_POSE = "Tall-kneeling pose: both knees on the floor, thighs strictly vertical and perpendicular to the ground, hips raised high above the heels, body held upright as if standing. Shins flat behind her on the floor. Body facing the camera directly. Both arms raised high and spread wide apart, elbows bent and pointing broadly outward to each side, hands interlaced behind her neck. Armpits fully exposed, arms forming a wide open V-shape. Hips pushed upward and forward, pelvis tilted to accentuate the curves. Waist slightly twisted to one side to create a natural S-curve silhouette. Chest pushed forward, waist pinched inward. Glamorous and seductive pose."
DEFAULT_SETTING = "Minimalist dark studio setting with a deep dark near-black seamless background. The floor is covered with a thin layer of water, creating a highly reflective wet surface. Her reflection visible in the water beneath her. Puddles of water surrounding her, glistening under the light. Softly blurred background (bokeh)."
DEFAULT_LIGHTING = ""
DEFAULT_CAMERA = "Full body shot from head to knees. Low-angle shot, camera positioned near the floor pointing upward. Soft bokeh background. Shot with a 35mm lens."
