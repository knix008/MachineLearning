...
DEFAULT_OUTFIT = "She wears an extremely tiny micro red string bikini top, the triangles are the smallest possible size barely covering only the nipples, thin string ties, plain smooth fabric, absolute maximum skin exposure on chest and torso. Extremely tiny micro red string bikini bottom, the smallest possible size barely covering only the groin, thin string sides, plain smooth fabric, exposing entire stomach, hips, thighs fully. Headwear: tall, upright blue fabric bunny ears with plain white inner lining and a plain white headband, accented with a small white bow."
DEFAULT_POSE = "Lying on the bed, full body extended lengthwise. Body gently curved in a subtle S-shape, back slightly arched. Both arms resting loosely at the sides, both hands placed naturally flat on the bed surface. One leg fully extended, other leg bent at the knee slightly to the side. Lips softly parted, sultry gaze looking directly up at camera. Full body visible head to toe."
DEFAULT_SETTING = "King-size bed with dark navy satin sheets, rumpled naturally. Decorative pillows. Dimly lit upscale hotel bedroom, moody elegant interior."
