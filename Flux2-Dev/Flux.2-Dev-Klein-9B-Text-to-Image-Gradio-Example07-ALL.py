...
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear and flawless complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face. She is looking directly at the camera."
DEFAULT_OUTFIT = "She is wearing a matching set of tiny, skimpy white bra and white panties. The bra is a small triangle bralette with thin straps. The panties are small and minimal coverage."
DEFAULT_POSE = "Full body shot from head to toe. She is standing on the floor facing directly forward toward the camera. Her body is facing straight ahead, not angled. One hand is on her hip and the other is gently touching her hair. Her legs are slightly apart in a confident innerwear model stance."
DEFAULT_SETTING = "The background features a bright blue diamond-patterned wall and large grid windows overlooking a blurred city. Clean, polished studio floor."
DEFAULT_LIGHTING = "Bright, even studio lighting, cinematic lighting, dramatic contrast, high-key lighting that highlights her figure and the lingerie details, soft rim light accentuating her silhouette."
DEFAULT_CAMERA = "Full body portrait shot with Canon EOS R5, 35mm f/1.8 lens, ISO 100, wide enough to capture entire body from head to feet, shallow depth of field, sharp focus on subject, natural color grading, innerwear catalog photography."
...
def main():
    ...
    with gr.Blocks(
        title="Flux.2 Klein 9B Text-to-Image Generator",
    ) as interface:
            ...
            with gr.Column(scale=1):
                ...
                with gr.Row():
                    guidance_scale = gr.Slider(
                        ...
                        step=0.1,
                        value=0.5,
                        info="프롬프트 준수도. 낮으면 창의적, 높으면 정확. 권장: 0.3-0.7",
                    )
