...
if device_type == "cuda":
    ...
    print("Memory optimization: sequential CPU offload, model CPU offload, attention slicing (CUDA)")
    ...
    pipe.enable_model_cpu_offload()
    pipe.enable_attention_slicing()
    print("Memory optimization: sequential CPU offload, model CPU offload, attention slicing (CPU)")
