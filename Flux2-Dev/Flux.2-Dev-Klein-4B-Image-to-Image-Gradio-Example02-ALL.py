...
DEFAULT_PROMPT = "Show her back. She kneels down on the bed. Cinematic lighting, 4k, ultra-detailed texture, with perfect anatomy, fashion vibe."
...
def main():
    ...
    with gr.Blocks(title="Flux.2 Dev 4B Image-to-Image 편집기") as demo:
        gr.Markdown("# Flux.2 Dev 4B Image-to-Image 편집기")
