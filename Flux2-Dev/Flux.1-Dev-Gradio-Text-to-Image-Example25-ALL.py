...
DEFAULT_POSE = "Full body shot from head to toe. She is standing on the floor facing directly forward toward the camera. Her body is facing straight ahead, not angled. Her hands are naturally down like a fashion model. Her legs are slightly apart in a confident innerwear model stance."
