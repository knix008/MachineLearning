...
#DEFAULT_PROMPT = "She is wearing a red bra and pantie with a red long bunny ear on her head. She looks like a instagram-style girl. Slim, skinny, perfect body model shape, perfect anatomy, perfect hands, perfect toes, perfect proportions, detailed face, intricate details, high quality, 4k, sharp focus, masterpiece, best quality, ultra-detailed, cinematic lighting, highly detailed."
...
def generate_image(
    ...
    output_path = os.path.join(
        script_dir,
        f"{script_name}_{timestamp}_{device_type}_guidance{guidance_scale}_steps{int(num_inference_steps)}_seed{int(seed)}_seqlen{int(max_sequence_length)}.png",
    )
