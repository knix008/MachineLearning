...
def print_system_info():
    ...
    # 디바이스 정보
    print("-" * 60)
    print(f"디바이스: {DEVICE.upper()} (Apple Silicon)")
...
def main():
    ...
    try:
        ...
        with gr.Blocks(title="Flux Klein 9B 다중 이미지 생성기 (MacOS)") as demo:
            gr.Markdown("# Flux Klein 9B Multi-Image Generator (MacOS)")
            gr.Markdown(
