...
#DEFAULT_PROMPT = "A sparkling-eyed young woman with a stylish beach bag, cute denim skirt, realistic crop top, beautiful detailed body and face, beautiful model young korean girl, gorgeous sundress model, photorealistic, beautiful anime woman, beautiful body, attractive pose, attractive face and body, beautiful anime woman --niji 5 --ar 9:16"

#DEFAULT_PROMPT = "A sparkling-eyed young woman with a stylish beach bag, cute denim skirt, realistic crop top, beautiful detailed body and face, beautiful model young korean girl, gorgeous sundress model, photorealistic, beautiful woman, beautiful body, attractive pose, attractive face and body, --niji 5 --ar 9:16"

# https://prompthero.com/prompt/3d816e12872-flux-flux-11-pro-oil-painting-on-canvas-young-korean-woman-wearing-a-vibrant-red-hanbok-facing-the-camera-directly-with-a-serene-and

#DEFAULT_PROMPT = "Oil painting on canvas, young Korean woman wearing a vibrant red hanbok, facing the camera directly with a serene and expressive gaze. Rich impasto brushstrokes, visible texture, warm light enhancing the folds of the red silk fabric. Her hair arranged in a simple traditional updo with subtle ornaments. Background softly painted in muted tones, giving a poetic, refined, and art-gallery aesthetic. High detail, high-resolution, emotional and timeless.”
