...
DEFAULT_NEGATIVE = "Perfect anatomy, perfect arms and hands structure, no extra fingers, no extra toes, no extra hands, no extra arms, no missing fingers, no fused fingers, no mutated fingers, no disfigured fingers."
DEFAULT_APPEARANCE = "A full body photo of a beautiful Korean woman with a soft idol aesthetic. She has a fair, clear complexion and striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face."
...
DEFAULT_POSE = "She is standing on the floor in front of a light-colored vintage-style bed. Her body is slightly angled toward the camera, creating a soft and inviting posture. One hand gently and naturally touching her hair, and the other hand naturally resting at her side near her thigh. She is looking at the camera with a soft, innocent expression. Full body shot from head to toe, with both shoulders fully visible and uncut, showing her complete outfit including her bunny ears, bodysuit, lace sleeves, fishnet stockings, and shoes. She is crossing her legs."
...
DEFAULT_QUALITY = "Detailed textures of denim and lace, gravure photography style, high-key lighting, airy atmosphere, studio photography, innocent and alluring, blue bunny girl, denim, white lace, blue contact lenses, black hair with bangs, fishnet stockings. 8k resolution, high-quality, masterpiece, best quality, ultra-detailed, highly detailed skin, cinematic soft focus."
