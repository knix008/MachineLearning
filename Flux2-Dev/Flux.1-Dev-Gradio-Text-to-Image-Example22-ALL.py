...
# Reference Site : https://prompthero.com/prompt/4017aa07598-flux-dev-this-is-an-image-of-a-sexy-naked11-woman-in-her-bed-at-night-her-eyes-are-closed-and-her

# Default values for each prompt section
DEFAULT_QUALITY = "4k, ultra-detailed, high-quality, raw photo, realistic, photorealistic, masterpiece, best quality, extremely detailed, high resolution, extremely intricate details, highly detailed skin, enhanced contrast, clear shadows and highlights"
...
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face. Her eyes is closed and her mouth slightly open. She has long tousled brunette hair spread out across her pillow."
DEFAULT_OUTFIT = "Her panties are lace and revealing."
DEFAULT_POSE = "She is lying in her bed. One hand is at the side of her face. Her hips are turned putting her slightly on her side. Her legs are bent and slightly apart. The camera angle is from above, looking down at her, capturing her full body and the bed around her."
DEFAULT_SETTING = "A dark bedroom at night. Moonlight is shining through the window behind her which is covered in curtains. Silhouette style, casting shadow style."
DEFAULT_LIGHTING = "Moonlight casting through curtains, dramatic shadows and highlights, low-key lighting, natural moonlight glow on skin, intense contrast between light and shadow, cinematic night atmosphere."
DEFAULT_CAMERA = "Shot with Canon EOS R5, 85mm f/1.4 lens, ISO 800, shallow depth of field, sharp focus on subject, natural color grading, low light photography."
