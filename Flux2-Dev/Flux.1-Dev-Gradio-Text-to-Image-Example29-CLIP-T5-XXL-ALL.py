...
def load_model(device_name=None):
    ...
    print("CLIP + T5-XXL 텍스트 인코더를 함께 사용합니다.")
...
def generate_image(
    ...
    try:
        ...
        # Pass prompt directly to the pipeline
        pipe_kwargs = {
            "prompt": prompt,
            "width": width,
            "height": height,
