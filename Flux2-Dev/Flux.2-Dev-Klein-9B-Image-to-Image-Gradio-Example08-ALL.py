...
DEFAULT_QUALITY = ""
DEFAULT_NEGATIVE = "Perfect anatomy, missing fingers, no extra fingers, no malformed fingers, no fused fingers. no missing toes, no extra toes, do deformed toes, no fused toes."
DEFAULT_APPEARANCE = ""
DEFAULT_OUTFIT = "She wears a small high legged string pink bikini. Around her neck is a blue bow tie attached to a white collar. She wears long, white floral lace fingerless sleeves that extend past her elbows, finished with blue cuffs and small black decorative ribbons. She wears white fishnet stockings held up by blue and white ruffled lace garters adorned with small white bows. She wears a headband with bunny ears. The outer surface of the bunny ears is solid blue fabric, while the inner facing surface is distinctly white lace, clearly visible and contrasting against the blue exterior. The bunny ears are attached to a delicate white lace headband base accented with a small white bow."
DEFAULT_POSE = "She is lying on a sunbed in a classic bikini model pose, body stretched out gracefully, one leg slightly bent, both hands resting naturally and lightly touching her thighs, full body visible from head to toe."
DEFAULT_SETTING = "Sunny beach hotel poolside, bright sunlight, sunbed with white towel, tropical background."
DEFAULT_LIGHTING = "Natural sunlight, soft and warm, not overly bright, gentle diffused daylight."
DEFAULT_CAMERA = "Overhead top-down angle, bird's eye view, full body shot, wide frame showing entire body from head to toe on the sunbed."
