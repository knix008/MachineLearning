...
DEFAULT_NEGATIVE = "Perfect anatomy, perfect fingers, perfect toes, no extra fingers, no missing fingers, no deformed hands, no mutated limbs, no extra limbs, no blurry image."
...
DEFAULT_OUTFIT = "She wears tall, upright blue fabric bunny ears with white lace inner lining and a delicate white lace headband base, accented with a small white bow. She wears a unique blue denim-textured bodysuit with a front zipper, silver buttons, and thin silver chains draped across the chest. The sides are constructed from semi-sheer white lace. Around her neck is a blue bow tie attached to a white collar. She wears long, white floral lace fingerless sleeves that extend past her elbows, finished with blue cuffs and small black decorative ribbons. She wears white fishnet stockings held up by blue and white ruffled lace garters adorned with small white bows."
DEFAULT_POSE = "She is standing gracefully in front of the edge of a light-colored, vintage-style bed or cushioned bench. Her body is slightly angled toward the camera, creating a soft and inviting posture."
...
DEFAULT_QUALITY = "High-quality, photorealistic, 8k resolution."
DEFAULT_CAMERA = "Cosplay portrait, full body shot."
...
def load_model(device_name=None):
    ...
    if DEVICE == "cuda":
        ...
        print("메모리 최적화 적용: attention slicing, channels last (MPS)")
...
def main():
    ...
    with gr.Blocks(
        title="Flux.1-Kontext Text-to-Image Generator",
    ) as interface:
        gr.Markdown("# Flux.1-Kontext Text-to-Image Generator")
        gr.Markdown(
