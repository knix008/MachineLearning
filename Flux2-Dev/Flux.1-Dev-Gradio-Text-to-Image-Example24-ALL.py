...
DEFAULT_QUALITY = "8k resolution, photorealistic, hyper-realistic skin texture, cinematic, raw photo, ultra-detailed, high-quality, masterpiece, best quality, extremely detailed, highly detailed skin, natural light diffusion, commercial fashion photography"
...
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face. Her expression is bright, cheerful, and energetic, looking directly up into the camera lens with a wide, toothy smile."
DEFAULT_OUTFIT = "Lingerie: A matching pale pink mesh lingerie set (bralette and panties). Bottoms: Baggy, light-wash blue denim jeans, unbuttoned and unzipped, pulled down slightly to rest low on her hips, fully revealing the waistband of her underwear. Footwear: Chunky white dad sneakers."
DEFAULT_POSE = "High-angle full-body shot captured from a distinct high angle, looking down at the subject. She is sitting on a silver metal stool with her legs spread wide apart in a relaxed, confident stance. Her hands rest on the seat of the stool behind her for support, leaning her torso slightly forward."
DEFAULT_SETTING = "A bright white seamless infinite studio backdrop. Clean, minimalist commercial fashion photography set."
DEFAULT_LIGHTING = "High-key, bright, and even lighting, typical of commercial fashion photography. Minimizes shadows and makes colors pop against the white background."
DEFAULT_CAMERA = "Shot with Canon EOS R5, 35mm f/1.8 lens, ISO 100, high-angle shot looking down, sharp focus on subject, natural color grading, raw photo aesthetic."
