...
# Reference Site : https://prompthero.com/prompt/879d467c833-z-image-turbo-a-photorealistic-gravure-style-shot-of-a-beautiful-asian-woman-standing-on-a-sunlit-city-balcony-she-has-brown-hair

# Default values for each prompt section
DEFAULT_QUALITY = "8k resolution, photorealistic, realistic skin texture, Japanese gravure, ultra-detailed, high-quality, raw photo, masterpiece, best quality, extremely detailed, highly detailed skin"
...
DEFAULT_APPEARANCE = "A beautiful slim Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face. She is smiling softly. She is holding a white coffee mug with both hands near her face."
DEFAULT_OUTFIT = "She is wearing an oversized, textured cream knit cardigan that is draped open to reveal her bare chest and midriff. She wears a pastel tone pantie."
DEFAULT_POSE = "She is standing on a sunlit city balcony, leaning against a beige wall. She holds the coffee mug near her face with both hands. Casual morning vibe, casual sensual."
DEFAULT_SETTING = "A sunlit city balcony. The background is a blurred urban cityscape. Foreground bokeh. Bright and sunny atmosphere."
DEFAULT_LIGHTING = "Bright natural sunlight, high-key lighting, strong highlights on her skin and clothes, creating a warm and inviting morning atmosphere."
DEFAULT_CAMERA = "Shot with Canon EOS R5, 85mm f/1.4 lens, ISO 100, shallow depth of field, soft focus background, sharp focus on subject, natural color grading, gravure-style photography."
