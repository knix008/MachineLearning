    ...
    try:
        ...
        if negative_prompt:
            ...
            if "negative_prompt" in sig.parameters:
                ...
                print("경고: 현재 모델은 negative_prompt를 지원하지 않습니다. 무시됩니다.")
...
def main():
    ...
    # Auto-load model on CUDA at startup
    initial_status = load_model(DEVICE)
        ...
        with gr.Row():
            with gr.Column(scale=1):
                device_selector = gr.Radio(
                    ...
                    value=DEVICE,
                    info="모델을 실행할 디바이스를 선택하세요. 다른 디바이스를 선택한 후 '모델 로드'를 눌러주세요.",
                )
                ...
                negative_prompt = gr.Textbox(
                    ...
                    lines=2,
                    placeholder="예: blurry, low quality, distorted, deformed",
