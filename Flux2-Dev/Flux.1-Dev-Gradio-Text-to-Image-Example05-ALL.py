...
DEFAULT_PROMPT = "The image is a vertical, ultra-high-quality digital illustration featuring a beautiful young korean woman in a sunlit indoor setting. The style combines stylized facial features with hyper-realistic textures and cinematic lighting. The camera on the floor, captured the image from a dramatic low-angle perspective. The Character: Appearance: She has a fair complexion with a soft pink blush, striking crystalline blue eyes, and a neutral,direct gaze.Hair: Her hair is long, voluminous, and styled in rich chocolate-brown curls that cascade over her shoulders. Skin: Her skin is rendered with an extremely high-gloss, wet or oily finish, creating brilliant white specular highlights on her thighs,midriff, and shoulders. Pose: She is standing in front of a sofa in a relaxed yet powerful pose. The low-angle hero shot emphasizes her stature as she looks down toward the camera with one knee raised with little smile on her face. Attire: Top: A form-fitting, cream-colored or off-white sports bra made of a high-shine, latex-like material with a small gold script logo on the band.Bottom: Vibrant yellow high-cut thong-style bikini bottoms. Legwear: She wears thick, slouchy yellow ribbed socks scrunched down around her ankles. Setting & Background: Location: A bright, luxurious, and minimalist living room. Furniture: She is seated on an ivory-white tufted leather or vinyl sofa.Decor: Lush green tropical plants in pots are visible on both sides, partially framing the shot. Backdrop: In the background is a large window with wooden frames and soft beige curtains,allowing bright natural light to fill the room. Lighting: Effect: The scene is bathed in intense, soft natural sunlight. This creates high-contrast highlights on the reflective surfaces (skin and sports bra) and soft, warm shadows in the room, resulting in a clean and professional editorial look. 8k, ultra-detailed, cinematic lighting, hyper-realistic textures, stylized facial features, dramatic low-angle perspective. Key Stylistic Keywords: High-gloss skin, latex sports bra, yellow bikini bottoms, slouchy socks, low-angle hero shot, bright natural light, minimalist living room, tropical plants, cinematic lighting, ultra-detailed digital illustration."
