...
DEFAULT_SUBJECT = "A photorealistic overhead top-down aerial view of a beautiful young skinny Korean woman lying in a bathtub, chest, torso, and hips fully submerged beneath water. Visible above the water surface: both arms, neck, face, and the upper portion of both thighs and legs."

DEFAULT_APPEARANCE = "She has a fair, clear complexion and dark hair tightly pulled back and tied up in a wet bun at the back of her head, hair completely soaking wet, drenched and dripping with water, strands clinging to her neck. Her expression is serene and relaxed, eyes gently open revealing striking bright blue contact lenses. Skin is visibly wet and glistening, water droplets covering her face, neck, arms, and legs, a moist sheen reflecting soft candlelight across her damp dewy skin."

DEFAULT_POSE = "She is lying in the bathtub with her chest, torso, abdomen, and hips fully submerged under clear transparent water, waterline sitting exactly at the hip-to-thigh boundary, hips completely underwater. Above the waterline: both arms, neck, face, and the upper portion of both thighs are clearly visible. One arm is raised with the hand lightly touching her chin, index finger gently resting against her chin in a thoughtful pose. Her other arm is fully extended and resting on top of her legs, hand and forearm laid relaxedly across her shins."

DEFAULT_OUTFIT = "Completely bare, chest, torso, and hips submerged beneath semi-transparent bath water, body faintly visible beneath the milky translucent water. White foam bubbles densely concentrated between the chest and the upper thighs, fully covering and concealing that area. Scattered white foam bubbles also spread across the rest of the water surface. Arms and upper thighs above the waterline are clearly visible and uncovered. Red and white flower petals floating on the water surface among the foam."

DEFAULT_SETTING = "White ceramic bathtub filled with warm semi-transparent milky bath water, water is translucent with a soft hazy appearance, body faintly visible beneath. White foam bubbles densely clustered between the chest and upper thighs concealing that area, with scattered foam bubbles also spread across the entire remaining water surface. Multiple vivid red rose petals and white flower petals floating on the water surface. Several lit candles placed at the head end of the bathtub, flickering warm flame, melting wax, soft candlelight glow. Soft spa-like bathroom setting."

DEFAULT_LIGHTING = "Warm soft overhead diffused lighting, golden candlelight glow from several candles placed at the head end of the bathtub, flickering warm orange candlelight reflected on the water and foam, subtle steam rising from hot bath water, hyper-realistic spa atmosphere, cinematic photography, 8k high detail."
