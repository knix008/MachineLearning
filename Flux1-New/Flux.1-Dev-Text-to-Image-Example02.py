...
DEFAULT_SUBJECT = "In this masterpiece, a stunning skinny Korean woman with a soft idol aesthetic, standing beside a luxury resort pool, entire body soaking wet and glistening."
...
DEFAULT_POSE_HEAD = "Looking directly at the camera, chin slightly raised."

DEFAULT_POSE_BODY = "Standing upright at the poolside, body turned at a three-quarter angle, slim defined waist, shapely rounded hips, hourglass silhouette, confident and sensual posture."

DEFAULT_POSE_ARM = "Arms relaxed naturally at her sides."

DEFAULT_POSE_HAND = ""

DEFAULT_POSE_LEG = "Extremely long slender legs, one leg slightly forward, toned and graceful."

DEFAULT_POSE_FOOT = "Both feet in red stiletto high heels on the wet pool deck."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Tiny red string bikini top, wet fabric clinging tightly to her skin."

DEFAULT_BOTTOM = "Tiny red string bikini bottom, wet fabric clinging to her body, highlighting the hip line."

DEFAULT_LEGWEAR = ""

DEFAULT_FOOTWEAR = "Shiny red stiletto high heels, glossy lacquered surface, both shoes fully visible."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Edge of a luxury resort pool, wet pool deck tiles, crystal-clear turquoise pool water in the background."

DEFAULT_LIGHTING = "Cinematic studio lighting, strong specular highlights catching every water droplet on her skin and the glossy red heels, luminous shimmering effect."

DEFAULT_CAMERA = "Wide full-body shot from a distance, head to heels fully in frame, 24mm lens, slightly low angle, pool in background."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, sharp focus, perfect anatomy, full body, head to toe."

DEFAULT_NEGATIVE_PROMPT = "Extra hands, extra legs, extra feet, extra arms, paintings, sketches, low quality, monochrome, grayscale, skin blemishes, mutated hands, poorly drawn hands, blurry, bad anatomy, bad proportions, extra limbs, disfigured, fused fingers, too many fingers, missing arms, bad hands, missing fingers, exposed nipples, watermark, text, signature."
...
def generate_image(
    ...
    try:
        ...
        if DEVICE == "cuda" and torch.cuda.is_available():
            ...
            gpu_name = re.sub(r"[^\w]", "_", props.name)
            vram_gb = props.total_memory / (1024 ** 3)
            device_tag = f"CUDA_{gpu_name}_{vram_gb:.0f}GB"
        else:
