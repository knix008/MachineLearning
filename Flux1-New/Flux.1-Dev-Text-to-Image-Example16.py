...
DEFAULT_SUBJECT = "Photorealistic cinematic vertical medium-full shot of a stunning young Korean woman."
...
DEFAULT_POSE_HEAD = "Her head is tilted back, eyes closed, projecting a deeply atmospheric lost-in-the-moment vibe with gently parted lips."

DEFAULT_POSE_BODY = "Body angled slightly, back arched, hips pushed forward in a dramatic S-curve silhouette, highlighting flat midriff and defined waistline."

DEFAULT_POSE_ARM = "Her right arm is raised high above her head with her wrist elegantly relaxed."

DEFAULT_POSE_HAND = "Left hand brought up to her face, fingers delicately resting across her nose and cheek, partially obscuring her features."
...
DEFAULT_TOP = "Extremely tiny red bra with minimal coverage. Oversized dark navy pinstripe blazer worn open, pushed back behind her arms, framing her bare torso."

DEFAULT_BOTTOM = "Extremely tiny red thong panties with thin side straps, resting high on her hips."
...
DEFAULT_LIGHTING = "Intense direct flash lighting, high-contrast highlights on skin, stark black shadow cast onto the wall behind, gritty late-night editorial aesthetic."

DEFAULT_CAMERA = "Eye-level vertical medium-full shot. 35mm point-and-shoot flash style, sharp focus, 8k resolution, gritty editorial cinematic composition."
