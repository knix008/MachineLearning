...
DEFAULT_SUBJECT = "A high-quality photorealistic full body portrait of a stunning young beautiful gorgeous Korean woman."
...
DEFAULT_POSE = "She is striking a confident professional fashion model pose on the beach shoreline. Full body shot. Standing with one leg slightly in front of the other, weight shifted onto one hip, creating a natural S-curve silhouette. One hand resting lightly on her hip, the other arm hanging gracefully at her side. Torso angled slightly to the side, chest facing three-quarters toward the camera. Head tilted slightly, chin down. Hair gently billowing and flowing in the sea breeze."
