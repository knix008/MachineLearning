...
DEFAULT_SUBJECT = "A photography of a beautiful young skinny Korean woman sitting at an outdoor cafe table, full body, facing forward toward the camera, wearing a navy blue floral midi dress and white sneakers, spring outing style."
...
DEFAULT_POSE_HEAD = "Head held naturally"
...
DEFAULT_SETTING = "Outdoor open-air cafe terrace, small round cafe table with a coffee cup in front of her, cafe chairs, spring day, lush greenery and soft bokeh background."

DEFAULT_LIGHTING = "Even spring daylight, soft natural light, face clearly lit, neutral cafe atmosphere."
