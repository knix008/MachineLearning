...
DEFAULT_SUBJECT = "A photorealistic full body portrait of a beautiful young skinny Korean high school woman with a soft idol aesthetic, wearing a school uniform, standing in a bright school corridor."

DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses. Her expression is fresh and youthful with a soft innocent smile, looking directly at the camera. She has long straight jet-black hair with thick straight-cut bangs framing her face."

DEFAULT_POSE = "Standing in a natural and confident model pose. Weight shifted slightly to one leg creating a gentle S-curve. One hand resting lightly on her hip, the other hanging naturally at her side. Posture is upright and graceful. Full body visible from head to toe."

DEFAULT_OUTFIT = "Wearing a crisp white short-sleeved school uniform blouse, fitted and neat. A red school ribbon bow tie neatly tied at the collar. Black very short pleated school uniform skirt above mid-thigh. White knee-high socks reaching up to the knees. Black school leather shoes."

DEFAULT_SETTING = "Bright modern school corridor with large windows, white walls, clean tiled floor. Soft natural light from the windows. Clean and fresh school atmosphere."

DEFAULT_LIGHTING = "Bright natural daylight from corridor windows, soft and even illumination, high-key lighting with no harsh shadows. Clean and fresh atmosphere."
