...
DEFAULT_SUBJECT = "Photorealistic portrait of an 38-year-old Korean female standing on the beach in a string bikini, wet body with moisture glistening on her skin, ultra-realistic skin texture."
...
DEFAULT_POSE_HEAD = "Her hair tied up neatly. Bright warm smile on her face."

DEFAULT_POSE_BODY = "Standing in the ocean water, body fully facing forward toward the camera, entire body soaking wet and glistening, water droplets covering every inch of her skin, strong specular highlights and shiny wet sheen reflecting sunlight across her shoulders, chest, abdomen, and arms, skin visibly damp and lustrous."

DEFAULT_POSE_ARM = ""

DEFAULT_POSE_HAND = ""

DEFAULT_POSE_LEG = "Both legs visibly standing in the ocean, water rising up to her thighs, clear water surface clearly visible at thigh height with splashing ripples around her legs."

DEFAULT_POSE_FOOT = "Feet and lower legs submerged beneath the ocean water surface."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Stylish string light pink bikini top, minimal coverage, wet and clinging to her body."

DEFAULT_BOTTOM = "Matching string bikini bottom, wet and clinging, highlighting her figure."
...
DEFAULT_SETTING = "Shallow ocean water clearly visible rising up to her thighs, transparent blue-green water with gentle ripples and waves around her legs, sandy seabed visible beneath the water, ocean and beach in the background, bright sunny day."

DEFAULT_LIGHTING = "Bright natural sunlight, warm golden beach lighting, soft shadows, vibrant and fresh atmosphere."

DEFAULT_CAMERA = "Full body front-facing shot, eye-level angle, 8k high resolution, ultra-realistic skin tones and anatomy."
