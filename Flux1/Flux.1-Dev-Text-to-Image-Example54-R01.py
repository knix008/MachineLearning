...
DEFAULT_POSE_BODY = "Standing naturally and relaxed, body facing forward toward the camera, casual and effortless posture."

DEFAULT_POSE_ARM = "Both arms hanging loosely and naturally at her sides."

DEFAULT_POSE_HAND = "Both hands hanging loosely at her sides, fingers naturally relaxed."

DEFAULT_POSE_LEG = "Standing naturally with a slight weight shift to one leg, relaxed and casual stance."

DEFAULT_POSE_FOOT = "Feet slightly apart in a natural relaxed position, white sneakers resting casually on the pavement."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Loose flowing deep navy blue sleeveless one-piece dress with small floral print, entire fabric fully covered with densely packed small-to-medium sized flowers, allover floral pattern with no gaps, sleeveless with bare shoulders, cinched at the waist, flowing below the waist with a deep front slit starting from the thigh exposing one bare leg through the opening, breezy and lightweight."
