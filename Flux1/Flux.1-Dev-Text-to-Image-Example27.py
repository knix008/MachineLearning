...
# https://prompthero.com/prompt/78fd2a37c9d-flux-flux-11-pro-ultra-a-stunning-futuristic-depiction-of-a-female-astronaut-aboard-an-advanced-spacecraft-wearing-a-sleek-form-fitting-and-partially-revealing

# Default values for each prompt section
DEFAULT_SUBJECT = "A stunning futuristic depiction of a female astronaut aboard an advanced spacecraft, photorealistic, high-quality, sci-fi movie aesthetic."
...
DEFAULT_POSE_HEAD = "Confident and commanding presence, head held with elegance and poise."

DEFAULT_POSE_BODY = "Confident pose with an athletic physique accentuated by the form-fitting suit. Body slightly angled, commanding and elegant presence."

DEFAULT_POSE_ARM = "One arm resting on her head, the other resting on the ship's console."
...
DEFAULT_TOP = "Sleek, form-fitting, and partially revealing white spacesuit with a futuristic aesthetic blending cutting-edge technology and elegance. Smooth metallic white fabric with a subtle sheen. Deep cutouts in the chest and side areas exposing skin while maintaining a futuristic and functional look. High collar and structured panels give a space-age appearance."

DEFAULT_BOTTOM = "The spacesuit continues seamlessly with the same smooth metallic white fabric, form-fitting and figure-accentuating, with structured panels and subtle futuristic detailing."

DEFAULT_LEGWEAR = ""

DEFAULT_FOOTWEAR = ""

DEFAULT_ARMWEAR = "Left arm partially wrapped in a textured band resembling a combination of fabric and lightweight armor, adding detail and a sense of functionality."

DEFAULT_SETTING = "Interior of a high-tech spacecraft with glowing control panels, intricate machinery, and large observation windows offering a breathtaking view of a distant planet against the starry expanse of space."

DEFAULT_LIGHTING = "Dynamic lighting with soft highlights reflecting off the suit and metallic surfaces, adding depth and realism. Blend of cool blue ambient light from space and warm glow from control panels."

DEFAULT_CAMERA = "Full body composition, 8k resolution, cinematic photography, photorealistic, highly detailed suit and skin textures, sci-fi atmosphere."
