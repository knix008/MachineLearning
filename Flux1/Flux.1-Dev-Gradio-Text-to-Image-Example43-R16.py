...
DEFAULT_NEGATIVE = "Perfect anatomy, perfect body."
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic cosplay portrait of a young Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, with a subtle closed-mouth smile, lips softly curled upward slightly, looking directly at the camera with head facing straight forward. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face."
DEFAULT_OUTFIT = "Wearing a tiny, minimalist metallic red micro bikini with minimal coverage. The bikini top is very small with thin string ties, barely covering her chest. The matching bottoms are extremely small with thin side strings, low-rise and minimal. The shiny metallic red fabric glistens under the light. Wearing matching metallic red stiletto high heels."
DEFAULT_POSE = "Kneeling on the wet floor, sitting back on her heels with both knees spread apart, legs open. Thighs spread outward at a wide angle. Upright torso, back arched slightly, chest pushed forward. Both hands raised behind her head, fingers interlaced or loosely holding the back of her head, elbows spread wide to the sides. Head facing straight forward, looking directly ahead. Seductive and confident kneeling pose."
