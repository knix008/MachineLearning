...
DEFAULT_SUBJECT = "A photorealistic, high-quality portrait image of a young beautiful Korean woman with a soft, idol aesthetic."
DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, wavy jet-black hair that flows all the way down to her waist."
DEFAULT_OUTFIT = "She wears a loose, oversized short-sleeved white crop top that cuts off above the belly button, leaving the navel fully visible. The top is worn askew, sliding off to one side so that one shoulder is completely bare and exposed while the other remains covered. The front of the top has the text 'I Love Seoul' printed on it. Below, she wears a very small simple white thong. She wears white over-the-calf socks that reach up to her calves."
DEFAULT_POSE = "Standing near the window in a relaxed, natural pose, body slightly turned to one side. Both arms hanging naturally and loosely down at her sides. Her long wavy hair, reaching down to her waist, gently flowing and swaying in the soft breeze drifting through the open window. Effortless and graceful, with a calm, dreamy expression."
DEFAULT_SETTING = "A very bright, spacious, and airy interior room with high ceilings and large windows. Sheer white curtains gently billowing inward from the breeze. A door slightly ajar in the background. Clean, minimalist architecture with soft white walls."
DEFAULT_LIGHTING = "Abundant natural daylight streaming softly through large windows, flooding the room with warm, diffused sunlight. Soft window light casting gentle shadows across the floor. Bright, ethereal, and luminous atmosphere."
DEFAULT_CAMERA = "Full body shot from head to toe. Eye-level angle, capturing both the subject and the bright airy room environment. Shot with a 50mm lens, soft natural bokeh on the background."
