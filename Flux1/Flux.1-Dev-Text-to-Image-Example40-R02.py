...
SUBJECT = "A full body photography of a beautiful skinny young Korean woman standing at a resort infinity pool overlooking the ocean, gazing toward the sea."

FOOT = ""

LEG = "Both legs long and slender, fully bare and exposed, one leg crossed slightly in front of the other at the ankle, weight on the back leg, fashion model stance."

FACE = "She has a fair, clear complexion gazing toward the ocean in the distance. She has long, voluminous straight jet-black hair, dramatically flowing and billowing in the sea breeze, strands sweeping through the air."

BODY = "Classic fashion model pose, body angled at three-quarter view, contrapposto stance with one hip popped out to the side, shoulders slightly dropped on the opposite side, confident and elegant posture, slender waist and feminine hourglass curves fully accentuated."

ARM = "One hand resting on her hip with elbow bent outward, the other arm hanging naturally and relaxed at her side."

HAND = "One hand resting gracefully on the hip with fingers lightly curled, the other hand relaxed with fingers lightly extended at her side."

FOOTWEAR = ""

LEGWEAR = ""

BOTTOM = "Wearing a tiny red thong bikini bottom, minimal coverage, bare hips fully exposed, thin red string ties at the hips."

TOP = "Wearing a tiny red triangle bikini top, minimal coverage, thin red string ties at the neck and back, bare midriff and slim waist fully exposed."

HEADWEAR = ""

ARMWEAR = ""

HEAD = "Head held high with chin slightly raised, gazing confidently toward the ocean with a poised and elegant model expression."

LIGHTING = "Bright natural sunlight, skin glowing and luminous."

SETTING = "Luxury tropical resort infinity pool overlooking the ocean, crystal blue sea stretching to the horizon, turquoise water merging with the sky, elegant poolside deck, lush tropical greenery, warm tropical atmosphere."

CAMERA = "35mm lens, full body shot from sufficient distance, entire body from head to bare feet fully in frame, low angle from knee height looking slightly upward, tack sharp focus."

POSITIVE = "8k, high quality, photorealistic, razor sharp focus, perfect anatomy, ten fingers, beautiful fingers, beautiful hands, no extra limbs, masterpiece, best quality, highly detailed, intricate details, award winning photography, professional lighting, cinematic lighting, soft lighting, volumetric lighting, rim light, global illumination."

NEGATIVE = "Blurry, out of focus, soft focus, hazy, low sharpness, grainy, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, deformed hands."
