...
SUBJECT = "Full body photography of a beautiful skinny young Korean woman standing by a luxury hotel swimming pool wearing a thong bikini, with both bare feet fully visible on the poolside deck."

FOOT = "Both bare feet pressed firmly together with inner sides touching, ankles touching, side by side, both feet rotated slightly to the same side as the body, flat on the poolside deck, all toes and heels clearly in frame, not cropped."

LEG = "Both legs straight and pressed together with knees touching and thighs touching, turned slightly to the same side as the body, standing upright, long slender legs clearly visible."
...
BODY = "Body turned only slightly to one side (about 10-15 degrees), chest still mostly frontal to the camera, standing still, hip shifted slightly to one side, posture upright and confident, weight evenly balanced on both feet."
...
LIGHTING = "Strong frontal lighting directly from the camera side, bright and even illumination across the entire body from head to bare feet, face clearly lit, skin glowing and luminous."

CAMERA = "35mm lens, full body shot from sufficient distance, entire body from head to bare feet fully in frame, both feet and toes clearly visible with space below the feet, low angle from knee height looking slightly upward, tack sharp focus."

POSITIVE = "8k, high quality, photorealistic, razor sharp focus, perfect anatomy, ten fingers. ten toes, beautiful fingers, beautiful toes, well formed fingers and toes."

NEGATIVE = "Blurry, out of focus, soft focus, hazy, low sharpness, grainy, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, feet cropped, toes cropped, heels cropped, feet out of frame, missing feet, missing toes. deformed feet, deformed toes, deformed fingers, deformed hands."
