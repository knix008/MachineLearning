...
DEFAULT_POSE_BODY = "Contrapposto pose, weight on one leg, hip tilted to the side, body facing forward."

DEFAULT_POSE_ARM = "Both arms slightly raised, elbows out to the sides, hands brought up to her chest."

DEFAULT_POSE_HAND = "Both hands firmly cupping her bare breasts, palms pressed flat against them, nipples completely and fully hidden behind her palms, no nipples visible whatsoever."

DEFAULT_POSE_LEG = "One leg bearing weight, opposite hip raised, legs slightly apart."

DEFAULT_POSE_FOOT = "Both feet planted at the very edge of the pool."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Topless, no top, no clothing on upper body, bare chest and bare torso fully visible, no shirt, no bra, no bikini top."
...
DEFAULT_CAMERA = "Full-body shot, high-speed shutter freezing water droplets mid-air, sharp focus on subject with softly blurred background, realistic skin tones."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, exposed nipples."
