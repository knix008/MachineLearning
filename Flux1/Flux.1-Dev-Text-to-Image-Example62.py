...
SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetics standing on a casual spring outing in Seoul, wearing black stiletto high heels and a black bodycon mini dress."
...
LEG = "Both legs fully straight and pressed firmly together, knees touching each other, inner thighs touching, no gap between legs from thigh to ankle."
...
FOOTWEAR = "Black pointed-toe stiletto pumps, thin spike heels, both shoes entirely visible including heel tips."
...
POSITIVE = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, detailed high heels, full body visible, legs and feet in frame."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, one leg forward, staggered legs, walking pose, legs apart, feet apart, gap between feet, gap between knees, gap between legs, wide stance, equal weight on both legs, flat silhouette, no hip shift, heels cropped, feet cropped, missing feet, missing shoes, shoes cropped, bikini, swimsuit."
