...
SUBJECT = "A full body photography of a beautiful young skinny Korean woman standing at a beach hotel outdoor swimming pool wearing a very tiny white bikini, bare feet on the poolside deck."

FOOT = "Both bare feet pressed firmly together side by side, inner edges touching, toes pointing forward, feet flat on the poolside deck, feet entirely in frame and not cropped."

LEG = "Both legs fully straight and pressed firmly together, knees touching, thighs together, no gap between legs."
...
BODY = "Standing upright with both feet together, body fully facing the camera, tall and elegant posture, shoulders back."
...
TOP = "Wearing a very tiny white triangle bikini top, minimal coverage, thin string ties at the neck and back, bare midriff fully exposed."
...
SETTING = "Beach hotel outdoor swimming pool, glowing blue pool water, elegant poolside deck, ocean and blue sea visible beyond the pool in the background, clear blue sky, bright sunny day."

LIGHTING = "Brilliant direct sunlight from the front, entire body evenly flooded with bright sunlight, skin glowing and luminous, no shadows."

CAMERA = "Full body shot, entire body from head to bare feet fully in frame, feet completely visible and not cropped, extra space below the feet, waist level angle, sharp focus, soft bokeh background."

POSITIVE = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, ten toes, beautiful toes, detailed feet, well formed toes, well formed fingers."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, feet cropped, missing feet, legs apart, spread legs, gap between legs, gap between feet, wide stance, walking pose, staggered legs."
