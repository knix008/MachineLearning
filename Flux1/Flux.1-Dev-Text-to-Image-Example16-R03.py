...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetic standing beside a luxury hotel outdoor swimming pool, wearing a bikini, with barefoot."

DEFAULT_FACE = "She has a fair, clear complexion. Her expression is soft and gentle with a subtle faint smile, looking directly at the camera. She has long, voluminous wavy jet-black hair with beautiful soft waves and curls, gently flowing, strands moving naturally."

DEFAULT_POSE_HEAD = ""

DEFAULT_HEADWEAR = ""

DEFAULT_POSE_LEG = "One leg straight, the other knee slightly bent, both feet flat on the floor side by side, full leg line visible from hip to ankle."

DEFAULT_LEGWEAR = ""

DEFAULT_POSE_FOOT = "Both feet side by side, flat on the floor, not crossed from the viewer, fully visible at the bottom of the frame."
...
DEFAULT_LIGHTING = "Bright frontal studio lighting directly illuminating the front of the body, soft box light from the front, face and body evenly and brightly lit, no shadows on the face or body, no backlight, clean and well-exposed skin tones."
...
DEFAULT_POSITIVE_PROMPT = "8k, high quality, photorealistic, perfect anatomy, ten fingers, well formed fingers, well formed toes, ten toes, sharp focus, beautiful fingers, beautiful toes, clear toes, clear fingers, masterpiece, best quality, highly detailed, award winning photography, professional lighting, realistic skin texture, intricate details, elegant composition."
