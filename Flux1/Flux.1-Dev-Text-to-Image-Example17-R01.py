...
DEFAULT_POSE_LEG = "One leg straight, the other knee very slightly bent, both feet side by side and parallel, full leg line visible from hip to ankle."
...
DEFAULT_ARMWEAR = "Draped over the shoulders, a thin sheer semi-transparent chiffon cardigan, loosely worn, covering the shoulders, open at the front, fabric softly flowing, delicate and feminine."
...
DEFAULT_CAMERA = "24mm lens, full body shot, camera at chest height, chest-level angle, entire body from head to feet in frame, sharp focus, soft bokeh background."
