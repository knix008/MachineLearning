...
DEFAULT_POSE = "Standing upright on the wet floor with her knees. Her knees spread wide apart, thighs stand upright and spread open at a wide angle, body turned very slightly to one side, not fully front-facing. Both arms raised and spread wide apart, elbows pointing far outward to each side. Both hands hidden behind the neck, not visible from the camera angle. Elbows open wide. Back arched seductively, chest thrust forward, waist pulled in tightly to emphasize the hourglass curve. Hips tilted to one side with a prominent S-curve. Head tilted slightly to one side, chin gently raised upward. A soft, subtle closed-mouth smile, lips together, gentle and enigmatic expression. Heavy-lidded eyes gazing down at the camera with a smoldering, seductive look."
