...
DEFAULT_POSE = "Standing upright on the wet floor with her knees. Her knees spread wide apart, thighs stand upright and spread open at a wide angle, body turned very slightly to one side, not fully front-facing. Both arms raised and spread wide apart, elbows pointing far outward to each side. Both hands hidden behind the neck. Elbows open wide. Back arched seductively, chest thrust forward, waist pulled in tightly. Hips pushed slightly backward and tilted to one side, creating a prominent S-curve that accentuates the full roundness of the hips and the deep curve of the lower back. Head tilted slightly to one side, chin gently raised upward. A soft, subtle closed-mouth smile. Heavy-lidded eyes gazing down at the camera with a smoldering, seductive look."
