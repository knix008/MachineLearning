...
DEFAULT_POSE_BODY = "Body facing perfectly straight and directly toward the camera, chest and torso fully frontal, no angling or turning to the side, standing upright with tall and elegant posture. Full body visible from head to toe."
...
DEFAULT_TOP = "Soft white knit cardigan neatly worn and fully covering both shoulders, long sleeves with tidy cuffs, modest and proper fit, layered over a navy blue maxi dress with small delicate floral print, tiny coral pink and salmon flowers with small green leaves densely scattered across the fabric, smocked elastic waistband cinching the waist, long flowing semi-sheer chiffon skirt reaching the ankles with a front slit revealing the legs, neat and modest everyday style, no bare shoulders visible."
