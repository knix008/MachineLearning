...
SUBJECT = "Full body photography of a beautiful young skinny Korean woman posing beside a luxury hotel outdoor swimming pool, wearing bikini, bare feet on the poolside tiles."

FACE = "She has a fair, clear complexion. Her expression is innocent and confident, looking directly at the camera. She has long, voluminous straight jet-black hair loosely gathered at the nape of her neck."

HEAD = "Head held upright, chin slightly lifted, head turned toward the camera, gaze directed straight at the camera, natural and confident."

HEADWEAR = ""

LEG = "One leg straight bearing full body weight, the other leg clearly bent at the knee with foot still flat on the ground, natural contrapposto stance, both legs extremely long and slender, full leg line visible from hip to ankle, long legs fully exposed with no cropping."

LEGWEAR = ""

FOOT = "Both bare feet naturally positioned, toes clearly visible, both feet fully in frame at the bottom, standing directly on poolside tiles."

FOOTWEAR = ""

ARM = "Both elbows raised high and pointing upward, arms forming a wide V shape above the head, elbows lifted above head level, forearms angled inward toward the back of the neck."

ARMWEAR = ""

HAND = "Both hands gathered at the back of the neck, fingers intertwined and clasped together at the nape of the neck, actively tying and gathering the hair at the nape level."

BODY = "Body turned very slightly to the side at a subtle three-quarter angle, just enough to emphasize the curves of the waist and hips, weight shifted onto one straight leg, hips tilted naturally, slender waist and feminine silhouette clearly visible, tall and elegant posture."

TOP = "Wearing a very tiny sky blue triangle bikini top, extremely minimal coverage, barely covering the chest."

BOTTOM = "Wearing a very tiny sky blue thong bikini bottom, extremely minimal coverage, barely covering the hips."

SETTING = "Luxury hotel outdoor swimming pool, clear turquoise water behind her, white poolside tiles, sunny summer atmosphere."

LIGHTING = "Warm sunlight coming from a slight front-side angle, face and body evenly illuminated, gentle shadow on the far side of the body to accentuate waist and hip curves, no harsh shadows on the face, natural skin tones preserved."

CAMERA = "Full body shot, slightly low angle looking upward to emphasize leg length, wide enough to capture entire body from head to feet, feet clearly visible at the bottom with extra space below, sharp focus on subject, softly blurred pool background."

POSITIVE = "8k, high quality, photorealistic, perfect anatomy, two legs, long, slender legs, well formed legs and feet, well formed fingers, sharp focus, highly detailed, ten fingers, ten toes, beautiful fingers and toes. no extra limbs, no missing limbs."
