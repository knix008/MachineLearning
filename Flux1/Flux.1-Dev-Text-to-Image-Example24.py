...
DEFAULT_POSE_BODY = "Full body standing in a powerful commanding stance, body facing forward toward the camera, ethereal energy radiating from her form."

DEFAULT_POSE_ARM = "Both arms at her sides, spectral energy crackling around her forearms, energy-enhanced claws ready to extend."

DEFAULT_POSE_HAND = "Spectral energy-enhanced claws extending from her fingertips, glowing with light blue bioluminescent power, sharp and lethal."

DEFAULT_POSE_LEG = "Standing in a strong wide stance, weight evenly balanced, powerful and grounded posture."

DEFAULT_POSE_FOOT = ""

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "She is wearing a shimmering spectral suit with intricate white and gray patterns on the upper body, the fabric appears to shift and shimmer with ghostly energy, highly detailed texture."

DEFAULT_BOTTOM = "The shimmering spectral suit continues with intricate white and gray patterns on the lower body, seamlessly integrated with the full suit."

DEFAULT_LEGWEAR = ""

DEFAULT_FOOTWEAR = "Ghostly white and gray heel-boots with spectral energy detailing, ethereal and precise."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Dark ethereal void environment with swirling ghostly mist and spectral energy. Ominous shadows and faint apparitions in the background."
