...
DEFAULT_POSE_FOOT = "Both feet side by side, parallel to each other, toes pointing forward, sandals clearly shown on white sand, feet fully in frame, not cropped."

DEFAULT_FOOTWEAR = "Simple white strappy beach sandals, thin straps across the toes and ankle, flat sole, casual and elegant."
...
DEFAULT_CAMERA = "Full body shot, entire body from head to feet fully in frame, bare feet not cropped, slightly low angle to elongate legs, subject facing camera, sharp focus, soft bokeh background."
