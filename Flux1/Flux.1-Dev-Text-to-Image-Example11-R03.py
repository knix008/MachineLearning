...
DEFAULT_SUBJECT = "A full body fashion photography of a beautiful young skinny Korean woman standing upright outdoors wearing sandals, her body and hair completely soaking wet, water dripping down her skin."

DEFAULT_CAMERA = "35mm lens, full body frontal shot, camera positioned below the navel at hip height, slightly low angle looking upward to elongate the legs, entire body from head to feet fully in frame, sharp focus, soft bokeh background."
...
DEFAULT_POSE_BODY = "Body facing directly toward the camera, completely frontal, slender waist and figure visible, relaxed and natural posture."
...
DEFAULT_SETTING = "Luxury hotel swimming pool background, wet white stone floor, bright sunny summer day."

DEFAULT_LIGHTING = "Bright direct summer sunlight, strong warm highlights on the body, vivid and radiant ambiance."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, perfect anatomy, full body shot, frontal view, ten fingers, ten toes, feet fully visible, sandals visible."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, barefoot, feet cropped, head cropped, overhead shot, bird's eye view, top-down, worm's eye view, dry skin, dry hair."
