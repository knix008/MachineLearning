...
DEFAULT_BODY = "Beautiful fingers."
DEFAULT_SUBJECT = "A photography of a young Korean woman with a soft aesthetic."
DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is a soft, closed-mouth smile, subtle and gentle, lips lightly pressed together. She has long, wavy, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face."
DEFAULT_OUTFIT = "Wearing a simple light blue bra and panties. The bra is a minimalist triangle top. The bottoms are a classic thong style panties, offering minimal rear coverage."
DEFAULT_POSE = "Looking at the ocean. Standing on the sandy beach in a confident and sexy pose, facing the ocean. Weight shifted to one hip, creating a natural S-curve silhouette. One hand gently holding a strand of her hair, the other hanging naturally down at her side, resting loosely near her thigh. Head turned to the side, showing her profile. Her side face clearly visible."
DEFAULT_SETTING = "Sunny tropical beach. She is standing at the shoreline where the ocean meets the sand. A gentle wave is washing over her bare feet, water swirling around her ankles. Clear turquoise ocean stretching to the horizon in front of her. Blue sky with scattered clouds. Lush palm trees in the background."
DEFAULT_LIGHTING = "Bright natural outdoor sunlight. Warm golden hour lighting casting soft shadows on her back. Sun glistening on the skin. Cheerful and vibrant atmosphere."
DEFAULT_CAMERA = "Camera positioned directly behind her at chest height, shooting horizontally. Her back fully visible to the camera. Full body visible from head to toe. The ocean fills the background in front of her."
