...
BODY = "Body almost fully facing the camera, torso barely rotated just a few degrees to one side, nearly front-facing, natural weight shift creating subtle hip tilt."

ARM = "One arm hanging naturally and relaxed at side, other arm slightly raised with hand reaching down toward the ends of her hair."

HAND = "One hand hanging naturally down, other hand lightly holding the tips of her long hair."
...
ARMWEAR = "Delicate chain bracelet on the wrist of the arm hanging at side."

HEAD = "Chin slightly up, soft natural head tilt, hair loosely falling over shoulders."

SETTING = "Bright modern bedroom, blue floral wallpaper covering the walls, delicate flower pattern on soft blue background, neatly made white bed with pillows visible."
