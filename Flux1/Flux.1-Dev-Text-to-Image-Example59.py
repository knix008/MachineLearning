...
# https://prompthero.com/prompt/37f8528bb87-stable-diffusion-35-large-sun-drenched-beauty-in-the-sand-a-stunning-portrait-of-a-young-woman-with-long-wet-dark-brown-hair-lying-on-a-sun-drenched-beach-at

# Default values for each prompt section
DEFAULT_SUBJECT = "A stunning portrait of a young Korean woman with long, wet, dark brown hair and a soft idol aesthetic, lying on a sun-drenched beach at golden hour."
...
DEFAULT_POSE_HEAD = "Serene expression, gentle radiant smile, gazing softly."

DEFAULT_POSE_BODY = "She is topless, with her upper body exposed, lying on the sun-drenched beach sand. Her skin is smooth and glowing with natural warmth, lightly dusted with fine sand."

DEFAULT_POSE_ARM = "Arms resting beside her on the sand."
...
DEFAULT_SETTING = "Softly blurred ocean background with gentle waves, bathed in warm golden sunlight, beach sunset."

DEFAULT_LIGHTING = "Soft and cinematic golden hour lighting, dreamy romantic atmosphere, warm color grading, soft bokeh, natural lighting."

DEFAULT_CAMERA = "Shallow depth of field, cinematic composition, professional photography, sharp focus on face, ultra HD."

DEFAULT_POSITIVE_PROMPT = (
    "High detail, skin texture highly detailed, natural skin tones, natural beauty, realistic hair strands, masterpiece, high quality."
)

DEFAULT_NEGATIVE_PROMPT = "no artificial filters, no text, no watermark, no distortion."
