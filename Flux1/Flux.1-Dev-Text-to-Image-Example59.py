...
LEG = "Both legs fully straight and pressed firmly together, knees straight, thighs together, no gap between legs, no bending at the knees."

FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long wavy voluminous jet-black hair with beautiful soft waves and curls."

BODY = "Standing upright with both legs together, body fully facing the camera, tall and elegant posture."
...
LEGWEAR = "Wearing white socks."

BOTTOM = ""

TOP = "Long pure white chiffon one-piece dress, thin spaghetti straps, bare shoulders, fully opaque, densely covered all-over floral print with many tiny miniature flowers in soft pink and white covering the entire fabric, fitted waist, flowing A-line skirt with a deep side slit on one side reaching high up the thigh, side slit clearly open and prominently revealing the bare leg."
...
SETTING = "Bright spring street, cherry blossom trees lining the sidewalk with pink petals falling gently."

LIGHTING = "Bright even spring daylight, soft frontal natural light, face clearly and brightly lit, no harsh shadows."

CAMERA = "Full body shot, entire body from head to feet fully in frame, waist level angle, subject facing camera, sharp focus, soft bokeh background."

POSITIVE = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, well formed and beautiful fingers."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, staggered legs, walking pose, legs apart, stepping, spread legs, wide stance, gap between legs, gap between feet, one leg forward, crossed legs."
