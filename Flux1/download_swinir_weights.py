"""
SwinIR 모델 가중치 다운로드 스크립트
Usage: python download_swinir_weights.py
"""
...
MODELS = [
    ...
    {
        "name": "Real SR x4 PSNR (SwinIR-M)",
        "filename": "003_realSR_BSRGAN_DFO_s64w8_SwinIR-M_x4_PSNR.pth",
        "url": "https://github.com/JingyunLiang/SwinIR/releases/download/v0.0/003_realSR_BSRGAN_DFO_s64w8_SwinIR-M_x4_PSNR.pth",
    },
    {
        "name": "Classical SR x4 (SwinIR-M)",
