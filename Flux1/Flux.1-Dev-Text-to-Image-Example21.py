...
DEFAULT_SUBJECT = "Full body photography of a beautiful young skinny Korean woman standing beside a luxury hotel outdoor swimming pool, wearing pool slide slippers and bikini."
...
DEFAULT_POSE_FOOT = "Both feet clearly visible at the bottom of the frame side by side, slippers fully shown without cropping, standing on poolside tiles."

DEFAULT_FOOTWEAR = "Wearing pink open-toe pool slide slippers, toes fully exposed and clearly visible, flat and simple, on the poolside tiles."
...
DEFAULT_SETTING = "Luxury hotel outdoor swimming pool, clear turquoise water behind her, white poolside tiles, sunny summer atmosphere."
...
DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, barefoot, feet cropped, shoes cropped."
