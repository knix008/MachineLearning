...
DEFAULT_SUBJECT = "A photorealistic full body portrait of a beautiful young Korean woman with a slim toned figure, standing on a sandy beach near a modern coastal city, facing away from the camera toward the ocean."

DEFAULT_FACE = "She has long straight dark brown hair flowing loosely down her back, slightly tousled by the sea breeze."

DEFAULT_POSE_HEAD = "Head turned slightly to the side, gazing at the ocean horizon with a relaxed and confident expression."

DEFAULT_POSE_BODY = "Back facing the camera, body turned at a three-quarter angle to accentuate the S-curve silhouette, hips shifted slightly to one side, lower back arched naturally, waist clearly defined, full S-line body curve prominently visible."

DEFAULT_POSE_ARM = "Both arms hanging naturally and relaxed at her sides, close to her legs."

DEFAULT_POSE_HAND = "Both hands resting naturally near her thighs, fingers loosely relaxed."

DEFAULT_POSE_LEG = "Standing with legs slightly apart, weight shifted to one leg, creating a natural feminine hip curve."

DEFAULT_POSE_FOOT = "Bare feet on the wet sand at the water's edge, toes pointing toward the sea."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Bare top body, fully revealing the back and shoulders."

DEFAULT_BOTTOM = "Wearing a very tiny seamless light pink thong bottom, no ties or knots, high-cut style, fully revealing the buttocks and lower back."
...
DEFAULT_SETTING = "Sandy beach shoreline, gentle ocean waves, modern city skyline visible in the background across the bay, urban skyscrapers reflecting in the water."

DEFAULT_LIGHTING = "Bright midday sunlight, clear blue sky, strong natural daylight evenly illuminating the scene, vivid colors, high clarity, sharp shadows, sun directly overhead, brilliant white light reflecting off the sand and water."

DEFAULT_CAMERA = "Shot on Sony A7R V, 85mm f/1.8 lens, ISO 200, shallow depth of field, hyper-realistic skin texture, professional fashion photography quality, 8K resolution."
