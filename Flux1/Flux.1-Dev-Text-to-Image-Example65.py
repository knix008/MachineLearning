...
SUBJECT = "Photorealistic mirror selfie photo of a beautiful young skinny Korean woman, standing in a modern minimalist indoor room, wearing a teal steel-blue triangle bikini, taking a selfie with a smartphone in a large oval wall mirror."

FOOT = ""

LEG = "Both legs straight and close together, body slightly angled to the side, upper body and thighs visible in frame."

FACE = "She has a fair, clear complexion. Her expression is relaxed and natural with mouth gently closed, lips softly together, gazing slightly toward the mirror. She has long straight jet-black hair hanging loosely and naturally, slightly damp-looking, draped over her shoulders and chest."

BODY = "Body turned slightly to the side, not fully frontal, subtle hip shift creating a soft S-curve silhouette, slim toned figure, bare midriff fully visible."

ARM = "One arm raised holding a smartphone up toward the mirror to take the selfie, elbow bent; the other arm hanging naturally at her side."

HAND = "One hand holding a gold-colored smartphone facing the mirror; the other hand relaxed at her side."

FOOTWEAR = ""

LEGWEAR = ""

BOTTOM = "Very tiny teal steel-blue side-tie bikini bottom, thin rope tie strings on both hips, minimal coverage."

TOP = "Very tiny teal steel-blue triangle bikini top, thin spaghetti shoulder straps and neck tie, thin back strap, minimal coverage."

HEADWEAR = ""

ARMWEAR = "Small delicate earring visible."

HEAD = "Head tilted very slightly, face angled naturally toward the mirror reflection, relaxed and confident posture."

SETTING = "Modern minimalist indoor room, clean bright white walls, very large floor-to-ceiling oval wall mirror dominating the wall, mirror takes up most of the background, full figure visible inside the mirror, simple interior visible in the mirror reflection behind her."

LIGHTING = "Soft bright indoor ambient lighting, even white light illuminating the body clearly, no harsh shadows, clean and airy atmosphere."

CAMERA = "Mirror selfie shot, upper body from head to mid-thigh visible in frame, smartphone and hand visible in reflection, oval mirror frame partially visible, sharp focus on subject, 35mm lens."

POSITIVE = "8k, photorealistic, ultra sharp, tack sharp, in focus, high resolution, perfect anatomy, ten fingers."

NEGATIVE = "Blurry, out of focus, low quality, deformed, bad anatomy, extra limbs, watermark, text, extra fingers, outdoor, beach, full body shot, feet visible, open mouth, laughing, different hair color, dressed, fully clothed."
