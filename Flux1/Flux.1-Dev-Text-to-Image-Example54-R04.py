...
DEFAULT_POSE_BODY = "Standing casually and naturally upright, body facing forward toward the camera, relaxed everyday posture, comfortable and unstaged."

DEFAULT_POSE_ARM = "One arm hanging loosely and naturally at her side resting near her hip, the other arm bent with hand tucked into the cardigan pocket."

DEFAULT_POSE_HAND = "One hand resting naturally near her hip at her side, the other hand casually tucked inside the cardigan pocket."

DEFAULT_POSE_LEG = "Standing with both legs close together, one leg straight bearing weight, the other leg slightly bent at the knee, natural and relaxed stance."

DEFAULT_POSE_FOOT = "Both feet close together, one foot flat on the ground, the other slightly raised at the heel with knee gently bent, white sneakers resting on the pavement."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Loose flowing deep navy blue sleeveless one-piece dress with medium floral print, medium sized flowers loosely scattered across the fabric with breathing space between them, cinched at the waist, flowing below the waist with a deep front slit starting from the thigh exposing one bare leg through the opening, breezy and lightweight. Over the dress, a soft ivory knit cardigan properly worn, fully covering both shoulders, open front unbuttoned, sleeves casually pushed up and rolled up to the forearms, lightweight and cozy."

DEFAULT_BOTTOM = ""

DEFAULT_LEGWEAR = "White ankle socks, neatly folded down just above the sneakers."

DEFAULT_FOOTWEAR = "Clean white canvas sneakers, simple and casual."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Bright spring street in Seoul, cherry blossom trees with pink petals falling gently, warm sunny day."
