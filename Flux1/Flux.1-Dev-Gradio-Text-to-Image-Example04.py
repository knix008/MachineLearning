...
# Anatomy
DEFAULT_ANATOMY = "Perfect anatomy, five fingers on each hand, no extra finger, no missing fingers, no deformed fingers, no fused fingers, perfect hand structure, perfect feet structure, perfect body proportion, no extra hands, no extra feet, no distorted body."
