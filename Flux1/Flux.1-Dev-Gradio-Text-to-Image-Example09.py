...
DEFAULT_QUALITY = ""
DEFAULT_NEGATIVE = "Five fingers on each hand, five toes on each foot."
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic portrait of a young Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression looks like innocent and curious. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face."
DEFAULT_OUTFIT = "Wearing a very small string type light pink bra and matching panties."
DEFAULT_POSE = "Lying flat on her back on a sunbed, body completely flat and horizontal. One leg fully stretched out straight, the other leg slightly bent at the knee with the foot resting flat on the sunbed surface. Arms resting naturally at the sides or one arm resting on the stomach. Head resting on the sunbed, face turned slightly toward the camera."
...
DEFAULT_CAMERA = "Horizontal landscape composition, full body shot from the side showing the entire figure from head to toe. Camera positioned at sunbed level on the side of the subject, perpendicular to the body, pointing straight across. Sharp focus across the full body. Shot with a 35mm lens."
