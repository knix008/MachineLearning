...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetic standing on a sunny summer beach, wearing white sneakers and white ankle socks."
...
DEFAULT_POSE_LEG = "Both shoes slightly apart, planted firmly on the wet sand, fully visible at the bottom of the frame."

DEFAULT_LEGWEAR = ""

DEFAULT_POSE_FOOT = "Both feet clearly visible at the very bottom of the frame, shoes fully shown without any cropping, feet planted on the sand."

DEFAULT_FOOTWEAR = "Wearing clean white canvas sneakers and white ankle socks, both shoes completely visible and clearly rendered, shoe details fully shown including laces and sole."

DEFAULT_POSE_ARM = "One arm raised slightly with hand gently touching her hair, the other arm relaxed at her side, wind-blown natural pose."

DEFAULT_ARMWEAR = ""

DEFAULT_POSE_HAND = "Both hands loosely relaxed, fingers lightly extended and natural."

DEFAULT_POSE_BODY = "Three-quarter angle toward the camera, hips tilted and pushed noticeably to one side in a natural S-curve, upper body slightly turned, wind catching her hair and clothing, feminine waist-to-hip curve clearly emphasized."

DEFAULT_TOP = "Wearing a loose sky blue casual shirt, lightweight cotton fabric, relaxed oversized fit, unbuttoned at the top, sleeves slightly rolled up, billowing gently in the sea breeze."

DEFAULT_BOTTOM = "Wearing a white mini skirt, wind-blown and flowing, slightly damp at the hem, elegant and feminine."

DEFAULT_SETTING = "Sunny summer beach, bright clear blue sky with dazzling sunlight, white sandy shoreline glistening, turquoise ocean waves in the background, warm tropical summer day, lush vivid colors, beautiful summer seascape."

DEFAULT_LIGHTING = "Soft summer daylight, gentle natural light from clear sky, balanced natural illumination, face and body evenly lit, warm soft sunlight, natural skin tones."

DEFAULT_CAMERA = "24mm wide-angle lens, full body shot, camera at knee height, slightly low angle looking up, entire body from top of head to tips of toes fully in frame with generous margin below the feet, shoes clearly visible at the bottom, sharp focus on full body including feet, soft bokeh background."
