...
SUBJECT = "A full body photography of a beautiful skinny young Korean woman standing at a luxury hotel swimming pool wearing a thong bikini, bare feet on the poolside deck."

FOOT = "Both feet together, side by side, flat on the poolside deck, bare feet fully visible including toes and both ankles."

LEG = "One leg straight and weight-bearing, the other leg slightly bent at the knee in a relaxed pose, long slender legs clearly visible."
...
BODY = "Body turned slightly to a three-quarter angle, hips shifted and tilted to one side creating a natural S-curve, waist and hip line prominently visible, slender hourglass silhouette clearly defined, standing upright with confident posture."
...
HEAD = "Head held upright, tilted very slightly, glancing toward the camera."
...
POSITIVE = "8k, high quality, photorealistic, razor sharp focus, perfect anatomy, ten fingers, ten toes, beautiful fingers, beautiful toes, detailed feet, detailed toes, no extra toes."

NEGATIVE = "Blurry, out of focus, soft focus, hazy, low sharpness, grainy, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, feet cropped, missing toes, fused toes, webbed toes, distorted toes, toe deformity, toe duplication, toe artifact."
            ...
            with gr.Column(scale=1):
                ...
                with gr.Accordion("CLIP 프롬프트 (Subject → Positive)", open=False):
                    prompt_clip = gr.Textbox(
                        ...
                        lines=3,
                        interactive=True,
                        info="Subject + Positive 순으로 자동 결합됩니다. 인코딩 시 이 문자열을 그대로 사용합니다.",
                    )
