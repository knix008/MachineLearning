...
# https://prompthero.com/prompt/124a11f8dd1-z-image-turbo-subject-body-shape-a-high-resolution-full-body-portrait-of-a-stylish-young-east-asian-woman-with-a-slender-and

# Default values for each prompt section
DEFAULT_SUBJECT = "A full-body photography of a stylish young skinny Korean woman with a soft idol asethetic."
...
DEFAULT_POSE_BODY = "Leaning elegantly against the glass window of a storefront, body positioned at a slight angle, graceful and fashionable silhouette."

DEFAULT_POSE_ARM = "Right hand resting subtly at her side, left arm carrying a small bag over the shoulder."

DEFAULT_POSE_HAND = "One hand resting naturally at her side, the other holding the strap of a small crossbody bag."

DEFAULT_POSE_LEG = "One leg slightly forward, creating a graceful and fashionable silhouette."

DEFAULT_POSE_FOOT = ""

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Classic black-and-white tweed bouclé cropped jacket with gold buttons, crisp white blouse with a prominent pussy-bow collar underneath."

DEFAULT_BOTTOM = "Matching black-and-white tweed bouclé mini skirt."

DEFAULT_LEGWEAR = ""

DEFAULT_FOOTWEAR = ""

DEFAULT_ARMWEAR = "Small structured white leather crossbody bag with a delicate gold chain strap, chunky gold hoop earrings, simple gold ring."

DEFAULT_SETTING = "Charming narrow pedestrian arcade alleyway with vintage European aesthetic, intricate blue-and-white patterned mosaic tile ground, rows of empty outdoor cafe tables with blue tops and wooden chairs lining the path under old-fashioned street lamps, decorative metal lattice security shutter behind the glass storefront window she is leaning against."

DEFAULT_LIGHTING = "Soft diffused natural daylight filtering into the arcade, bright and even glow, realistic subtle reflections on the glass storefront window, clean and airy lighting emphasizing rich tweed textures and smooth porcelain skin quality."

DEFAULT_CAMERA = "Full body shot, sharp focus, soft bokeh background, high resolution."

DEFAULT_POSITIVE_PROMPT = (
    "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers."
)

DEFAULT_NEGATIVE_PROMPT = "extra hands, extra legs, extra feet, extra arms, extra toes, waist pleats, paintings, sketches, worst quality, low quality, normal quality, lowres, monochrome, grayscale, skin spots, wet, acnes, skin blemishes, age spot, manboobs, backlight, mutated hands, poorly drawn hands, blurry, bad anatomy, bad proportions, extra limbs, disfigured, more than 2 nipples, missing arms, extra legs, fused fingers, too many fingers, unclear eyes, bad hands, missing fingers, extra digit, bad hands, missing fingers, cleft chin, exposed nipples."
