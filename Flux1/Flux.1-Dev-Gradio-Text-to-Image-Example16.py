...
DEFAULT_SUBJECT = "A photorealistic, high-quality cosplay photography of a young Korean woman with a soft, idol aesthetic, dressed in bra and panties with white fishnet stockings."
...
DEFAULT_OUTFIT = "She wears a very small, minimal light pink triangle string bra and matching light pink micro string panties (thong). She wears upright blue fabric bunny ears with white inner lining and a delicate white headband base, accented with a small white bow."
DEFAULT_POSE = "High-kneeling pose: both knees resting on the floor, thighs vertical and perpendicular to the ground, body held tall and upright as if standing but on her knees. The lower legs (shins) are flat behind her, tops of the feet on the floor. Body and torso fully facing the camera directly. Upper body fully upright and straight. Confident and alluring expression directed straight at the camera. Both arms raised, both hands placed behind her neck with fingers interlaced, elbows pointing outward to the sides. Hips slightly tilted forward in a sexy, confident pose. Full body visible from head to knees. Glamorous, alluring model pose with sensual energy."
...
DEFAULT_LIGHTING = ""
DEFAULT_CAMERA = "Full body shot from head to toe, wide composition. Camera positioned far back to capture the entire body in frame. Eye-level angle. Entire figure visible with space above and below. Sharp focus on the entire subject. Shallow depth of field, soft bokeh background. Professional studio photography. Shot with a 35mm lens."
