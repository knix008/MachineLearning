...
DEFAULT_NEGATIVE = "Perfect anatomy, five finger on each hand."
...
DEFAULT_POSE = "She is standing upright on the wet floor with her knees, both knees firmly on the ground, shins flat behind her, knees spread wide apart, thighs spread open at a wide angle, full body facing the camera. Both arms raised high and spread wide apart, elbows bent and pointing outward and upward, hands clasped at the back of the neck. Chest lifted and pushed forward, shoulders rolled back. Hips shifted slightly to one side for a seductive S-curve. Sultry expression, eyes gazing down toward the camera with a smoldering look."
...
DEFAULT_CAMERA = "Extreme low-angle shot, camera positioned very close to the floor right in front of the subject, angled sharply upward. Wide-angle 16mm lens, f/2.8. Camera very close to the subject, filling the frame tightly. The extreme low close-up upward perspective dramatically elongates her legs and body. Full body visible from knees to head. Vertical portrait orientation. No cropping."
