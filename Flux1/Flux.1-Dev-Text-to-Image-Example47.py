...
FOOT = "Both feet pressed together touching each other, toes pointing forward, white sneakers fully visible and not cropped, feet entirely in frame."
...
TOP = "Dark navy chiffon one-piece dress with thin spaghetti straps, simple neckline, bare shoulders and arms, mostly opaque with only a slight translucency, densely scattered tiny cherry blossom print in soft pink and white, fitted waist, flowing A-line skirt with a side slit gently blown by the breeze revealing the bare leg, skirt fabric billowing softly in the wind, casual spring outing style."
...
CAMERA = "Full body shot, entire body from head to feet fully in frame, feet and sneakers not cropped, slightly low angle to elongate legs, subject facing camera, sharp focus, soft bokeh background."

POSITIVE = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, one leg forward, staggered legs, walking pose, weight shift, legs apart, stepping, feet apart, spread legs."
