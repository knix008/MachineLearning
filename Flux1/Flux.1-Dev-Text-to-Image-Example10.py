...
DEFAULT_LEGWEAR = "Wearing white sheer stockings, smooth and semi-transparent white fabric, delicate and elegant fit along the legs."

DEFAULT_FOOTWEAR = "Wearing ivory cream pointed-toe stiletto high heels, tall thin heel clearly visible, glossy surface."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Cherry blossom park in full bloom, pale pink petals gently falling, cherry blossom trees forming a soft pink canopy, bright and airy spring atmosphere."
