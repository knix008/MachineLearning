...
DEFAULT_OUTFIT = "Wearing a sleek, form-fitting black thong bikini. The black bikini top has thin string ties that accentuate her figure. The matching black bikini bottoms are minimal with thin side strings, low-rise. The matte black fabric contrasts beautifully against her fair skin."
DEFAULT_POSE = "Lying on a sun lounger on her back, body stretched out languidly. One knee slightly bent, legs relaxed and slightly apart. Back arched gently, chest lifted upward. One arm raised above her head resting on the lounger, the other hand resting softly on her stomach. Head tilted slightly to the side, face turned toward the camera. Seductive and confident sunbathing pose."
DEFAULT_SETTING = "Luxurious five-star hotel pool area. She is lying on a white padded sun lounger (sun bed) beside a crystal-clear turquoise swimming pool. Tropical surroundings with lush palm trees and manicured greenery. Sun umbrella casting soft dappled shade nearby. Poolside tiles are clean and bright white. Other sun loungers and poolside amenities visible in the background, suggesting an upscale resort atmosphere."
DEFAULT_LIGHTING = "Bright, warm natural sunlight flooding the scene from above. Soft golden sunlight illuminating her skin with a warm glow, creating a sun-kissed look. Gentle highlights on her body and hair. The turquoise pool water reflects shimmering light patterns onto her and the surroundings. Bright, airy, and cheerful outdoor poolside atmosphere with clear blue sky overhead."
DEFAULT_CAMERA = ""
