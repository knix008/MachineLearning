...
DEFAULT_QUALITY = ""
DEFAULT_ANATOMY = "Perfect anatomy, five fingers on each hand, five toes on each foot."
DEFAULT_SUBJECT = "A photorealistic, high-quality portrait image of a young skinny beautiful Korean woman with a soft, idol aesthetic."
DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is shy and gentle with a soft, slightly bashful smile, looking directly at the camera. She has long, wavy jet-black hair that flows all the way down to her waist."
DEFAULT_POSE = "Slightly sexy natural standing pose. Weight shifted onto one hip, one leg relaxed with knee slightly inward, creating a gentle S-curve silhouette. One hand gently holding the very tips of her long hair, fingers lightly gripping the ends of the hair that falls to her waist. The other hand resting naturally and loosely down at her side. Soft, alluring expression with a gentle smile toward the camera."
DEFAULT_OUTFIT = "Wearing a very small black string bra with thin string straps, and matching very small black string thong with thin string sides. Over this, a loose, oversized white office dress shirt worn askew, one shoulder bare and exposed. Front buttons all fastened closed. Cuffs unbuttoned. The shirt fabric is slightly opaque white cotton, semi-transparent enough that the black bra and panties underneath are softly and clearly visible through the fabric. Bare legs fully exposed. Barefoot."
DEFAULT_SETTING = "A cozy, everyday residential home interior. A large window dominates the wall, with sheer curtains softly framing it. Warm and lived-in home atmosphere with familiar domestic elements visible in the background — simple furniture, wooden floors, and soft-toned walls."
DEFAULT_LIGHTING = "The entire room is brightly and evenly illuminated by warm artificial indoor lighting, not natural sunlight. Bright front-facing key light directed toward the subject from the front, clearly and cleanly illuminating her face with no harsh shadows. The whole room is uniformly bright and well-lit."
DEFAULT_CAMERA = "Full body shot from head to toe. Slight low-angle, camera positioned just below eye level pointing slightly upward to emphasize height and elegance. Shot with a 85mm lens, shallow depth of field with soft bokeh background."
...
def combine_prompt_sections(
    ...
    sections = [quality, anatomy, subject, appearance, pose, outfit, setting, lighting, camera]
