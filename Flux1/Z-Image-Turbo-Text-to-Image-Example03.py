...
DEFAULT_POSE_BODY = "She is lying in the bathtub with her torso and hips fully submerged beneath murky opaque bath water, completely hidden and invisible beneath the surface."

DEFAULT_POSE_ARM = "Both arms are raised above the water, hands and forearms clearly visible in the air."

DEFAULT_POSE_HAND = ""

DEFAULT_POSE_LEG = "Both legs are draped and resting over the far edge of the bathtub, calves and feet hanging outside above the waterline."

DEFAULT_POSE_FOOT = "Only head, arms below elbow, and lower legs are visible above water."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = ""

DEFAULT_BOTTOM = "Completely bare, torso and hips entirely submerged and concealed beneath murky cloudy bath water. Only the head, neck, forearms, hands, calves, and feet are visible above the opaque water surface."
