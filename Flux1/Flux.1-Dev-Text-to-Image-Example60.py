...
DEFAULT_POSE_HEAD = "Head tilted very slightly to the side, chin slightly lifted, hair cascading naturally over one shoulder."

DEFAULT_POSE_BODY = "Three-quarter angle to camera, one shoulder forward, weight on one hip, natural S-curve silhouette, elegant model pose."

DEFAULT_POSE_ARM = "One arm resting softly at her side, the other hand lightly touching her waist or hip, elbows gently relaxed, natural and elegant model arm placement."

DEFAULT_POSE_HAND = "Fingers loosely relaxed and naturally curved, one hand delicately placed at the hip, wrists softly bent in a graceful model pose."

DEFAULT_POSE_LEG = "Weight on one leg, other knee slightly bent, elongated leg line, skirt slit revealing bare leg."

DEFAULT_POSE_FOOT = "One foot planted firmly, the other foot slightly in front with toes angled outward, white sneakers fully visible and not cropped."
...
DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, one leg forward, staggered legs, walking pose, weight shift, legs apart, stepping."
