...
SETTING = "Beach hotel outdoor swimming pool, glowing blue pool water, ocean and blue sea visible beyond the pool in the background, clear blue sky, bright sunny day."

LIGHTING = "Bright direct frontal sunlight, sun in front of the subject, entire body evenly and brightly lit from the front, no backlighting, no shadows, skin glowing and luminous."

CAMERA = "Full body shot, entire body from head to bare feet fully in frame, feet completely visible and not cropped, extra space below the feet, knee level angle, sharp focus, soft bokeh background."

POSITIVE = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, ten toes, beautiful toes, detailed feet."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, feet cropped, missing feet, legs apart, spread legs, gap between legs, gap between feet, wide stance, walking pose, staggered legs, backlit, backlighting, contre-jour, rim light only, silhouette, shadows on face, dark face, underexposed body, sun behind subject."
