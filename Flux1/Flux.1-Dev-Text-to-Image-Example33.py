...
DEFAULT_SUBJECT = "A photorealistic, high-quality full-body portrait of a young beautiful Korean woman with a soft, idol aesthetic."
...
DEFAULT_POSE_HEAD = "Long, wavy jet-black hair flowing down to her waist, soft and relaxed."

DEFAULT_POSE_BODY = "Standing in a relaxed, natural pose in the center of a bright blue room, body slightly turned to one side with the face looking toward the camera, effortless and graceful."

DEFAULT_POSE_ARM = "One arm raised, with the hand gently sweeping hair back near the ear. The other arm hanging naturally down at her side."

DEFAULT_POSE_HAND = "The raised hand lightly touching and pushing hair back near the ear in a natural, effortless gesture."

DEFAULT_POSE_LEG = "Legs in a model-like stance: one leg slightly crossed in front of the other, weight shifted onto the back leg, creating a natural elongating line."

DEFAULT_POSE_FOOT = "Feet positioned with one foot slightly forward and angled outward, in a classic runway pose."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Extremely cropped oversized short-sleeved white crop top that cuts off just below the chest, leaving the entire stomach and navel fully exposed. The hem rides so high it barely covers the lower edge of the bust. Worn askew, sliding off to one side so that one shoulder is completely bare and exposed while the other remains covered. The front has 'I Love Seoul' printed on it."

DEFAULT_BOTTOM = "Very tiny simple white thong."

DEFAULT_LEGWEAR = "Clean white ankle socks, neatly worn."

DEFAULT_FOOTWEAR = "White casual sneakers, clean and fresh."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Bright, cheerful indoor room with walls and ceiling painted in vivid sky blue. Natural light oak wood flooring. Large floor-to-ceiling windows with sheer white curtains gently billowing in the breeze. Simple minimal furniture in blue tones."

DEFAULT_LIGHTING = "Warm natural sunlight streaming through large windows, casting soft golden rays across the blue walls and wood floor. Bright and luminous atmosphere with gentle shadows."

DEFAULT_CAMERA = "Full body shot from head to toe. Eye-level angle, capturing the subject. Shot with a 50mm lens, soft natural bokeh on the background. Perfect anatomy."
