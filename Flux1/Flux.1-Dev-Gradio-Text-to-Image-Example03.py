...
# Anatomy
DEFAULT_ANATOMY = "Perfect anatomy, no bad body structure, five fingers, no extra fingers, no missing fingers, no deformed fingers, no fused fingers, perfect hand structure, perfect feet structure, no extra hands, no extra feet, no distorted body."
...
# Outfit
DEFAULT_OUTFIT = "Black bra and black thong panties only. Plain smooth fabric, no lace, no other clothing, no accessories."

# Pose & Action
DEFAULT_POSE = "Lying flat on a white bed, relaxed pose. One arm down along her side, hand resting beside her leg. Other arm bent upward, hand lightly touching and running through her hair. Legs slightly opened, one straight, one slightly bent at knee. Full body visible head to toe. Looking up at the camera."
...
# Lighting
DEFAULT_LIGHTING = "Bright natural daylight, even overhead lighting, no harsh shadows. Crisp clear illumination on skin and white bedding."

# Camera & Shot Style
DEFAULT_CAMERA = "Overhead top-down view, camera straight above. Full body symmetrically visible from above. 24mm wide lens, sharp focus. Indoor aerial perspective."
