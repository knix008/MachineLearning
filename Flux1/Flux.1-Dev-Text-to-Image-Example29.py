...
DEFAULT_SUBJECT = "A full body landscapep hotography of a beautiful young skinny Korean woman standing by a swimming pool at night."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, voluminous wavy jet-black hair, all swept fully back down her back, not covering the shoulders or front at all, lying flat against her back."

DEFAULT_POSE_HEAD = "Head held upright with elegant posture, all hair swept fully back down the back, shoulders and front completely exposed."

DEFAULT_HEADWEAR = ""

DEFAULT_POSE_LEG = "Both legs straight and together, feet neatly side by side."

DEFAULT_LEGWEAR = "Bare legs, smooth and fair skin."

DEFAULT_POSE_FOOT = "Both feet neatly together, side by side, parallel to each other, toes pointing forward, bare feet clearly shown."

DEFAULT_FOOTWEAR = "Bare feet, no footwear."

DEFAULT_POSE_ARM = "One arm relaxed naturally at her side, the other arm bent at the elbow with hand resting lightly on her hip."

DEFAULT_ARMWEAR = ""

DEFAULT_POSE_HAND = "One hand relaxed at her side with fingers lightly extended, the other hand resting gently on her hip with fingers loosely curved."

DEFAULT_POSE_BODY = "Body directly and fully facing the camera, hip shifted a little bit to one side, torso strictly frontal, posture confident and elegant."

DEFAULT_TOP = "Very small dark blue bikini top with pink straps, tiny coverage."

DEFAULT_BOTTOM = "Very small dark blue thong bikini bottom with pink straps, tiny coverage, sitting low on the hips."

DEFAULT_SETTING = "Outdoor swimming pool at night, pool deck, soft underwater pool lights in the background."

DEFAULT_LIGHTING = "Soft nighttime pool lighting, gentle warm glow, subtle rim light, no harsh shadows."

DEFAULT_CAMERA = "Full body shot from a distance, wide enough to show the entire body with ample space above the head and below the feet, bare feet not cropped, low-angle shot from knee level looking slightly upward to elongate the legs, sharp focus."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, beautiful fingers, ten fingers.ten toes, beautiful toes."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, one leg forward, staggered legs, walking pose, weight shift, legs apart, stepping, feet apart, spread legs, indoor."
