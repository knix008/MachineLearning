...
# https://prompthero.com/prompt/fd32ec61213-flux-pro-11-ultra-an-elegant-fine-art-boudoir-portrait-of-a-confident-woman-posed-gracefully-within-a-softly-lit-bedroom-setting-she-wears

# Default values for each prompt section
DEFAULT_SUBJECT = "An elegant fine-art boudoir portrait of a confident young beautiful Korean skinny woman with soft, idol aesthetics, wearing blue contact lenses, posed gracefully, exuding sensuality and poise."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is soft and serene with a gentle, subtle closed-lip smile, lips lightly pressed together, not parted. She has long, straight jet-black hair."

DEFAULT_POSE_HEAD = "Face turned directly toward the camera, expression reflecting intimacy and emotional depth, subtle and self-assured."

DEFAULT_POSE_BODY = "Body facing toward the camera with hips slightly shifted to one side, creating a natural S-curve silhouette that accentuates her waist and figure. Graceful posture reflecting self-assurance and poise. Skin glowing softly under warm ambient light, with delicate highlights and gentle shadows enhancing every curve."

DEFAULT_POSE_ARM = ""

DEFAULT_POSE_HAND = "Ten fingers visible."
...
DEFAULT_TOP = "Refined lingerie with sheer fabrics flowing naturally around her form, sensual without overt exposure."
...
DEFAULT_SETTING = "Softly lit bedroom setting, elegant and intimate atmosphere."

DEFAULT_LIGHTING = "Warm ambient lighting filling the room, casting delicate highlights and gentle shadows across her figure to enhance every curve and texture."

DEFAULT_CAMERA = "Fine-art boudoir photography style, hyper-realistic skin textures, high-resolution rendering, cinematic depth-of-field. Perfect anatomy."
