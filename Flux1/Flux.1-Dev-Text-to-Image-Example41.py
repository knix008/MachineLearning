...
SUBJECT = "A full body photography of a beautiful slender young Korean woman standing in a luxury hotel interior, wearing a tiny red bikini, bare feet on the polished marble floor."

FOOT = "Both feet bare, one foot flat on the polished marble floor bearing full weight, the other foot with only the toes lightly touching the floor."

LEG = "Both legs long and slender, fully bare and exposed, one leg standing straight bearing most of the weight, the other leg slightly bent at the knee with toes lightly touching the floor, creating a natural relaxed stance."
...
BODY = "Body angled very slightly to one side, torso turned just a few degrees away from fully frontal, hip gently shifted to one side creating a subtle S-curve silhouette, slender waist and feminine hourglass curves beautifully accentuated, entire body contour clearly defined."

ARM = "One arm raised with elbow relaxed and slightly bent, the other arm naturally down at her side."

HAND = "One hand lightly holding a few strands of hair near the temple, the other hand relaxed with fingers lightly extended."
...
HEAD = "Head held upright, chin slightly raised."

LIGHTING = "Bright front lighting, skin luminous and glowing."

SETTING = "Elegant luxury hotel interior, spacious and bright room, polished marble floor, soft neutral-toned walls, large floor-to-ceiling windows allowing abundant natural light."
...
POSITIVE = "8k, high quality, photorealistic, razor sharp focus, perfect anatomy, ten fingers, beautiful fingers, beautiful hands, ten toes, beautiful toes, detailed toes, all toes visible, natural skin texture."
