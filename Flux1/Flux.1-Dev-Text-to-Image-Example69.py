...
SUBJECT = "A photography of a beautiful young skinny Korean woman with a soft idol aesthetic standing on a bright white sand beach, wearing a black and white small checkered pattern bikini."
...
HEAD = "Head turned very slightly to the side, chin slightly lowered, natural and confident."
...
POSITIVE = "8k, photorealistic, tack sharp, in focus, high resolution, perfect anatomy, ten fingers, ten toes, well formed fingers and toes, sharp focus."
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Markdown(
                    ...
                    "- **T5**: Subject → 외모·의상·포즈 → Setting → Camera → Lighting → Positive 순.\n"
                ...
                with gr.Accordion("T5 프롬프트 (전체 섹션 결합)", open=False):
                    prompt_t5 = gr.Textbox(
                        ...
                        interactive=True,
                        info=(
                            "Subject → 외모·의상·포즈 → Setting → Camera → Lighting → Positive 순으로 자동 결합. "
