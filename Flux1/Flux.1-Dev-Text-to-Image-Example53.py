...
SUBJECT = "Full-body photo, slim young Korean woman with soft idol aesthetic, standing on the street in a summer day in Seoul."

FOOT = "Editorial stance: weight on back foot, front foot half-step, toe slightly out; full feet and white sneakers in frame, uncropped."

LEG = "Soft bent front knee, long back leg, subtle S-curve at hips, runway-style leg line."

FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is poised and confident with a soft editorial gaze toward the camera. She has long wavy voluminous jet-black hair with beautiful soft waves and curls, draped to her back."

BODY = "Torso about three-quarters to camera, shoulders angled, one hip popped, tall open posture."

ARM = "One hand on hip, other arm at side with a soft bend."

HAND = "Relaxed fingers, graceful hand lines."
...
HEAD = "Chin slightly up, model head tilt, hair frames face."
...
POSITIVE = "8k, photorealistic, sharp focus, perfect anatomy, ten fingers, full body, feet and shoes visible, no extra limbs, no deformed limbs, ten fingers, well formed fingers and hands."
