...
DEFAULT_POSE_HEAD = "Long, wavy jet-black hair flowing down to her waist, gently lifted and swaying in the warm outdoor breeze."

DEFAULT_POSE_BODY = "Standing near the pool in a relaxed, natural pose, body facing directly toward the camera, effortless and graceful."
...
DEFAULT_SETTING = "Luxurious hotel outdoor swimming pool on a brilliantly sunny day. Crystal-clear turquoise pool water, elegant sun loungers, lush tropical plants, and a vivid deep blue sky stretching across the background."

DEFAULT_LIGHTING = "Bright, intense midday sunlight flooding the scene, sparkling reflections on the pool water, warm and vibrant atmosphere with deep blue sky."

DEFAULT_CAMERA = "Full body shot from head to toe. Eye-level angle, capturing the subject and the sunny pool environment. Shot with a 50mm lens, soft natural bokeh on the background. Perfect anatomy."
