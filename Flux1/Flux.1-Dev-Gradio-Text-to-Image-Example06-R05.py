...
DEFAULT_OUTFIT = "She wears an extremely tiny micro light pink string bra, barely covering the nipples only, maximum skin exposure. Extremely tiny micro light pink string panties, barely covering the groin only, exposing bare thighs, hips, and stomach fully. Headwear: tall, upright blue fabric bunny ears with white inner lining and a delicate white headband, accented with a small white bow."
DEFAULT_POSE = "Lying on the bed, full body extended lengthwise. Body gently curved in a subtle S-shape, back slightly arched. One arm resting loosely at the side, hand placed naturally on the bed. Other arm bent, hand lightly resting on the stomach. One leg fully extended, other leg bent at the knee slightly to the side. Lips softly parted, sultry gaze looking directly up at camera. Full body visible head to toe."
