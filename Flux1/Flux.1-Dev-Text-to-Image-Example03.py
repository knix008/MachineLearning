...
SUBJECT = "A photography of a beautiful skinny young Korean woman standing by a luxury hotel swimming pool wearing a thong bikini."
...
CAMERA = "35mm lens, full body shot from sufficient distance, waist level angle shot, tack sharp focus."
...
POSITIVE = "8k, high quality, photorealistic, razor sharp focus, perfect anatomy, ten fingers, beautiful fingers."

NEGATIVE = "Blurry, out of focus, soft focus, hazy, low sharpness, grainy, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers."
