...
DEFAULT_POSE_BODY = "Standing perfectly still and upright, knees touching together, feet planted side by side on the ground, body facing straight toward the camera, chest and torso fully frontal, tall and elegant posture, shoulders back."
...
DEFAULT_POSE_LEG = "Both legs pressed together, knees touching, thighs and calves in contact, no gap from hip to ankle, side slit of skirt naturally parted revealing bare leg."

DEFAULT_POSE_FOOT = "Both feet touching side by side, heels together, toes pointing forward, white sneakers clearly shown, feet not cropped."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Dark navy chiffon one-piece dress with thin spaghetti straps, bare shoulders and arms, tiny cherry blossom print in soft pink and white, fitted waist, flowing A-line skirt with a side slit from the upper thigh revealing the bare leg."
