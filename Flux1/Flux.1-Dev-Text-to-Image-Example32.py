...
DEFAULT_POSE_BODY = "Standing in a relaxed, natural pose in the center of a bright blue room, body facing directly toward the camera, effortless and graceful."

DEFAULT_POSE_ARM = "Both arms hanging naturally and loosely down at her sides."
...
DEFAULT_SETTING = "Bright, cheerful indoor room with walls and ceiling painted in vivid sky blue. Natural light oak wood flooring. Large floor-to-ceiling windows with sheer white curtains gently billowing in the breeze. Simple minimal furniture in blue tones. Clean and airy atmosphere with a fresh, playful mood."
...
DEFAULT_CAMERA = "Full body shot from head to toe. Eye-level angle, capturing the subject and the blue interior environment. Shot with a 50mm lens, soft natural bokeh on the background. Perfect anatomy."
