...
DEFAULT_POSE_FOOT = "Both feet side by side, flat on the floor, not crossed from the viewer, fully visible at the bottom of the frame, not cropped. The toes of each foot should be aligned, side by side."
