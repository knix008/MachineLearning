...
DEFAULT_SUBJECT = "Full body photography of a beautiful young skinny Korean woman standing on a bright sunny beach, wearing sandals on her feet."

DEFAULT_POSE_FOOT = "Both feet clearly visible at the bottom of the frame side by side, sandals fully shown without cropping, standing on sandy beach."
...
DEFAULT_FOOTWEAR = "Wearing pink open-toe flat sandals, toes fully exposed and clearly visible, pink straps, on the sand."
...
DEFAULT_TOP = "Wearing a very tiny sky blue triangle bikini top, extremely minimal coverage, thin pink string straps, barely covering the chest."

DEFAULT_BOTTOM = "Wearing a very tiny sky blue thong bikini bottom, extremely minimal coverage, thin pink string straps, barely covering the hips."
...
DEFAULT_LIGHTING = "Sun shining directly from the front onto the subject, bright frontal sunlight fully illuminating the face and body, face and body evenly and brightly lit, no shadows on the face or body, no backlight, subject clearly separated from the background, natural skin tones preserved."

DEFAULT_CAMERA = "35mm lens, full body shot, camera at waist height, entire body from top of head to bottom of sandals fully in frame, extra margin below the sandals, subject in sharp focus from head to toe, no depth of field blur, subject clearly defined against background."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, photorealistic, perfect anatomy, ten fingers, ten toes, sharp focus, highly detailed, crisp edges, subject clearly visible, vivid and clear image."

DEFAULT_NEGATIVE_PROMPT = "Blurry, out of focus, hazy, soft focus, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, barefoot, feet cropped, sandals cropped, missing sandals, ankles cropped, depth of field blur, overexposed, washed out."
