...
DEFAULT_SUBJECT = "A 8k resolution high-quality photorealistic portrait of a stunning young beautiful gorgeous Korean woman walking on a luxurious resort beach, framed from thighs to head."
...
DEFAULT_POSE_HEAD = "Head held high, lips slightly parted, gazing directly into the camera with a confident and alluring expression. Hair and outfit gently billowing and flowing in the sea breeze."

DEFAULT_POSE_BODY = "She is walking gracefully along the beach shoreline directly toward the camera, body fully facing forward. Torso and chest facing straight at the camera, hips swaying naturally with each stride."

DEFAULT_POSE_ARM = "Both arms hanging naturally down at her sides, swinging loosely with the rhythm of walking."

DEFAULT_POSE_HAND = "Hands loosely swinging at her sides in a natural walking motion."

DEFAULT_POSE_LEG = "One leg stepping forward, weight shifting naturally with each stride."

DEFAULT_POSE_FOOT = ""

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "She is wearing a breezy white beach sundress with short sleeves and a flowy midi-length skirt, a fabric sash tied at the waist. Lightweight cotton fabric, the hem and sleeves gently fluttering in the sea breeze, casual beach vacation style."
...
DEFAULT_SETTING = "Luxurious resort beach with white sand shoreline on a bright sunny day. Clear blue sky with no clouds. Modern high-rise resort towers in the background skyline. Ocean waves at the shore. Sparkling ocean water in the background."

DEFAULT_LIGHTING = "Bright clear midday sunlight, vivid blue sky, strong natural daylight flooding the scene. Crisp warm highlights on her skin, sharp sun-drenched beach atmosphere."

DEFAULT_CAMERA = "Three-quarter shot framed from mid-thigh to top of head, front-facing, perfectly straight-on eye-level angle. 85mm portrait lens, subject centered in frame, beach surroundings visible in background. Resort buildings and ocean softly visible behind her. Realistic lifestyle beach photography. High-fidelity skin textures. Perfect anatomy."
