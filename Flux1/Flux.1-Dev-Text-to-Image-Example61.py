...
SUBJECT = "Full-body, beautiful, skinny young Korean woman, soft idol look, hotel pool deck, black bodycon mini, sheer white pantyhose stockings, black stilettos, both feet and heels pressed together, no gap, subtle hip shift with weight on one leg."

FOOT = "Both feet in heels together: inner edges and heels touching, parallel, flat on deck, no gap between feet; full shoes in frame, margin below tips."

LEG = "Both legs straight, knees extended not bent; body supported mainly on one leg with subtle hip shift; thighs close; ankles and feet always touching, parallel; long legs from stilettos and short hem; hip and leg lines visible."
...
BODY = "Facing camera, tall posture, most weight on one supporting leg with a subtle hip shift and soft S-curve; both knees straight, legs long and unbent; waist cinched, hips rounded, silhouette visible through the tight dress; feet and ankles together on deck, inner shoe edges touching."

ARM = "Arms relaxed at sides, wrists visible."

HAND = "Hands relaxed, no rings, gold bracelet visible on one wrist."

FOOTWEAR = "Black pointed stiletto pumps, thin heels."

LEGWEAR = "Sheer white pantyhose stockings under the dress into black pumps; smooth sheer nylon, not fishnet, not opaque."

BOTTOM = ""

TOP = "Sleeveless black bodycon mini: deep neckline, high waist, very short hem, tight fit, fabric hugging waist and hips so curves read clearly."

HEADWEAR = ""

ARMWEAR = "Gold chain necklace and gold bracelet, clearly visible."

HEAD = "Head tilted slightly, relaxed."

SETTING = "Beach hotel pool deck, blue water, ocean beyond, sunny sky."

LIGHTING = "Bright front sunlight on the whole figure, even, high clarity, sharp crisp detail."

CAMERA = "Waist-height, straight-on full body, deep DOF on her, long-leg framing; margin below heels; distant pool and sea soft only."

POSITIVE = "8k, realistic, tack sharp, perfect anatomy, ten fingers, full body, heels in frame."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, cropped feet or heels, missing shoes, bikini, swimsuit, bare legs, no pantyhose, black pantyhose, fishnet, opaque or thick tights, no jewelry, bare neck or wrists, short legs, bent knees, one knee bent, flexed knee, legs or feet apart, gap between feet, ankles apart, one foot forward, wide stance, walking, staggered legs, military stance, equal weight both legs, boxy waist, straight hips, flat silhouette, soft or blurred subject, shallow DOF on body, bokeh on subject, motion blur, hazy."
