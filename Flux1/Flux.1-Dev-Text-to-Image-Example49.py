...
DEFAULT_POSE_HEAD = "Hair tied up neatly."

DEFAULT_POSE_BODY = "Standing upright, body facing forward toward the camera, wet body with moisture glistening on skin, ultra-realistic skin texture."
...
DEFAULT_TOP = "Transparent extremely tiny string light blue bikini top with minimal coverage."

DEFAULT_BOTTOM = "Transparent extremely tiny string light blue bikini bottom."
...
DEFAULT_SETTING = "Standing on the beach."

DEFAULT_LIGHTING = "Bright natural sunlight, warm daytime atmosphere."

DEFAULT_CAMERA = "Full body shot, sharp focus, 8k high resolution, photorealistic, perfect anatomy."
