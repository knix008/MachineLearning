...
DEFAULT_OUTFIT = "She is wearing mesh-type fishnet white stocking with blue ribbon on top center of the two stocking bands."
DEFAULT_SETTING = ""
DEFAULT_LIGHTING = ""
DEFAULT_CAMERA = "Camera positioned directly above at chest level, shooting straight down toward the body, wide-angle lens capturing the entire body from head to toe in frame, top-down overhead perspective."
