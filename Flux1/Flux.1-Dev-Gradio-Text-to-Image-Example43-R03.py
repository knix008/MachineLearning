...
DEFAULT_POSE = "Standing upright in a confident fashion model pose. Weight shifted onto one leg, opposite hip slightly raised, creating a natural S-curve. One hand resting lightly on the hip, the other hanging naturally at the side. Shoulders relaxed and back, chest forward. Head tilted very slightly, direct and alluring gaze into the camera, lips softly parted. Elegant and seductive full-body standing pose."

DEFAULT_SETTING = "Clean, minimalist high-end fashion studio. Seamless white or light gray background. Smooth reflective floor. Modern and sleek atmosphere."

DEFAULT_LIGHTING = "Bright, professional fashion studio lighting. Soft diffused key light from the front illuminating the full body evenly. Gentle fill light removing harsh shadows. Subtle rim light from behind outlining the silhouette. Clean, flattering light that highlights skin tone and the fabric of the outfit."

DEFAULT_CAMERA = "Full body shot from head to toe, vertical composition. Camera positioned at a slight distance to capture the entire figure. Subject centered in frame. Sharp focus across the full body. Shot with an 85mm portrait lens."
