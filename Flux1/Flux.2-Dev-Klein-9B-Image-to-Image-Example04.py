...
DEFAULT_QUALITY = ""
DEFAULT_ANATOMY = "Perfect anatomy, exactly two legs, exactly two arms, correct number of limbs, no extra limbs."
DEFAULT_SUBJECT = ""
DEFAULT_APPEARANCE = ""
DEFAULT_POSE = "She is lying on a bed, full body visible from head to toe, both legs (exactly two legs) slightly crossed at the ankles, accentuating the natural curves of the waist and hips."
DEFAULT_OUTFIT = "She is wearing mesh-type fishnet white stocking with blue ribbon on top center of the stocking band."
DEFAULT_SETTING = ""
DEFAULT_LIGHTING = ""
DEFAULT_CAMERA = "Overhead bird's-eye view camera directly above, shooting straight down at 90 degrees, capturing the entire body from head to toe in frame, wide-angle lens, top-down perspective."
