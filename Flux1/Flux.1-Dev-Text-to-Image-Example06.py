...
DEFAULT_SETTING = "Sunny tropical beach. White sandy beach at the water's edge. Clear turquoise ocean and blue sky visible in the background. Lush palm trees in the background."
DEFAULT_LIGHTING = "Bright natural outdoor sunlight. Warm golden hour lighting casting soft shadows. Sun glistening on the skin. Cheerful and vibrant atmosphere. Face brightly and evenly lit, as if a soft fill light is illuminating her face directly, clear and glowing complexion with no harsh shadows on the face."
DEFAULT_CAMERA = "Camera positioned at eye level from a medium distance, as if shot with a telephoto lens from afar. Full body shot from head to toe. Subject facing the camera. Slight sense of distance between camera and subject."
