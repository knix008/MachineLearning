...
DEFAULT_SUBJECT = "A beautiful young skinny Korean woman with a soft idol aesthetic lying on her side on a sandy beach."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, voluminous wavy jet-black hair with beautiful soft waves and curls, completely drenched, draped down and touching the incoming waves, wet hair strands floating in the shallow water."

DEFAULT_POSE_HEAD = "Head raised and tilted toward the camera, chin slightly lifted, face wet and glistening."

DEFAULT_POSE_BODY = "Lying on her side on the wet sand, upper body propped up by one elbow, entire front of the body and belly button facing directly toward the camera."

DEFAULT_POSE_ARM = "One elbow planted on the wet sand supporting the upper body weight, the other arm resting loosely along the side."

DEFAULT_POSE_HAND = "The supporting forearm and hand flat on the sand, the other hand loosely resting on the hip or thigh, fingers naturally relaxed."

DEFAULT_POSE_LEG = "One heel pressed firmly into the wet sand supporting the lower body weight and lifting the hips, the other leg relaxed and extended on the sand."

DEFAULT_POSE_FOOT = "Both bare feet fully visible and not cropped."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Tiny deep blue string bikini top, barely covering her bust, thin straps, wet fabric clinging tightly to her skin, vivid deep blue color intensified by water, sparkling brilliantly under the sunlight."

DEFAULT_BOTTOM = "Tiny deep blue string bikini bottom, barely covering her hips, thin side strings, wet fabric clinging to her body, shimmering under the bright light."
...
DEFAULT_SETTING = "Sandy tropical beach, shallow ocean waves washing over her body and flowing around her, wet sand glistening, turquoise ocean in the background, clear blue sky."

DEFAULT_LIGHTING = "Intense bright sunlight, strong specular highlights and reflections catching every water droplet on her skin and the wet bikini fabric, luminous shimmering glow across her entire wet body."

DEFAULT_CAMERA = "Full body shot from a low front angle, entire body from head to feet clearly in frame, sharp focus on the subject."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, ten toes."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, standing, sitting, face down, lying flat."
