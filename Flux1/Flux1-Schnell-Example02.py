...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column():
            prompt = gr.Textbox(
                label="Prompt",
                value="8k, looking at viewer, a skinny woman photo, walking on a sunset beach, wearing a dark blue bikini with high leg style, high detail, full body figure, cinematic lighting, photo realistic",
