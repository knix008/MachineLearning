...
DEFAULT_POSE_LEG = "Both legs visible through the deep front slit of the dress, legs slightly apart in a confident stance."

DEFAULT_POSE_FOOT = "Both bare feet fully visible and not cropped."

DEFAULT_HEADWEAR = "Delicate golden halo floating above her head, thin glowing ring of soft golden light."

DEFAULT_TOP = "Flowing pure white gown, fitted bodice with sweetheart neckline and thin shoulder straps, covered in intricate embroidered patterns of feathers and celestial motifs in silver and gold thread, fine lacework and ornate arabesque designs, luminous fabric."

DEFAULT_BOTTOM = "Long flowing white gown with a very deep front center slit from upper thigh to ankle revealing both legs, embroidered patterns and fine lacework along the hem and slit edges continuing from the bodice, sheer lightweight fabric draping softly."
