...
SUBJECT = "A full body photography of a beautiful skinny young Korean woman standing at a resort infinity pool overlooking the ocean, wearing a tiny red bikini, gazing toward the sea, bare feet on the poolside deck."

FOOT = "Both feet bare, flat on the poolside deck, all ten toes clearly visible, toes separated and distinct."

LEG = "Both legs long and slender, fully bare and exposed, standing with one leg slightly bent at the knee, weight shifted to one side, accentuating the natural curves of the body."

FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is serene and dreamy, gazing toward the ocean in the distance. She has long, voluminous straight jet-black hair, dramatically flowing and billowing in the sea breeze, strands sweeping through the air."

BODY = "Body turned in three-quarter profile toward the sea, torso slightly angled, contrapposto standing posture, hip tilted to one side, natural S-curve silhouette, slender waist and feminine curves fully accentuated, entire body contour clearly defined."
...
HEAD = "Head turned to the side, gazing toward the ocean, chin slightly raised, serene and elegant expression."

LIGHTING = "Brilliant direct sunlight from the front, entire body from head to bare feet completely and evenly flooded with bright sunlight, every part of the body fully illuminated, skin glowing and luminous, no shadows anywhere on the body, no side shadows, no backlighting, no rim light."

SETTING = "Luxury tropical resort infinity pool overlooking the ocean, crystal blue sea stretching to the horizon, turquoise water merging with the sky, elegant poolside deck, lush tropical greenery, bright sunny day, warm tropical atmosphere."
...
POSITIVE = "8k, high quality, photorealistic, razor sharp focus, perfect anatomy, ten fingers, beautiful fingers, beautiful hands, ten toes, beautiful toes, detailed feet, detailed toes, anatomically correct feet, all toes visible, detailed face, natural skin texture, beautiful body curves, fit and toned figure."
