...
# https://prompthero.com/prompt/2a1ac14206d-flux-flux-11-pro-prompt-a-breathtaking-fantasy-portrait-of-a-mysterious-woman-with-flowing-long-blue-hair-that-shimmers-like-moonlight-her-serene

# Default values for each prompt section
DEFAULT_SUBJECT = "A breathtaking photography of a young beautiful Korean woman with soft idol aesthetics, flowing, long wavy deep blue hair."

DEFAULT_FACE = "She has a fair complexion with a dewy and luminous glow. She is wearing striking bright blue contact lenses, vivid and captivating. She has long, wavy, flowing deep blue hair. Her expression is soft and serene, lips lightly parted, gazing gently toward the viewer."

DEFAULT_POSE_HEAD = "Her serene expression illuminated by soft ambient lighting, delicate features glowing with an ethereal radiance."

DEFAULT_POSE_BODY = "Elegant posture, off-shoulder design exposing her smooth, radiant skin, glowing softly under cool atmospheric lighting."
...
DEFAULT_TOP = "Elegant deep-blue gown with intricate lace details, adorned with glistening beads that reflect the ambient light. Off-shoulder design."
...
DEFAULT_SETTING = "Cosmic dark-blue expanse with floating luminescent specks. Tiny particles of sparkling dust swirling around her, creating a dreamlike celestial atmosphere."

DEFAULT_LIGHTING = "Soft cinematic ambient lighting, ethereal radiance, cool atmospheric glow, masterful depth-of-field effects."

DEFAULT_CAMERA = "Hyper-realistic skin textures, intricate hair detailing, high-resolution rendering, elegance, celestial dreamlike atmosphere."
