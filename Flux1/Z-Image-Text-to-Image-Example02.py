...
# 섹션 기본값 (Z-Image 모델에 맞춘 자연스러운 프롬프트 스타일로 개선)
...
FOOT = "Standing naturally, both feet fully visible in the frame."

LEG = "Legs positioned gracefully, standing upright."
...
BODY = "Tall and elegant posture, facing the camera naturally with relaxed shoulders."

ARM = "Arms resting casually at her sides."

HAND = "Hands with delicate fingers, relaxed naturally."

FOOTWEAR = "Clean and stylish white canvas sneakers."

LEGWEAR = "Bare legs with smooth skin."

BOTTOM = ""

TOP = "Dark navy chiffon long dress with thin spaghetti straps and delicate pink cherry blossom prints. The dress has a flowy A-line skirt with a subtle side slit catching a light spring breeze."

HEADWEAR = ""

ARMWEAR = ""

HEAD = "Head gently tilted, relaxed and natural look."

SETTING = "A beautiful spring street in Seoul, cherry blossom trees in full bloom, pink petals gently falling in the air, creating a vibrant and romantic atmosphere."

LIGHTING = "Soft natural spring daylight, cinematic lighting, gentle rim light on the hair, flawless and even illumination on the face."

CAMERA = "Full body shot, camera at waist level, sharp focus on the subject, 85mm lens, f/1.8, soft creamy bokeh background."

POSITIVE = "masterpiece, best quality, highly detailed, ultra-realistic, 8k, raw photo, photorealistic, beautiful aesthetic, perfect anatomy."

NEGATIVE = "blurry, low quality, bad anatomy, deformed, worst quality, mutated, extra limbs, watermark, text, out of frame, cropped, distorted."
