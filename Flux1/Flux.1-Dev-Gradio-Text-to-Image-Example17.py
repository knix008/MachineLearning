...
DEFAULT_SUBJECT = "A photorealistic, high-quality portrait image of a young skinny Korean woman with a soft, idol aesthetic."
...
DEFAULT_POSE = "Tall-kneeling pose, body upright and facing the camera with vertical thighs. Both arms fully raised high above the shoulders, elbows bent and pointing outward, hands interlaced behind her neck. Armpits fully exposed. Hips pushed upward and forward, pelvis tilted to accentuate the curves. Waist slightly twisted to one side to create a natural S-curve silhouette. Chest pushed forward, waist pinched inward. Glamorous and seductive pose."
