...
def generate_image(
    ...
    try:
        ...
        if input_image is not None:
            ...
            negative_prompt = "blurring, low quality, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username"
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            prompt_input = gr.Textbox(
                ...
                value="photorealistic, ultra high definition, ultra high resolution, 8k resolution, ultra detail, realistic shadows, high quality",
                # value="photorealistic, ultra high definition, ultra high resolution,8k resolution, ultra detail, realistic shadows, high quality, masterpiece, best quality, perfect anatomy, good hair, good fingers, good legs",
                lines=4,
            )
