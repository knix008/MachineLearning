...
DEFAULT_POSE = "Both knees resting on the floor in a high-kneeling position, thighs vertical and perpendicular to the ground. Body and torso fully facing the camera directly. Upper body upright and tall. The lower legs (shins) are behind, with the tops of the feet flat on the floor. Confident and alluring expression directed straight at the camera. One hand raised, fingers gently and seductively touching her hair. The other hand resting softly on her thigh. Hips slightly tilted forward in a sexy, confident pose. Full body visible from head to knees. Glamorous, alluring model pose with sensual energy."
