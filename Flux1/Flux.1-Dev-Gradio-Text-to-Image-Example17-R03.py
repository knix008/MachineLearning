...
DEFAULT_QUALITY = ""
DEFAULT_ANATOMY = "Perfect anatomy."
DEFAULT_SUBJECT = "A photorealistic, high-quality portrait image of a young skinny Korean woman with a soft, idol aesthetic, with model pose and composition, in a minimalist studio setting."
...
DEFAULT_POSE = "Standing upright on both feet, body tall and erect. Weight shifted slightly to one hip, creating a natural contrapposto stance. Torso slightly twisted to a three-quarter angle toward the camera. Both arms raised high and wide apart, elbows pointing outward, hands interlaced behind her neck. Chest pushed forward, waist pinched inward. Hips tilted to accentuate the S-curve silhouette. Glamorous and seductive standing model pose."
...
DEFAULT_LIGHTING = ""
DEFAULT_CAMERA = "Full body shot from head to knees. Camera positioned at belly button height, angled slightly upward. Soft bokeh background. Shot with a 35mm lens."
