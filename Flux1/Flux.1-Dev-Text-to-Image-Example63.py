...
SUBJECT = "A full body photography of a beautiful young skinny Korean woman with soft idol aesthetics standing on a casual spring, smile with closed mouth."

FOOT = "Both feet touching each other, inner edges of feet in contact, no gap between feet, toes pointing forward, white sneakers pressed side by side, feet entirely in frame and not cropped."

LEG = "One leg straight bearing full body weight, opposite knee softly bent inward while the foot remains touching the other foot."

FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is a gentle closed-lip smile, lips pressed together and softly curved upward, teeth not showing, slightly shy and sweet with rosy cheeks, eyes curved warmly. She has long wavy voluminous jet-black hair."

BODY = "Body facing the camera, leaning very slightly forward in a shy playful way, natural weight shift onto one supporting leg creating a gentle hip tilt, feminine S-curve silhouette accentuated."

ARM = "Both arms reaching naturally behind her back, elbows slightly bent, hidden behind her body."

HAND = "Both hands clasped together behind her lower back, fingers intertwined, completely hidden behind her body."

FOOTWEAR = "Clean white canvas sneakers, simple and casual."

LEGWEAR = "Bare legs, smooth and fair skin visible through the skirt slit, feet touching and ankles together."

BOTTOM = ""

TOP = "Long pure white chiffon one-piece dress, thin spaghetti straps, bare shoulders, fully opaque, densely covered all-over floral print with many tiny miniature flowers in soft pink and white covering the entire fabric, fitted waist, flowing A-line skirt with a high side slit starting at mid-thigh level, slit revealing the bare leg from mid-thigh downward."

HEADWEAR = ""

ARMWEAR = ""

HEAD = "Head tilted slightly to one side, chin slightly down, hair draping naturally over shoulders."

SETTING = "Bright spring street in Seoul, cherry blossom trees lining the sidewalk with pink petals falling gently."

LIGHTING = "Bright even spring daylight, soft frontal natural light, face clearly and brightly lit, no harsh shadows."

CAMERA = "Full body shot, entire body from head to feet fully in frame, feet and sneakers not cropped, low angle camera at knee height, slight upward tilt, elongated leg perspective, sharp focus, soft bokeh background."

POSITIVE = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, staggered legs, walking pose, legs far apart, stepping, spread legs, wide stance, stiff pose, flat posture, hands visible in front, arms at sides, hands on hips, open mouth, teeth showing, laughing, grinning."
