...
# Outfit
DEFAULT_OUTFIT = "She is wearing a loose, flowy semi-sheer white sundress with an off-shoulder asymmetric neckline — one shoulder is fully covered by the dress strap while the other shoulder is completely bare and exposed. Underneath she is wearing a very tiny black bra and very tiny black panties. The thin black bra straps and tiny black bra cups are faintly visible through the sheer white fabric of the dress. The dress hem is slightly lifted by the sea breeze and her walking motion, just barely revealing the very bottom edge of her tiny black panties peeking out between her thighs — only a subtle hint of black underwear visible. A slim black leather belt is cinched at her waist. The lightweight breezy fabric gently billows in the sea wind."
