...
DEFAULT_SUBJECT = "A full body photography of a beautiful skinny young Korean woman standing at a luxury hotel swimming pool wearing a thong bikini, body fully facing the camera, bare feet on the poolside deck."

DEFAULT_POSE_FOOT = "Both feet together, side by side, flat on the poolside deck, bare feet."

DEFAULT_POSE_LEG = "Both legs straight and fully extended, close together, not bent, standing upright, long slender legs clearly visible."
...
DEFAULT_POSE_BODY = "Body facing directly and fully toward the camera, chest and torso completely frontal, posture upright and confident."

DEFAULT_POSE_ARM = "One arm bent at the elbow with hand resting on the hip, the other arm hanging naturally and relaxed at the side."

DEFAULT_POSE_HAND = "One hand placed on the hip with fingers resting naturally, the other hand relaxed with fingers lightly extended hanging at the side."

DEFAULT_FOOTWEAR = ""

DEFAULT_LEGWEAR = ""

DEFAULT_BOTTOM = "Wearing a tiny light pink thong bikini bottom, minimal coverage, bare hips fully exposed, sky blue string ties at the hips."

DEFAULT_TOP = "Wearing a tiny light pink triangle bikini top, minimal coverage, thin sky blue string ties at the neck and back, bare midriff fully exposed."
...
DEFAULT_LIGHTING = "Brilliant direct sunlight hitting the subject straight from the front, face and entire body completely and evenly front-lit, high-key bright exposure, skin glowing and luminous, zero shadows on the body or face, front-lit only."
...
DEFAULT_CAMERA = "35mm lens, three-quarter body shot from sufficient distance, waist-level angle, tack sharp focus."
