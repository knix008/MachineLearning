...
DEFAULT_POSE = "Kneeling upright on both knees spread wide apart, hips fully raised high above the heels, thighs spread open. Hands interlaced behind the head, elbows wide. Back arched, chest forward, hourglass silhouette emphasized. Sultry gaze into the camera, lips softly parted. Seductive and confident kneeling pose."
DEFAULT_SETTING = "Clean dark studio environment. Deep charcoal dark gray gradient background, nearly black. Dark floor with a slightly wet, faintly reflective surface. Subtle water reflections and light glints visible on the floor beneath and around her."
DEFAULT_LIGHTING = "Medium-key studio lighting with a dark background. Soft frontal light source evenly illuminating the face and body with gentle, flattering light. Subtle highlights catching the sparkly texture of the bikini fabric and the skin on the shoulders and chest. Background kept very dark to create strong subject-background contrast. No harsh shadows, smooth and clean skin illumination."
DEFAULT_CAMERA = ""
