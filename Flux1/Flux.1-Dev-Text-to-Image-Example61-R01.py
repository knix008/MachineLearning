...
# CLIP는 ~77토큰(Subject+Positive), 네거티브도 동일 한도. T5는 섹션 합+Positive가 max_sequence_length(기본 512) 이내 — 중복은 잘림·노이즈를 키우므로 의상은 TOP/LEGWEAR에 집중.
SUBJECT = "Full body photograph of a beautiful skinny young Korean woman with a soft idol aesthetic, standing at a beach hotel outdoor pool deck wearing a black bodycon mini dress and pantyhose with side slit and black stiletto heels."

FOOT = "Both feet together, inner edges touching, heels side by side, feet parallel on the deck."

LEG = "Both legs fully straight, knees fully extended; thighs close together."

FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is a gentle soft smile with lips closed, no teeth showing, looking directly at the camera. She has long wavy voluminous jet-black hair with beautiful soft waves and curls, draping naturally over her shoulders."

BODY = "Weight fully shifted onto one leg, hip pushed outward to that side creating a clear S-curve and visible waist-to-hip ratio; waist narrow, hips wide and rounded."

ARM = "Both arms hanging naturally at sides, slightly away from the hips."

HAND = "Hands relaxed, fingers lightly extended."

FOOTWEAR = "Black pointed-toe stiletto pumps, thin spike heels."

LEGWEAR = "Sheer white fishnet pantyhose covering both legs from waist to feet inside the shoes, diamond mesh pattern."

BOTTOM = ""

TOP = "Sleeveless black bodycon mini dress, deep plunging V-neckline, very short hemline well above mid-thigh, extremely tight fit hugging waist and hips, curves of waist and hips clearly defined through the fabric, side slit on one side from the mid-thigh hemline revealing the leg."

HEADWEAR = ""

ARMWEAR = "Delicate gold chain necklace at the neckline, delicate gold chain bracelet on one wrist."

HEAD = "Head tilted very slightly to one side, relaxed."

SETTING = "Beach hotel outdoor swimming pool deck, glowing blue pool water, ocean and blue sky in the background, bright sunny day."

LIGHTING = "Strong direct frontal sunlight illuminating the entire figure evenly from the front, face and full body brightly and clearly lit, no shadows on the front of the figure."

CAMERA = "Full body shot from head to heel tips, knee level camera angle to elongate legs, entire body in frame with generous empty space below heel tips, sharp focus on subject, soft bokeh on distant background."

POSITIVE = "8k, photorealistic, sharp focus, perfect anatomy, ten fingers, full body, beautiful feminine curves, heels in frame."

NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, cropped feet, cropped heels, missing shoes, feet apart, wide stance, legs apart, ankles apart, gap between feet, one foot forward, walking pose, staggered legs, crossed legs, legs overlapping, bent knee, flexed knee, bent leg, no hip curve, flat silhouette, boxy figure, equal weight on both legs, bikini, swimsuit, bare legs, no pantyhose, black pantyhose, opaque tights, no jewelry, bare neck, motion blur, hazy."
            ...
            with gr.Column(scale=1):
                ...
                with gr.Accordion(
                    ...
                    prompt_foot = gr.Textbox(
                        ...
                        value=FOOT,
                        lines=1,
                        placeholder="예: feet in heels together, toes forward",
                        info="발의 위치를 설명합니다.",
                    )
                    ...
                    prompt_footwear = gr.Textbox(
                        ...
                        value=FOOTWEAR,
                        lines=1,
                        placeholder="예: black stiletto heels, pumps",
                    ...
                    prompt_legwear = gr.Textbox(
                        ...
                        value=LEGWEAR,
                        lines=1,
                        placeholder="예: sheer white pantyhose",
                    ...
                    prompt_bottom = gr.Textbox(
                        ...
                        value=BOTTOM,
                        lines=2,
                        placeholder="예: short tight dress skirt, mini hem",
                    ...
                    prompt_top = gr.Textbox(
                        ...
                        value=TOP,
                        lines=2,
                        placeholder="예: black bodycon one-piece dress",
                    ...
                    prompt_armwear = gr.Textbox(
                        ...
                        value=ARMWEAR,
                        lines=1,
                        placeholder="예: gold necklace, gold bracelet",
                        info="목걸이, 팔찌, 장갑, 소매 장식 등을 설명합니다.",
                    )
                ...
                with gr.Accordion(
                    "포지티브 프롬프트 (Positive · CLIP · T5 공통 사용)", open=False
                ):
                ...
                with gr.Accordion(
                    "네거티브 프롬프트 (Negative · True CFG)", open=False
                ):
