...
LIGHTING = "Large windows with white curtains provide soft diffused natural-looking light. The background is softly blurred with gentle bokeh."
            ...
            with gr.Column(scale=1):
                ...
                with gr.Accordion("프롬프트 섹션 (Subject · 포즈 · 의상 · 배경 · 조명 · 카메라)", open=True):
                    prompt_subject = gr.Textbox(
                        ...
                        info="T5 프롬프트 맨 앞. CLIP에는 Subject만 들어갑니다.",
                    )
