...
# https://prompthero.com/prompt/77692960830-stable-diffusion-35-large-ultra-detailed-cinematic-portrait-of-a-hong-kong-female-cyborg-navy-and-white-metallic-limbs-partially-broken-revealing-internal-machinery

# Default values for each prompt section
DEFAULT_SUBJECT = "Ultra-detailed cinematic portrait of a beautiful young Korean female cyborg with soft idol aesthetics, navy and white metallic limbs partially broken revealing internal machinery, realistic skin texture and sharp facial and body features, intense focused expression, hyper-realistic photorealism, sci-fi concept art, mechanical complexity."
...
DEFAULT_POSE_HEAD = "Intense focused expression, sharp facial features."

DEFAULT_POSE_BODY = "Navy and white metallic limbs partially broken revealing internal machinery and circuitry beneath realistic skin. Mechanical complexity, futuristic technology."
...
DEFAULT_SETTING = "Clean white background with technical sketch lines and blueprint elements, concept art style."

DEFAULT_LIGHTING = "Dramatic lighting, sharp focus, cinematic depth."

DEFAULT_CAMERA = "8K resolution, ultra-high detail, cinematic depth, hyper-realistic photorealism."
