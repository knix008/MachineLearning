...
DEFAULT_SUBJECT = "Photorealistic full-body shot of a stunning young Korean woman, head to feet, white ankle socks and white sneakers, body visibly drenched in sweat."

DEFAULT_FACE = "She has a fair complexion drenched in sweat, fine beads of perspiration covering her forehead, cheeks, neck, and lips, skin intensely dewy and luminous with strong specular highlights. She has long, straight jet-black hair slightly damp and clinging to her skin. Her expression is soft and serene, eyes completely closed, lips lightly parted."

DEFAULT_POSE_HEAD = "Head tilted back, eyes closed, lips gently parted. Sweat glistening on her temples, neck, and collarbones."

DEFAULT_POSE_BODY = "Body angled slightly, back arched, hips pushed forward in an S-curve. Skin drenched in sweat, shiny and reflective under flash light."

DEFAULT_POSE_ARM = "Right arm raised above her head, wrist relaxed. Sweat glistening on the inner arm."

DEFAULT_POSE_HAND = "Left hand resting across her nose and cheek, partially obscuring her features. Ten fingers visible."

DEFAULT_POSE_LEG = "Legs fully visible, slight weight shift to one side. Thighs and shins glistening with sweat."

DEFAULT_POSE_FOOT = "Feet clearly visible, wearing white sneakers with white ankle socks neatly folded above the shoe line."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Tiny metallic dark charcoal bra, glossy and reflective. Oversized dark navy blazer worn open, framing her bare torso."

DEFAULT_BOTTOM = "Tiny metallic dark charcoal thong, glossy and reflective, resting high on her hips."

DEFAULT_LEGWEAR = "White ankle socks, clean and crisp."

DEFAULT_FOOTWEAR = "White sneakers, clean and bright."

DEFAULT_ARMWEAR = "A very thin, delicate gold chain bracelet visible on her raised wrist."

DEFAULT_SETTING = "Dark grunge-themed room, wall collaged with vintage music posters. Kurt Cobain poster on the left, yellow 'MUSIC' poster on the right. Dark leather sofa in the shadows."

DEFAULT_LIGHTING = "Intense direct flash lighting, strong specular highlights on sweat-drenched skin, stark black shadow on the wall behind, gritty late-night editorial aesthetic."

DEFAULT_CAMERA = "Chest-level vertical full-body shot from head to toe, feet clearly visible. 35mm flash style, sharp focus, 8k resolution. Perfect anatomy."
