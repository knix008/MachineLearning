...
DEFAULT_SUBJECT = "A photography of an beautiful skinny Korean woman with wet skin, a soft idol aesthetic."

DEFAULT_FACE = "Wearing striking blue contact lenses, a fair complexion with completely drenched glistening skin, heavy rivulets of water streaming down her face, neck, and chest, every surface of her skin visibly soaked and dripping. Long, wavy jet-black hair utterly soaked and waterlogged, thick heavy wet strands plastered across her forehead, face, neck, and shoulders, water dripping continuously from her hair ends. Her expression is confident and serene, gazing directly at the camera, lips softly parted in a gentle smile."

DEFAULT_POSE_HEAD = ""

DEFAULT_POSE_BODY = "Three-quarter pose, torso angled about 30 degrees from the camera, waist clearly defined, hip curve fully accentuated."

DEFAULT_POSE_ARM = "Both arms relaxed and hanging naturally at her sides."

DEFAULT_POSE_HAND = "Both hands loosely open, fingers naturally relaxed."

DEFAULT_POSE_LEG = "One leg straight bearing full weight, the other knee bent with heel lifted, creating a natural S-curve silhouette."

DEFAULT_POSE_FOOT = "One foot flat, the other foot with heel raised and toes pointed, accentuating the leg line."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Extremely tiny light blue string bikini top with minimal triangular cups barely covering the nipples, completely soaked and clinging tightly to her skin, thin string ties visible."

DEFAULT_BOTTOM = "Extremely tiny light blue string thong bikini bottom, completely soaked and clinging tightly to her body, thin side strings tied at the hips, wet fabric glistening with specular highlights."
...
DEFAULT_SETTING = "Standing right at the very edge of an outdoor swimming pool at night, toes at the pool rim with glowing pool water directly behind her, wet pool tiles underfoot."
...
DEFAULT_CAMERA = "Full-body shot, slightly low angle to elongate legs, telephoto lens from several meters away, high-speed shutter freezing water droplets, softly blurred background."
