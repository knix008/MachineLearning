...
DEFAULT_SUBJECT = "A photorealistic image of a beautiful young skinny Korean woman standing on a sunny beach, wearing white sandals and a tiny light pink bikini with sky blue string straps."
...
DEFAULT_POSE_LEG = "Both legs naturally standing, one leg straight, the other very slightly relaxed, feet side by side, full leg line visible from hip to ankle."

DEFAULT_LEGWEAR = ""

DEFAULT_POSE_FOOT = "Both feet and sandals completely and clearly visible at the very bottom of the frame, generous empty space below the feet, nothing cropped below the ankles."

DEFAULT_FOOTWEAR = "Wearing white flat open-toe sandals, both sandals sharply rendered and fully visible, white toe strap and ankle strap clearly shown, soles visible, feet resting on the sand."

DEFAULT_POSE_ARM = "Both arms relaxed at her sides."

DEFAULT_ARMWEAR = ""

DEFAULT_POSE_HAND = "Both hands loosely relaxed, fingers lightly extended."

DEFAULT_POSE_BODY = "Body turned slightly to a three-quarter angle, hips shifted to one side, waist and hip curve clearly visible in profile, slender waist and feminine silhouette emphasized, relaxed and effortless posture."

DEFAULT_TOP = "Wearing a very tiny light pink triangle bikini top, extremely minimal coverage, thin sky blue string straps, barely covering the chest."

DEFAULT_BOTTOM = "Wearing a very tiny light pink thong bikini bottom, extremely minimal coverage, thin sky blue string straps, barely covering the hips."

DEFAULT_SETTING = "Bright sunny summer beach, clear blue sky, white sandy shoreline, turquoise ocean waves in the background, warm tropical summer day, vibrant beach atmosphere."

DEFAULT_LIGHTING = "Sun shining directly from the front onto the subject, bright frontal sunlight fully illuminating the face and body, face and body brightly lit, no shadows on the face, no backlight, natural skin tones preserved."

DEFAULT_CAMERA = "35mm lens, full body shot, camera at waist height, entire body from top of head to bottom of sandals fully in frame, extra margin below the sandals, sandals sharply in focus and fully visible, sharp focus throughout, no depth of field blur."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, photorealistic, perfect anatomy, ten fingers, sharp focus, highly detailed, ten toes, beautiful fingers, beautiful toes."

DEFAULT_NEGATIVE_PROMPT = "Blurry, out of focus, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, barefoot, feet cropped, sandals cropped, missing sandals, ankles cropped, depth of field blur."
