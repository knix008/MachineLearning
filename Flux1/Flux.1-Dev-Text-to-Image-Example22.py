...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman standing on a sunny beach."
...
DEFAULT_POSE_FOOT = "Both feet side by side, parallel to each other, toes pointing forward, white sneakers clearly shown side by side, feet fully in frame, not cropped."
...
DEFAULT_SETTING = "Sunny sandy beach, turquoise ocean waves behind her, clear blue sky, bright summer day."
