...
DEFAULT_POSE_BODY = "She poses thoughtfully, her form exuding both otherworldly wisdom and a deep passion for charting the unknown. Her pose is elegant and commanding, radiating serene focus and profound curiosity."

DEFAULT_POSE_ARM = "Ethereal angelic tattoos in glowing gold and blue patterns swirl along her arms, adding an otherworldly and adventurous charm."

DEFAULT_POSE_HAND = "She holds a holographic map projector and a customized astrolabe that seems to resonate with celestial energy, ready to chart unexplored dimensions and map pathways through the cosmos."
...
DEFAULT_TOP = "She wears a modern tailored outfit crafted from shimmering white and celestial blue materials, interwoven with flexible plating, angelic sigils, and holographic map projections. Luminous whites, soft blues, and shimmering golds creating a divine and exploratory contrast."

DEFAULT_BOTTOM = "The outfit continues with intricate celestial patterns, flexible fabrics that seem to shift with starlight, and embedded crystals that enhance her navigational skills, designed for both comfort and charting the cosmos."
...
DEFAULT_SETTING = "A vivid combination of a celestial observatory and swirling abstract energy currents in hues of luminous white, soft blue, and shimmering gold, emphasizing her divine knowledge and passion for exploration."
