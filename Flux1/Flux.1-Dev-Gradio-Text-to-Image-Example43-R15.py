...
DEFAULT_NEGATIVE = "Perfect anatomy, perfect body, no extra fingers, no missing fingers, no fused fingers, no deformed fingers, no extra limbs, no distorted body, no blurry face, no bad anatomy."
