...
DEFAULT_POSE = "Kneeling upright on both knees spread wide apart on the floor, hips fully raised high above the heels, thighs spread open at a wide angle. Body fully erect, facing directly forward toward the camera. Both hands interlaced behind the head, elbows flared wide. Back arched, chest pushed forward, waist pinched inward. Sultry heavy-lidded gaze into the camera, lips softly parted. Seductive and confident kneeling pose."

DEFAULT_SETTING = "Dark, dramatic studio setting. Deep dark gray to near-black seamless background. Smooth dark floor with a faint reflective surface. Moody and intense atmosphere."
...
DEFAULT_CAMERA = "Full body shot from head to toe including the feet and heels, vertical composition. Camera pulled back sufficiently to capture the entire figure with comfortable margin. Subject centered in frame. Sharp focus across the full body. Shot with a 50mm lens."
