...
DEFAULT_POSE = "Standing upright, legs straight, feet slightly apart, full body facing the camera. Both arms raised upward, hands interlaced behind the neck, elbows pointing outward and upward. Chest lifted and pushed forward, shoulders rolled back. Hips tilted slightly to one side for a seductive S-curve. Sultry expression, eyes gazing directly into the camera. Full body in frame, camera at belly button height."
...
DEFAULT_CAMERA = "Full body shot, entire figure fully visible in frame with comfortable padding. 35mm lens, f/2.8, camera at belly button height, perfectly centered. Vertical portrait orientation. No cropping."
