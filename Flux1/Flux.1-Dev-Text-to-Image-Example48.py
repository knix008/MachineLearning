...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetic, posing gracefully in a bright indoor studio setting."

DEFAULT_FACE = "She has a fair, clear complexion. Wearing striking bright blue contact lenses contrasting with her dark hair. Long straight jet-black hair falling softly over her shoulders. Calm and elegant expression, lips closed with a subtle gentle smile, looking directly and confidently toward the camera."
...
DEFAULT_TOP = "Crisp white school uniform blouse, fitted and neat. Tiny small red ribbon tied neatly at the collar like a miniature necktie bow, solid red color, very small and delicate."
...
DEFAULT_FOOTWEAR = "Black school girl shoes."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Bright and clean indoor room, walls covered with soft pastel blue patterned wallpaper featuring delicate floral and vine motifs, elegant decorative wallpaper as background, large bright window on the side letting in natural light, sheer white curtains gently draping beside the window, polished floor, airy and spacious room atmosphere."

DEFAULT_LIGHTING = "Bright indoor studio lighting, soft diffused light from multiple directions, clean and even illumination with gentle shadows, fresh and airy atmosphere."

DEFAULT_CAMERA = "35mm portrait lens, slightly low angle full body shot from below eye level, low angle perspective making legs appear longer and more elegant, tack-sharp focus on subject, shallow depth of field with soft bokeh background. Photorealistic, fashion photography style, 8k resolution, masterpiece. Perfect anatomy, High-fidelity skin textures."
