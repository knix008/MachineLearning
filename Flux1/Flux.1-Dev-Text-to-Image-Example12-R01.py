...
DEFAULT_TOP = "Wearing a very tiny pink bikini top, minimal coverage, thin straps, bare skin exposed."

DEFAULT_BOTTOM = "Wearing a very tiny pink bikini bottom, minimal coverage."

DEFAULT_LEGWEAR = ""

DEFAULT_FOOTWEAR = "Wearing white pool slide sandals, simple flat open-toe slippers."
...
DEFAULT_CAMERA = "Full body shot, entire body from head to toe fully in frame including shoes, feet must not be cropped, natural chest-level angle, sharp focus on the subject, soft bokeh on the background."
