...
# Outfit
DEFAULT_OUTFIT = "She is wearing an ultra-sheer semi-transparent white sundress with thin spaghetti straps on both shoulders. The dress fabric is so thin and translucent that it is nearly see-through — underneath, she is wearing an extremely tiny black micro bra with minuscule triangular cups that barely cover her nipples, and an extremely tiny black micro thong with only the thinnest strip of fabric at the front and thin string sides. The microscopic black underwear is clearly and distinctly visible through the transparent white dress fabric — the tiny bra cups and micro thong are unmistakably visible beneath the sheer white. The dress has a deep side slit on the right leg running up to mid-thigh. The ultra-thin fabric billows and ripples dramatically in the sea wind, the skirt lifting and flowing freely in the breeze. No accessories or cover-up."
