...
# Outfit
DEFAULT_OUTFIT = "She is wearing an ultra-sheer semi-transparent white sundress with thin spaghetti straps on both shoulders. The dress fabric is so thin and translucent that it is nearly see-through — underneath, her very tiny black bra and very tiny black panties are clearly visible through the sheer white fabric, the dark color of the underwear showing distinctly beneath the transparent dress. The dress has a deep side slit on the right leg running up to mid-thigh. The ultra-thin fabric billows and ripples dramatically in the sea wind, the skirt lifting and flowing freely in the breeze. The white sheer fabric glows softly in the sunlight while remaining transparent. No accessories or cover-up."
