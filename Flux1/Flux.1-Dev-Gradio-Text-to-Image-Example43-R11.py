...
DEFAULT_POSE = "Standing upright, legs straight, feet slightly apart, full body facing the camera. Both arms spread wide to the sides, elbows bent, hands clasped at the back of the neck. Hips tilted slightly to one side for a seductive S-curve. Chest lifted, shoulders back. Sultry expression, eyes gazing directly into the camera. Full body in frame, camera at belly button height."
