...
DEFAULT_POSE_LEG = "Both legs straight, knees not bent, standing upright, long slender legs clearly visible."
...
DEFAULT_POSE_BODY = "Fully frontal toward the camera, hips shifted slightly to one side, relaxed natural posture."
