...
DEFAULT_SUBJECT = "A beautiful young skinny Korean woman with a soft idol aesthetic, an angel with enormous pure white feathered wings fully spread wide."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is serene and ethereal, looking directly at the camera with a calm and divine gaze. She has long, voluminous wavy jet-black hair softly flowing down, delicate and luminous."

DEFAULT_POSE_HEAD = "Head held high, chin slightly lifted, face fully illuminated and facing the camera."

DEFAULT_POSE_BODY = "Standing upright, entire front of the body facing the camera, elegant and divine posture."

DEFAULT_POSE_ARM = "Both arms gracefully extended slightly outward and downward along the sides."

DEFAULT_POSE_HAND = "Both hands open, fingers gently spread, palms facing slightly forward."

DEFAULT_POSE_LEG = "Both legs fully visible, legs slightly apart in a confident and elegant stance."

DEFAULT_POSE_FOOT = "Both feet in black stiletto heels, fully visible and not cropped."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Extremely tiny black mesh fishnet micro bra, only covering the nipples, ultra-minimal coverage, very thin straps, sheer translucent black fishnet fabric."

DEFAULT_BOTTOM = "Extremely tiny black mesh fishnet micro panties, only barely covering the crotch area, ultra-minimal coverage, very thin side strings, sheer translucent black fishnet fabric."

DEFAULT_LEGWEAR = "Black garter belt around the waist with suspender straps clipping to black fishnet stockings, black fishnet stockings extending from upper thigh to feet, garter straps clearly visible on the outer thigh."

DEFAULT_FOOTWEAR = "Shiny black stiletto high heels, glossy surface gleaming under the light, both shoes fully visible."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Deep dark void background, pure black with subtle dark blue and violet haze, dramatic contrast between the bright white wings and the dark surroundings."

DEFAULT_LIGHTING = "Divine radiant glow from behind the subject, rim lighting outlining the wings and body with soft golden light, gentle frontal light on the face, heavenly light rays piercing the darkness."

DEFAULT_CAMERA = "Full body shot from a slightly low angle, entire figure from head to feet in frame, both wings fully visible, 35mm lens, sharp focus on the subject."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, ten toes."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, dark wings, black wings, demon, devil, featherless wings, small wings, folded wings."
