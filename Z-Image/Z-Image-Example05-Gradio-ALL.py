...
# Reference Site : https://prompthero.com/prompt/16c71686861-z-image-turbo-the-image-is-a-high-quality-photorealistic-cosplay-portrait-of-a-young-asian-woman-with-a-soft-idol-aesthetic-physical
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                combined_prompt = gr.Textbox(
                    label="최종 프롬프트 (Combined Prompt for Generation)",
