...
def main():
    ...
    with gr.Blocks(title="Z-Image-Turbo Text-to-Image Generator") as interface:
        ...
        gr.Markdown(
            f"Tongyi-MAI/Z-Image-Turbo 모델을 사용하여 텍스트에서 이미지를 생성합니다. (Device: **{DEVICE.upper()}**)"
        )
