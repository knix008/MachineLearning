...
DEFAULT_PROMPT = "A serene, artistic portrait of a cute and young korean instagram-style woman with long, flowing reddish- black hair cascading gracefully around her form, subtly covering her body. She poses playfully yet elegantly, with a warm, inviting expression. medium bust, Soft natural light, gentle blush tones, dreamy atmosphere, painterly style, high detail, ethereal mood."
