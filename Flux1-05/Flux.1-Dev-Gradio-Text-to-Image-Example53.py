...
DEFAULT_QUALITY = "Ultra-realistic masterpiece photograph, 8k resolution, high-fidelity skin textures, intricate lace details, cinematic lighting, realistic lifestyle photography."
...
DEFAULT_OUTFIT = "She is wearing an extremely tiny black string bikini with barely-there coverage, minuscule triangles barely covering her chest and an ultra-thin string bottom. Over it, a long sheer black lace floral robe flowing open over her body. She also wears sheer black thigh-high stockings with wide lace tops."
DEFAULT_POSE = "Standing in the shallow water of a turquoise swimming pool. Both arms hanging naturally and relaxed at her sides, hands empty. Full body vertical shot, posture relaxed and cheerful."
DEFAULT_SETTING = "A sunny outdoor pool deck with clear turquoise blue water. Beautiful outdoor swimming pool surrounded by a bright pool deck. Soft bokeh background of the pool area."
DEFAULT_LIGHTING = "Natural daylight, bright and clear. Sunlight reflecting off the turquoise pool water, creating sparkling highlights. Cinematic lighting with warm tones."
DEFAULT_CAMERA = "Vertical portrait format, eye-level full body shot. Realistic lifestyle photography style, shallow depth of field with soft bokeh of the pool deck in the background."
