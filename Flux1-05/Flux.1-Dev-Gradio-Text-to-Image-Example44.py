...
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic cosplay portrait of a young Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, straight jet-black hair with thick, straight-cut bangs (fringe) that frame her face. Wet hair dripping water down her body. Her eyes are large and expressive, with long lashes. Her entire body is dripping wet, water beads rolling down her skin. Glistening wet skin reflecting sunlight. Water streaming down her arms, torso, and legs."
DEFAULT_OUTFIT = "Wearing an extremely tiny string black mesh see-through bikini with barely-there coverage. The bikini top consists of minuscule triangles held by ultra-thin strings, barely covering her chest. The soaking wet fabric clings tightly to her body, the wet material shimmering in the sunlight. Water dripping from the wet fabric."
DEFAULT_POSE = "She is holding the swimming pool metal ladder, mid-way up. Both hands gripping the ladder rails firmly. One foot on a ladder rung, the other stepping up. Body facing the camera. Water cascading off her entire body as she climbs. Dynamic and sensual climbing pose, emerging from the water."
DEFAULT_SETTING = "In the hotel outdoor swimming pool. Chrome metal pool ladder clearly visible, partially submerged in water. Crystal clear turquoise pool water surrounding the ladder. Her lower body still partially in the water."
DEFAULT_LIGHTING = "Bright warm golden afternoon sunlight. Sun creating a beautiful shimmer on her dripping wet skin and soaked bikini. Pool water reflecting rippling light caustics onto her body and the ladder. Water droplets sparkling in the sunlight as they fall."
DEFAULT_CAMERA = "Camera positioned just above the pool water surface at a very low angle, nearly at water level. Wide-angle shot capturing the rippling water surface in the foreground, the pool ladder in the mid-ground, and her full body climbing up in the frame."
