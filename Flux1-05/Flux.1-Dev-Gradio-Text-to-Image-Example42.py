...
DEFAULT_QUALITY = "Stunning professional photo, 4k, ultra detail, high resolution, photorealistic, RAW photo, ultra-realistic skin texture, sharp focus."
DEFAULT_NEGATIVE = "No extra fingers, no missing fingers, no fused fingers, no extra limbs, no distorted body, no blurry face, no bad anatomy, no anime, no cartoon, no illustration."
DEFAULT_APPEARANCE = "A beautiful Korean woman with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her black hair. Her expression is innocent and curious, looking directly at the camera. She has long flowing black hair cascading past her waist, with a few soft strands framing her face. Her overall look is youthful, ethereal, and captivating. She has fair skin and a brightly smiling expression. Beautiful eyes with a moist and gentle look, long slit eyes. Thin lips. Realistic girl face. Beautiful skin with ultra-realistic skin texture."
DEFAULT_OUTFIT = "Wearing an orange tiny bikini with minimal coverage. The bikini top has a small metallic embellishment at the center."
DEFAULT_POSE = "Lying on her stomach on the sandy beach near the shoreline. Full body visible from head to toe. Body angled diagonally to show the full length of her figure. Head slightly raised, turning gently toward the camera with a relaxed expression."
DEFAULT_SETTING = "Sandy beach near the shoreline. Gentle waves washing over the white fine sand. Clear light blue ocean water. Tropical beach atmosphere."
DEFAULT_LIGHTING = "Sunny day with warm bright sunlight. Sunlight reflecting off the water and the woman's skin. Relaxed tropical atmosphere. Soft natural shadows."
DEFAULT_CAMERA = "Canon EOS R5, 24mm f/8, ISO 200, 1/500s shutter. Camera positioned far from the subject, at a low side angle, shooting slightly downward. Wide environmental shot showing the full body from head to toe including the surrounding beach and ocean. Background well-exposed and clearly visible."
