...
DEFAULT_QUALITY = "vertical ultra-realistic masterpiece photograph, photorealistic, high-fidelity skin textures, 8K resolution, cinematic boudoir photography, masterpiece"
DEFAULT_NEGATIVE = "extra hands, extra legs, extra feet, extra arms, waist pleats, paintings, sketches, worst quality, low quality, low resolution, monochrome, grayscale, skin spots, acnes, skin blemishes, age spot, backlight, mutated hands, poorly drawn hands, blurry, bad anatomy, bad proportions, extra limbs, disfigured, missing arms, fused fingers, too many fingers, unclear eyes, bad hands, missing fingers, extra digit, cleft chin, exposed nipples."
DEFAULT_APPEARANCE = "The image is a high-quality, photorealistic portrait of a beautiful Korean fashion model with a soft, idol aesthetic. She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. She has long flowing black hair, loose and cascading naturally past her waist, with soft waves and a few strands gently framing her face."
DEFAULT_OUTFIT = "She is wearing a very tiny, minimal white sheer see-through micro bra and a matching white sheer see-through micro thong. The lingerie is translucent and barely covering her body."
DEFAULT_POSE = "Three-quarter back view, looking over her shoulder with an intimate expression. Her arms are raised, gently holding sheer white translucent curtains on either side."
DEFAULT_SETTING = "Sheer white translucent curtains surrounding her. Soft-focus background with faint white flowers. Bright, airy, ethereal dreamlike atmosphere with a subtle haze."
DEFAULT_LIGHTING = "Bright, soft, diffused natural light, high-key lighting creating an ethereal dreamy atmosphere. Soft shadows, professional boudoir lighting. Light filtered through sheer curtains."
DEFAULT_CAMERA = "Vertical portrait, 85mm lens, f/1.8, shallow depth of field, soft-focus background, sharp focus on her face and skin, cinematic boudoir photography."
