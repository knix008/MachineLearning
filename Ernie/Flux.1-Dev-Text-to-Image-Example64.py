...
FACE = "She has a fair, clear complexion with a light sun-kissed glow. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is relaxed and confident with mouth gently closed, lips together, a soft gentle smile, looking directly at the camera. She has long straight voluminous jet-black hair draping naturally over her shoulders."

BODY = "Weight shifted onto one straight supporting leg with a subtle hip shift, creating a soft S-curve; body facing completely straight toward the camera, chest and torso fully frontal."
...
BOTTOM = "Very tiny bright white thong bikini bottom with minimal coverage."

TOP = "Very tiny white triangle bikini top with minimal coverage, thin shoulder straps and back tie."
