...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman on a casual spring outing."
...
DEFAULT_POSE_HEAD = "Head held upright with elegant posture, chin slightly lifted."

DEFAULT_POSE_BODY = "Standing naturally in a relaxed upright pose, body facing perfectly straight and completely toward the camera, chest and torso fully frontal, no angling or turning to the side, posture tall and elegant, shoulders back."

DEFAULT_POSE_ARM = "One arm resting naturally at her side, the other arm slightly bent with hand resting gently on her upper thigh, fingers relaxed and graceful."

DEFAULT_POSE_HAND = ""

DEFAULT_POSE_LEG = "One leg slightly in front of the other in a classic model stance, weight shifted elegantly, skirt slit parted naturally revealing the bare leg."

DEFAULT_POSE_FOOT = "Both feet fully visible on the ground, white sneakers clearly shown, feet not cropped."
...
DEFAULT_SETTING = "Peaceful lakeside, calm lake water reflecting the sky, blooming cherry blossom trees along the shore with soft pink petals drifting in the air, warm sunny spring day."
