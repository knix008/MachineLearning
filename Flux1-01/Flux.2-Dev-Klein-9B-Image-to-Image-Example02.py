...
DEFAULT_SUBJECT = "A high-quality, photorealistic full-body portrait of a young Korean woman with a soft, idol aesthetic."
DEFAULT_FACE = "She has a fair, clear, porcelain complexion. She is wearing blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera with no smile."
DEFAULT_POSE_HEAD = "She has long, voluminous wavy jet-black hair with beautiful soft waves and curls."
DEFAULT_POSE_BODY = ""
DEFAULT_POSE_ARM = ""
DEFAULT_POSE_HAND = ""
DEFAULT_POSE_LEG = ""
