...
DEFAULT_POSE_ARM = "Both arms hanging loosely and naturally at her sides, relaxed and effortless."

DEFAULT_POSE_HAND = "Both hands hanging loosely at her sides, fingers naturally relaxed."
...
DEFAULT_TOP = "Loose flowing deep navy blue sleeveless one-piece dress with medium floral print, medium sized flowers loosely scattered across the fabric with breathing space between them, sleeveless with bare shoulders, cinched at the waist, flowing below the waist with a deep front slit starting from the thigh exposing one bare leg through the opening, breezy and lightweight."
...
DEFAULT_ARMWEAR = "Soft ivory knit cardigan worn loosely over the dress, open front unbuttoned, relaxed and casual drape over the shoulders and arms, lightweight and cozy."
