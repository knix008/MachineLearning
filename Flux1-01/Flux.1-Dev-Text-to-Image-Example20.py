...
DEFAULT_POSE_BODY = "Confident and captivating full-body pose, as if inviting the viewer to step into her world, curves and lines outlined with strong expressive strokes."
...
DEFAULT_SETTING = "Clean white backdrop, textured setting."

DEFAULT_LIGHTING = "Dominated by light beige and deep umber tones, strong expressive contrast, dramatic shadows accentuating the figure's curves."

DEFAULT_CAMERA = "Full figure composition, deliberate precision, impactful look inspired by Frazetta, creative expression."
