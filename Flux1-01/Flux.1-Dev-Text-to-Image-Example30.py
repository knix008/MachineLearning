...
# https://prompthero.com/prompt/d28c2877a8e-flux-flux-11-pro-a-stunning-25-year-old-woman-with-porcelain-fair-skin-and-long-wavy-chestnut-hair-sitting-gracefully-at-a-small

# Default values for each prompt section
DEFAULT_SUBJECT = "A stunning 25-year-old beautiful skinny Korean woman with soft idol aesthetic sitting gracefully at a small balcony table overlooking a breathtaking tropical island paradise. Photorealistic, cinematic, hyper-realistic, 8k."
...
DEFAULT_POSE_HEAD = "Long wavy jet-black hair flowing naturally, soft and relaxed."

DEFAULT_POSE_BODY = "Sitting gracefully at a small outdoor balcony table, posture relaxed yet elegant, body slightly angled toward the camera."

DEFAULT_POSE_ARM = "Arms resting naturally on the table or in her lap, relaxed and composed."

DEFAULT_POSE_HAND = "Hands relaxed and resting softly, fingers naturally at ease."
...
DEFAULT_TOP = "Short white leather jacket, clean and modern, fitting neatly over her shoulders."

DEFAULT_BOTTOM = "Soft flowing skirt with a deep side slit, lightweight fabric gently parting as she sits, revealing her bare thigh and a subtle glimpse of white underwear."
...
DEFAULT_SETTING = "Small balcony table with a breathtaking view of a tropical island paradise — turquoise waters, lush greenery, and vibrant scenery stretching into the horizon."

DEFAULT_LIGHTING = "Warm natural daylight, casting gentle shadows and soft highlights on her face, clothing, and the vibrant background. Serene and cinematic atmosphere."

DEFAULT_CAMERA = "8k resolution, cinematic framing, depth of field, ultra-sharp details, filmic atmosphere, photorealistic, detailed fabric and skin textures."
