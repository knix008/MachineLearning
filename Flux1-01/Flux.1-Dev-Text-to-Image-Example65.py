...
# https://prompthero.com/prompt/777602a2357-flux-flux-11-pro-a-striking-photograph-showcases-a-light-skinned-woman-with-long-flowing-platinum-blonde-hair-surrounded-by-a-bed-of-vibrant

# Default values for each prompt section
DEFAULT_SUBJECT = "A striking photograph of a light-skinned Korean woman with long, flowing platinum black hair and a soft idol aesthetic."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, voluminous wavy jet-black hair with beautiful soft waves and curls, dramatically flowing."

DEFAULT_POSE_HEAD = "Gaze turned thoughtfully towards the distance."

DEFAULT_POSE_BODY = "Centered in the frame, body partially covered with lush hydrangeas and roses."

DEFAULT_POSE_ARM = "Both arms reaching out gently to the sides."

DEFAULT_POSE_HAND = "Fingers spread."
...
DEFAULT_SETTING = "Surrounded by a bed of vibrant teal blue hydrangeas interspersed with pale pink roses, flowers filling the entire frame, creating a dreamy and surreal backdrop."

DEFAULT_LIGHTING = "Even and bright lighting with soft diffused illumination, highly saturated visual effect enhancing the intensity of blues and pinks, balanced exposure, neutral white balance."

DEFAULT_CAMERA = "Balanced and symmetrical composition, centered framing emphasizing the immersive floral setting."
