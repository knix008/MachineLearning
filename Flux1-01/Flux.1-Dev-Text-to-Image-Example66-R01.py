...
DEFAULT_SUBJECT = "A highly detailed, photorealistic, cinematic wide shot of a beautiful young skinny Korean woman with a soft idol aesthetic, riding a white horse on a sunny beach, the full body of the horse clearly visible."
...
DEFAULT_POSE_HEAD = "Turned toward the camera, looking directly into the lens."

DEFAULT_POSE_BODY = "Sitting upright on a black saddle atop a white horse, confident and joyful pose."
...
DEFAULT_TOP = "Vibrant red string bikini top, thin straps tied behind her neck."

DEFAULT_BOTTOM = "Matching red string bikini bottom, thin side straps tied at the hips."
...
DEFAULT_SETTING = "Tropical beach during the day, white horse with a dark short-trimmed mane wearing red and orange braided reins, sparkling blue ocean meeting a clear light blue sky at the horizon, soft white waves on sandy shore."
...
DEFAULT_CAMERA = "Side-profile perspective, wide full shot showing the entire horse and rider, slight film grain, sharp focus on both subject and horse."
