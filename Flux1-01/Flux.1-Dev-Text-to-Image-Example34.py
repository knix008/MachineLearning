...
DEFAULT_SUBJECT = "A photorealistic, high-quality full-body portrait of a young beautiful Korean ballerina performing an elegant ballet pose, soft idol aesthetic, graceful and artistic."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, wavy jet-black hair that flows all the way down to her waist."

DEFAULT_POSE_HEAD = "Hair elegantly pulled up into a classic ballet bun, with a few soft strands framing her face. Head held upright with graceful poise."

DEFAULT_POSE_BODY = "Performing a beautiful arabesque — body upright and elongated, weight balanced on one leg, the torso slightly forward with a long, graceful line from head to extended leg."

DEFAULT_POSE_ARM = "Arms extended in a flowing, curved ballet port de bras — one arm raised overhead in a soft arc, the other extended gracefully to the side, creating an elegant and expressive line."

DEFAULT_POSE_HAND = "Fingers softly curved and relaxed, wrists gently curved downward in the classic ballet hand position, delicate and expressive."

DEFAULT_POSE_LEG = "One leg firmly planted as the supporting leg, knee fully extended. The other leg extended behind in a high arabesque, lifted and fully stretched, creating a long, beautiful line."

DEFAULT_POSE_FOOT = "Supporting foot in a full relevé on pointe, balanced and steady. Extended foot fully pointed with a beautifully arched instep."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Delicate white classical ballet tutu with a fitted, structured bodice adorned with fine lace trim and subtle floral embroidery. The skirt layers are short, stiff, and fluffy, fanning out around her hips in a classic romantic silhouette."

DEFAULT_BOTTOM = ""

DEFAULT_LEGWEAR = "Sheer pale pink tights, smooth and form-fitting, accentuating the lines of her legs."

DEFAULT_FOOTWEAR = "White satin pointe shoes with ribbons wrapped neatly around her ankles, elegant and classic."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "A grand classical ballet studio with a polished hardwood floor, large mirrored walls, and tall arched windows."

DEFAULT_LIGHTING = "Soft, diffused natural light from tall windows, casting gentle highlights on her white tutu and skin. Warm and luminous atmosphere, cinematic and artistic."

DEFAULT_CAMERA = "Full body shot from head to toe, capturing the complete arabesque pose. Slightly low angle to emphasize the height and length of the pose. Shot with a 50mm lens, shallow depth of field. Perfect anatomy."
