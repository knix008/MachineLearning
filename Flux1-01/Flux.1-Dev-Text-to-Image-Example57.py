...
DEFAULT_SUBJECT = "A photography of a beautiful young skinny Korean woman sitting at an outdoor cafe, enjoying a cup of coffee."
...
DEFAULT_POSE_HEAD = "Head held naturally, looking gently toward the camera with a soft relaxed expression."

DEFAULT_POSE_BODY = "Sitting naturally and comfortably in a cafe chair, upper body facing forward toward the camera, relaxed and elegant posture."

DEFAULT_POSE_ARM = "One arm resting on the cafe table, the other arm bent with hand holding a coffee cup."

DEFAULT_POSE_HAND = "One hand resting on the table, the other hand holding a coffee cup gently."

DEFAULT_POSE_LEG = "Legs crossed naturally at the knee, skirt slit parted revealing the bare leg."

DEFAULT_POSE_FOOT = "Feet resting naturally on the floor, white sneakers clearly visible."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Loose ivory open-front knit cardigan worn casually over a navy blue midi dress with small delicate floral print in white and pale pink, round neckline, fitted waist, flowing A-line skirt with a front slit from mid-thigh revealing the bare leg, casual spring outing style."

DEFAULT_BOTTOM = ""

DEFAULT_LEGWEAR = (
    "Bare legs, smooth and fair skin naturally visible through the skirt slit."
)

DEFAULT_FOOTWEAR = "Clean white sneakers, casual and sporty, clearly visible on feet."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Charming outdoor open-air cafe terrace, small round cafe table with a coffee cup in front of her, cafe chairs, warm sunny spring day, lush greenery and soft bokeh background."

DEFAULT_LIGHTING = "Bright warm spring daylight, soft natural light, face clearly and brightly lit, pleasant outdoor cafe atmosphere."

DEFAULT_CAMERA = "Three-quarter body shot from the front, subject sitting at a cafe table, sharp focus, soft bokeh background."
