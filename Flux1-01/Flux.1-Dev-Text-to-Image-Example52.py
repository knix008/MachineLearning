...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetic, walking along a bright spring street in Seoul."
...
DEFAULT_POSE_HEAD = "Head upright, hair swaying softly with her walking motion."
...
DEFAULT_POSE_ARM = "Arms swinging naturally and gently with her walking stride, relaxed and casual."

DEFAULT_POSE_HAND = "Hands relaxed and slightly open, swinging naturally at her sides."

DEFAULT_POSE_LEG = "Legs in natural walking stride, one foot forward, weight shifting naturally, long legs elegantly striding."

DEFAULT_POSE_FOOT = "White sneakers stepping lightly on the pavement, mid-stride."
...
DEFAULT_CAMERA = "Full body shot, camera positioned at chest height looking slightly upward, mild low angle perspective making legs appear long and elegant, full body visible from head to toe, sharp focus, fashion photography style."
