...
DEFAULT_SUBJECT = "A photorealistic image of a beautiful young skinny Korean woman standing on a hotel balcony, holding a coffee cup, enjoying the morning."

DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses. Her expression is fresh and youthful with a soft innocent smile.She has long wavy jet-black hair with thick straight-cut bangs framing her face."

DEFAULT_POSE = "She is standing relaxed on the balcony, leaning lightly against the railing with one hand, holding a coffee cup with the other hand raised near her lips. Her body is slightly turned, gaze directed toward the view beyond the balcony."

DEFAULT_OUTFIT = "Wearing black lace bra and black panties, black thigh-high stockings with a black garter belt attached. Black high heels on her feet."

DEFAULT_SETTING = "Luxury hotel balcony with a glass or iron railing, overlooking a bright cityscape or lush landscape. Small balcony table with a coffee pot nearby. Warm sunny morning atmosphere."

DEFAULT_LIGHTING = "Bright warm morning sunlight streaming in from the side, golden hour glow, soft natural shadows, clear blue sky, 8k high detail."

DEFAULT_CAMERA = "Eye-level medium shot, slight low angle, 50mm lens, tack-sharp focus, professional photography."
