...
DEFAULT_SUBJECT = "A photorealistic full-body portrait of a beautiful young slender Korean woman dressed as a real-world princess in an outdoor garden setting. Hyperrealistic, high-fashion editorial photography, natural textures and precise detailing."
...
DEFAULT_POSE_HEAD = "Long black hair flowing gracefully in soft natural waves, poised and regal."

DEFAULT_POSE_BODY = "Confident, upright posture with a warm and approachable expression. Slender, feminine figure with elegant and graceful bearing, facing the camera."

DEFAULT_POSE_ARM = "Arms relaxed at her sides with a natural, ladylike elegance."

DEFAULT_POSE_HAND = "Hands delicate and relaxed, fingers naturally curved."

DEFAULT_POSE_LEG = ""

DEFAULT_POSE_FOOT = ""

DEFAULT_HEADWEAR = "Delicate gold tiara with embedded gemstones, perched elegantly atop her hair."

DEFAULT_TOP = "Elegant pink ball gown with intricate golden embroidery, inspired by European royal court fashion. Shimmering satin fabric with a fitted bodice and sweetheart neckline adorned with fine golden trim. Real haute couture craftsmanship."

DEFAULT_BOTTOM = "Full, voluminous skirt in layered satin and organza, flowing gracefully to the ground with golden embroidered hem details."

DEFAULT_LEGWEAR = ""

DEFAULT_FOOTWEAR = "Elegant gold heels partially visible beneath the gown's hem."

DEFAULT_ARMWEAR = ""

DEFAULT_SETTING = "Lush outdoor royal garden with blooming flowers, manicured hedges, and a grand stone castle visible in the soft background. Natural landscape."

DEFAULT_LIGHTING = "Natural golden afternoon sunlight, soft and warm, casting gentle highlights on the gown and skin. Realistic and cinematic."

DEFAULT_CAMERA = "8k resolution, cinematic photography, photorealistic, detailed fabric and skin textures, natural color palette."
