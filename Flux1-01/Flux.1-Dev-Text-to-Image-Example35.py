...
DEFAULT_SUBJECT = "A photorealistic, high-quality full-body portrait of a young beautiful Korean ballerina with soft idol aesthetic, graceful and artistic."
...
DEFAULT_POSE_HAND = "Fingers softly curved and relaxed, wrists gently curved downward in the classic ballet hand position, delicate and expressive. Ten fingers visible."
...
DEFAULT_TOP = "Delicate white classical ballet tutu with a fitted, structured bodice adorned with fine lace trim and subtle floral embroidery. The skirt layers are short, stiff, and fluffy, fanning out around her hips."
...
DEFAULT_SETTING = "A bright indoor room with sky blue-painted walls, a hardwood floor, and floor-to-ceiling windows with sheer white curtains billowing in the breeze."

DEFAULT_LIGHTING = "Bright front-facing studio light illuminating the subject evenly, soft and flattering, making the skin and outfit appear clean and luminous. Well-lit, no harsh shadows."

DEFAULT_CAMERA = "Full body shot from head to toe. Slightly low angle, 50mm lens, shallow depth of field. Perfect anatomy."
