...
# https://prompthero.com/prompt/153e921b278-midjourney-61-a-stunning-portrait-of-a-woman-art-nouveau-style-with-vibrant-neon-colors-body-paint-pink-and-blue-iridescent-skin

# Default values for each prompt section
DEFAULT_SUBJECT = "A stunning portrait of a young beautiful Korean woman with soft idol aesthetics, art nouveau style, vibrant neon colors, body paint in pink and blue, iridescent skin, glowing makeup, photorealistic, 8k."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is soft and serene with a gentle, subtle closed-lip smile, lips lightly pressed together, not parted. She has long, wavy jet-black hair."

DEFAULT_POSE_HEAD = "Soft focus, intricate details, long dark hair."

DEFAULT_POSE_BODY = "Iridescent skin with body paint in pink and blue, glowing and luminous."
...
DEFAULT_TOP = "Top made of finely patterned fabric with intricate detailed texture. The fabric shifts in color under dramatic neon lighting, displaying vibrant hues of pink, blue, and violet across its surface, creating a rich multi-colored iridescent effect."
...
DEFAULT_ARMWEAR = "Elegant jewelry."

DEFAULT_SETTING = "Art nouveau style background, high contrast, bokeh, fashion photography."

DEFAULT_LIGHTING = "Dramatic lighting, vibrant neon colors, shallow depth of field."

DEFAULT_CAMERA = "8K resolution, photorealistic, soft focus, bokeh."
