...
DEFAULT_SUBJECT = "A confident young Korean woman with a soft, idol aesthetic,stands near an open balcony of a lavish Parisian penthouse at sunset, photorealistic, high-fashion editorial photography, cinematic luxury inspired by Slim Aarons."
...
DEFAULT_POSE_HEAD = "Long chestnut hair styled in loose, wind-touched waves flowing softly around her shoulders."

DEFAULT_POSE_BODY = "Softly curvy figure with a defined waist and elegant posture, body facing directly toward the camera, poised and graceful."
...
DEFAULT_TOP = "Delicate ivory lace lingerie with intricate floral embroidery and sheer panels that catch the warm amber light."

DEFAULT_BOTTOM = "Silk garters attached to the lingerie, catching the amber sunset light with a soft sheen."
...
DEFAULT_SETTING = "Lavish Parisian penthouse interior with white-and-gold art deco elegance, open balcony overlooking the glowing Eiffel Tower. Champagne flutes resting on a marble table beside her."

DEFAULT_LIGHTING = "Warm golden amber sunset light streaming through the open balcony, soft highlights on skin and lace, dramatic yet luxurious atmosphere."

DEFAULT_CAMERA = "Dramatic hyper-detailed realism, 8k resolution, cinematic photography, photorealistic, highly detailed fabric and skin textures."
