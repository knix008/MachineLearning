...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetic."

DEFAULT_FACE = "She has a fair complexion with completely soaking wet glistening skin, water droplets densely covering her face, neck, and chest, rivulets of water streaming down her skin. Wearing striking bright blue contact lenses contrasting with her dark hair. Long straight jet-black hair completely drenched and waterlogged, heavy wet strands clinging to her face, neck, and shoulders, dripping with water. Calm and elegant expression, lips closed in a soft gentle smile without opening the mouth, a quiet warm smile, looking directly toward the camera."

DEFAULT_POSE_HEAD = "Hair utterly soaked and dripping, heavy wet strands plastered to her face and neck."

DEFAULT_POSE_BODY = "Standing upright, body facing forward toward the camera, entire body soaking wet from head to toe, heavy rivulets of water streaming continuously down her neck, chest, torso, waist, hips, and legs, every inch of skin brilliantly reflecting bright sunlight, intense specular highlights blazing across her wet skin, ultra-realistic skin texture."
...
DEFAULT_POSE_FOOT = "Bare feet submerged in thick white ocean foam, an incoming wave breaking around her feet and ankles, dense bubbly sea foam completely engulfing her feet, frothy white bubbles swirling and foaming around her bare feet."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Transparent extremely tiny string sky blue bikini top with minimal coverage."

DEFAULT_BOTTOM = "Transparent extremely tiny string sky blue bikini bottom."
...
DEFAULT_SETTING = "Standing at the shoreline on the beach, ocean waves rolling in around her feet, wet sand beneath her, sea water foaming around her ankles."

DEFAULT_LIGHTING = "Blazing bright natural sunlight directly hitting her face and body, face brightly illuminated by direct sunlight, brilliant specular highlights blazing across every wet surface of her skin, water droplets sparkling like diamonds in the sun, intense light reflections shimmering on her glistening wet skin, radiant sunlit glow, warm daytime beach atmosphere."

DEFAULT_CAMERA = "Low angle full body shot from below, camera positioned at knee level looking up, elongated legs perspective, sharp focus, 8k high resolution, photorealistic, perfect anatomy."
