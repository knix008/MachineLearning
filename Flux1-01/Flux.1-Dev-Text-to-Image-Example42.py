...
# https://prompthero.com/prompt/206f8c8efb7-stable-diffusion-35-large-ultra-detailed-cinematic-portrait-of-a-hong-kong-female-cyborg-navy-and-white-metallic-limbs-partially-broken-revealing-internal-machinery

# Default values for each prompt section
DEFAULT_SUBJECT = "Ultra-detailed cinematic portrait of a beautiful young Korean female cyborg with soft idol aesthetics, navy and white metallic limbs partially broken revealing internal machinery, realistic skin texture and sharp facial and body features."
...
DEFAULT_POSE_BODY = "Mechanical complexity, navy and white metallic limbs with broken sections revealing internal machinery and circuitry beneath realistic skin."
...
DEFAULT_SETTING = "Clean white background with technical sketch lines and blueprint elements, sci-fi concept art style, futuristic technology."

DEFAULT_LIGHTING = "Dramatic lighting, sharp focus, cinematic depth."

DEFAULT_CAMERA = "8K resolution, ultra-high detail, hyper-realistic photorealism, sci-fi concept art style."
