...
DEFAULT_SUBJECT = "A professional full body portrait of an exceptionally beautiful young Korean woman with soft idol aesthetic."
...
DEFAULT_POSE_BODY = "Standing upright, body facing forward toward the camera, full body visible from head to toe."
...
DEFAULT_TOP = "Extremely tiny string light pink bikini top with minimal coverage."

DEFAULT_BOTTOM = "Tiny G-string thong light pink bikini bottom."
...
DEFAULT_SETTING = "Standing on the beach, ocean waves in the background."

DEFAULT_LIGHTING = "Diffused soft natural lighting, cinematic lighting atmosphere."

DEFAULT_CAMERA = "Full body shot, shallow depth of field, sharp focus, 8k, highly detailed, High detail RAW color art, hyper realism, masterpiece, perfect anatomy."
