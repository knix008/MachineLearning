...
# https://prompthero.com/prompt/f1e6902f273-flux-dev-a-highly-detailed-photorealistic-medium-shot-portrait-of-a-stunning-young-east-asian-woman-with-a-fit-athletic-physique-captured

# Default values for each prompt section
DEFAULT_SUBJECT = "Highly-detailed photorealistic medium-shot of a stunning sexy young East Asian woman with a fit, athletic physique, seductive and alluring presence, captured in a candid, intimate bedroom setting."

DEFAULT_FACE = "She has a fair complexion with wet glistening skin, entire body surface visibly damp and shiny, water droplets on skin, strong specular highlights reflecting light across her face, neck, shoulders, and exposed torso. She has long, straight jet-black hair. Her expression is soft and serene, eyes completely closed, lips lightly pressed together."

DEFAULT_POSE_HEAD = "Her face turned directly toward the camera with a gentle, alluring expression, while her body is angled sideways."

DEFAULT_POSE_BODY = "Body angled slightly sideways to the camera, back deeply arched with hips pushed out provocatively to one side, creating a dramatic S-curve silhouette that accentuates her narrow waist, full rounded hips, and the sensual sweep of her figure."

DEFAULT_POSE_ARM = "One arm raised above her head, the other arm reaching behind her back toward her hip."

DEFAULT_POSE_HAND = "The raised hand rests loosely above her head. The other hand is placed behind her hip."
...
DEFAULT_TOP = "Black long-sleeved cropped hoodie fully pulled up and bunched above her breasts, completely exposing her bare chest and her entire toned slender midriff and navel."

DEFAULT_BOTTOM = "Extremely tiny light pink panties."
...
DEFAULT_SETTING = "Plain light grey wall. In the immediate foreground, blurred white rumpled bed sheets are visible, grounding the scene in a bedroom environment."

DEFAULT_LIGHTING = "Soft diffused side lighting creating gentle shadows on the wall behind her, highlighting the definition of her abdominal muscles and the curve of her waist."

DEFAULT_CAMERA = "Raw high-resolution aesthetic, 8k, shot with a slight low angle to enhance the body curves, focusing on realistic anatomy and skin tones."
