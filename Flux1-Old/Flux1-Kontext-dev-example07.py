...
STYLE_PRESETS = {
    ...
    "📸 인물 - 최고 화질": {
        "prompt_prefix": "high noise reduction, ultra high quality portrait, 8k resolution, professional photography, perfect skin texture, natural lighting, detailed facial features, crystal clear, ultra detailed, masterpiece quality, professional grade",
        "guidance_scale": 4.8,
