...
DEFAULT_PROMPT = "A vertical ultra-realistic masterpiece photograph of a beautiful young woman with a short dark bob and bangs, posing behind sheer white translucent curtains. She is seen from a three-quarter back view, looking over her shoulder with an intimate expression. She is naked. Her arms are raised, gently holding the curtains. The scene is bathed in bright, soft, diffused natural light, creating a high-key, ethereal dreamy atmosphere with a subtle haze. High-fidelity skin textures, 8k resolution, cinematic boudoir photography, soft-focus background with faint white flowers, professional lighting, masterpiece. Key Stylistic Keywords: Photorealistic, boudoir photography, high-key lighting, soft-focus, sheer curtains, short bob hair, over-the-shoulder gaze, ethereal atmosphere, dreamlike, natural skin texture, 8k, masterpiece."
