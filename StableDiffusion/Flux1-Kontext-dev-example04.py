    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            prompt_input = gr.Textbox(
                ...
                value="blue bikini, blue eyes, beautiful face, good body shape, good hair, good fingers, good legs, photorealistic, 8k resolution, ultra detailed, vibrant colors, cinematic lighting, realistic shadows, high quality, masterpiece, best quality, perfect anatomy",
                lines=4,
            )
