...
# Outfit
DEFAULT_OUTFIT = "She is wearing a light blue sheer see-through one-piece dress, translucent fabric softly draping over her body. The dress has a deep side slit on one side that opens all the way up above the thigh, the slit parting wide to expose her bare thigh and hip. The high slit slightly reveals the edge of her tiny black panties. Underneath the sheer dress, she is wearing a very tiny black bra with minimal coverage and very small black panties, subtly visible through the translucent fabric and slightly peeking out from the high side slit."
