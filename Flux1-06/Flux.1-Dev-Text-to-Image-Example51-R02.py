...
LEG = "One leg straight bearing full body weight, opposite knee softly bent inward while the foot remains touching the other foot, subtle hip tilt accentuating curves, elegant S-curve silhouette."
...
BODY = "Body facing the camera, natural weight shift onto one supporting leg creating a gentle hip tilt, waist cinched, feminine curves accentuated, tall and elegant posture, graceful S-curve from shoulders to hips."
...
TOP = "Long pure white chiffon one-piece dress, thin spaghetti straps, bare shoulders, fully opaque, densely covered all-over floral print with many tiny miniature flowers in soft pink and white covering the entire fabric, fitted waist, flowing A-line skirt with a side slit revealing the bare leg, hem gently lifted by breeze."
...
NEGATIVE = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, staggered legs, walking pose, legs far apart, stepping, spread legs, wide stance, stiff pose, flat posture."
