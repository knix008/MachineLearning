...
DEFAULT_POSE_LEG = "One leg straight and weight-bearing, the other leg slightly bent at the knee, long slender legs clearly visible."

DEFAULT_LEGWEAR = ""

DEFAULT_POSE_FOOT = "Both feet together, flat on the floor."

DEFAULT_FOOTWEAR = (
    "Both feet together, flat on the floor, and standing on the floor with bare feet."
)
...
DEFAULT_CAMERA = "35mm lens, full body shot, low angle from hip height looking slightly upward, entire body from head to feet in frame, sharp focus, soft bokeh background."
