...
SUBJECT = "A portrait of a beautiful skinny young Korean woman with a soft idol aesthetic, wearing a white one-piece dress with a short blue ribbon necktie."
...
HEADWEAR = "She wears a white hairband."

TOP = "She wears a white one-piece dress with a short blue ribbon necktie at the collar, fitted bodice that accentuates her slim waist."

ARMWEAR = ""

BOTTOM = "The dress has a waist-cinched silhouette that creates an elegant hourglass shape, with a flowing skirt that falls gracefully."

LEGWEAR = "She is wearing sheer white thigh-high stockings that add a delicate and feminine touch to her legs, with a subtle sheen that catches the light."

FOOTWEAR = ""

HEAD = "Her head is very slightly tilted to one side with a gentle natural angle."

BODY = "Her body is facing directly towards the camera, with hips gently shifted to one side as weight rests on one leg, creating a pronounced S-curve silhouette that accentuates her waist."
...
LEG = "Most body weight is supported by one leg, with the other leg slightly bent at the knee and relaxed, creating a subtle natural curve that emphasizes the hip and waist line."

FOOT = ""

SETTING = "She stands in an indoor space with sky blue walls decorated with floral patterned wallpaper, windows with curtains in the background, furnished room with elegant furniture pieces arranged around the space."

CAMERA = "Photorealistic studio photography from camera position at waist level, balanced perspective showing full body from head to feet, cinematic soft focus with shallow depth of field, gentle background bokeh."

LIGHTING = "Strong powerful studio lighting illuminates the entire body from the front, creating a very bright high-key portrait with minimal shadows and even illumination from head to toe, full body well-lit."
