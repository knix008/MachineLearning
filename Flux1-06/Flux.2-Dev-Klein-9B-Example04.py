...
FOOT = "Both bare feet naturally positioned, toes clearly visible, both feet fully in frame at the bottom, standing directly on the indoor pool deck tiles."
...
SETTING = "Luxury hotel indoor swimming pool and spa area: calm turquoise water behind her, pale tiled deck, high ceiling, warm interior architecture, no outdoor sky visible, enclosed comfortable atmosphere."

LIGHTING = "Soft warm indoor ambient light with gentle highlights from ceiling fixtures and subtle reflections from the pool water, face and body evenly illuminated, mild shadow on the far side of the body to accentuate waist and hip curves, no harsh shadows on the face, natural skin tones preserved."

CAMERA = "Full body shot, slightly low angle looking upward to emphasize leg length, wide enough to capture entire body from head to feet, feet clearly visible at the bottom with extra space below, sharp focus on subject, softly blurred indoor pool and architecture behind her."
