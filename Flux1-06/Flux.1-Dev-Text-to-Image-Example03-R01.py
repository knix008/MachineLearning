...
DEFAULT_SUBJECT = "A beautiful young skinny Korean woman with a soft idol aesthetic, posing gracefully on a bright spring street in Seoul."
...
DEFAULT_POSE_BODY = "Standing perfectly still and upright, feet planted together on the ground, body facing straight toward the camera, chest and torso fully frontal, tall and elegant posture, shoulders back."

DEFAULT_POSE_ARM = "One arm hanging naturally at her side, the other arm bent with elbow out."

DEFAULT_POSE_HAND = "One hand hanging gracefully with fingers lightly extended, the other hand resting on her hip with fingers elegantly spread."

DEFAULT_POSE_LEG = "Both legs touching together, no gap between knees, side slit of skirt naturally parted revealing bare leg."

DEFAULT_POSE_FOOT = "Both feet firmly planted together side by side on the ground, toes pointing forward, white sneakers clearly shown, feet not cropped."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Dark navy chiffon one-piece dress with thin spaghetti straps, tiny cherry blossom print in soft pink and white, fitted waist, flowing A-line skirt with a side slit from the upper thigh revealing the bare leg."
...
DEFAULT_ARMWEAR = "Thin sheer white cardigan draped over her shoulders, translucent white fabric clearly revealing the skin and dress underneath, softly covering the shoulders and upper arms, loosely worn open at the front, delicate and lightweight."
...
DEFAULT_LIGHTING = "Bright even spring daylight, soft frontal natural light, face clearly lit, no harsh shadows."
...
DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, sharp focus, perfect anatomy, ten fingers, full body, head to toe."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, one leg forward, staggered legs, walking pose, weight shift, legs apart, stepping, feet apart, spread legs, gap between feet."
