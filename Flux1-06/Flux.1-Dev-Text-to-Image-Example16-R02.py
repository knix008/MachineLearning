...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman with a soft idol aesthetic standing beside a luxury hotel outdoor swimming pool, wearing a bikini, barefoot."

DEFAULT_FACE = "She has a fair, clear complexion. Her expression is innocent and curious, looking directly at the camera. She has long, voluminous wavy jet-black hair with beautiful soft waves and curls, dramatically flowing and billowing in the wind, strands sweeping through the air."
...
DEFAULT_POSE_ARM = "Both arms slightly bent at the elbow, hanging naturally down at her sides."
...
DEFAULT_LIGHTING = "Sun shining directly from the front onto the subject, bright frontal sunlight fully illuminating the face and body, subject facing the sun, face and body brightly lit, no shadows on the face, no backlight, natural skin tones preserved."
...
DEFAULT_POSITIVE_PROMPT = "8k, high quality, photorealistic, perfect anatomy, ten fingers, well formed fingers, well formed toes, ten toes, sharp focus, beautiful fingers, beautiful toes."
