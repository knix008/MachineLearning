...
DEFAULT_SUBJECT = "A beautiful young skinny Korean woman with a soft idol aesthetic."

DEFAULT_FACE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is calm and elegant, looking directly at the camera with a serene and confident gaze. She has long, voluminous straight jet-black hair softly flowing down."

DEFAULT_POSE_HEAD = "Head held upright, chin slightly lifted."

DEFAULT_POSE_BODY = "Standing upright in a refined model pose, chest and torso fully frontal toward the camera, hips shifted slightly to one side creating a subtle S-curve silhouette, elegant body line emphasized, shoulders naturally relaxed."

DEFAULT_POSE_ARM = "Both arms relaxed at her sides, one elbow softly bent."

DEFAULT_POSE_HAND = "One hand hanging gracefully with fingers lightly extended, the other hand lightly pinching the front hem of the cardigan with delicate fingers."

DEFAULT_POSE_LEG = "One leg slightly forward in a classic model stance, weight shifted to the back leg, legs fully stretched and elongated, visually long and slender leg line."

DEFAULT_POSE_FOOT = "Both feet clearly standing on stiletto high heels, heel tips visibly touching the ground, both shoes entirely in frame and not cropped."

DEFAULT_HEADWEAR = ""

DEFAULT_TOP = "Sleeveless fitted white silk slip dress with a subtle sheen, delicate lace trim along the neckline and hem, smooth and form-fitting."

DEFAULT_BOTTOM = ""

DEFAULT_LEGWEAR = "Bare legs, smooth and fair skin."

DEFAULT_FOOTWEAR = "Wearing ivory cream pointed-toe stiletto high heels, tall thin heel clearly visible, glossy surface."

DEFAULT_ARMWEAR = "Semi-transparent sheer ivory cardigan loosely draped over the shoulders only, not worn through the sleeves, hanging open at the front, delicate thin knit fabric with a soft translucent quality."

DEFAULT_SETTING = "Gyeonghoeru Pavilion in Gyeongbokgung Palace, Seoul, traditional Korean stone columns and iconic wooden pavilion structure reflected in the calm rectangular lotus pond, lush green trees, clear blue sky."

DEFAULT_LIGHTING = "Golden hour afternoon light, warm soft sunlight from the side, gentle glow on the face and hair, pavilion softly lit in the background."

DEFAULT_CAMERA = "Full body shot, entire body from head to feet fully in frame, slight low angle to emphasize leg length, sharp focus on the subject, soft bokeh on the background pavilion."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, realistic, detailed, perfect anatomy, ten fingers."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, extra toes, cardigan worn through sleeves, arms inside cardigan sleeves, jacket on arms, sleeves covering arms, barefoot, flat shoes, sneakers, sandals, boots, feet cropped, shoes cropped."
