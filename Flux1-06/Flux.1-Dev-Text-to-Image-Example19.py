...
DEFAULT_SUBJECT = "Full body photography of a beautiful young skinny Korean woman standing on a city street, wearing light casual everyday clothes, carrying a black backpack slung over one shoulder."
...
DEFAULT_POSE_LEG = "Standing naturally, one leg straight, the other slightly relaxed, full leg line visible from hip to ankle."

DEFAULT_LEGWEAR = ""

DEFAULT_POSE_FOOT = "Both feet clearly visible at the bottom of the frame, shoes fully shown without cropping, standing still on pavement."

DEFAULT_FOOTWEAR = "Wearing clean white sneakers and white ankle socks, both shoes completely visible and clearly rendered."

DEFAULT_POSE_ARM = "One shoulder raised slightly with a black backpack strap over it, the other arm relaxed at her side."

DEFAULT_ARMWEAR = "Black backpack slung casually over one shoulder, sleek and compact, strap visible across the chest."

DEFAULT_POSE_HAND = "One hand gripping the backpack strap near the chest, the other hand loosely relaxed and hanging naturally at her side."

DEFAULT_POSE_BODY = "Three-quarter angle toward the camera, standing upright, hips slightly tilted, feminine silhouette, relaxed and effortless."

DEFAULT_TOP = "Wearing a thin loose light blue long-sleeve shirt, slightly translucent fabric, top button undone, all remaining buttons fastened, sleeves casually rolled up to the elbows, front hem tucked into the skirt waistband, back hem left untucked and hanging loosely, relaxed oversized fit, shirt is fully buttoned and closed, dark bralette outline very faintly visible through the shirt fabric only, underwear completely covered by the shirt at all times, casual and feminine."

DEFAULT_BOTTOM = "Wearing a denim mini skirt, very short, light blue wash, casual and feminine."

DEFAULT_SETTING = "Sunny city street, clean urban sidewalk, bright daylight, modern storefronts in the background, lively and pleasant street atmosphere."

DEFAULT_LIGHTING = "Bright natural daylight, soft even outdoor illumination, face and body evenly lit, warm sunlight, natural skin tones."

DEFAULT_CAMERA = "50mm lens, full body shot, camera at waist height, entire body from head to shoes fully in frame, shoes clearly visible at the bottom, sharp focus throughout, no depth of field blur."

DEFAULT_POSITIVE_PROMPT = "8k, high quality, photorealistic, perfect anatomy, ten fingers, sharp focus, highly detailed."

DEFAULT_NEGATIVE_PROMPT = "Blurry, low quality, deformed, bad anatomy, extra limbs, ugly, watermark, text, signature, extra fingers, feet cropped, shoes cropped, barefoot, missing shoes."
