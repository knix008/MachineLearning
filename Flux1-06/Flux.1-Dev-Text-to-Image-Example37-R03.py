...
DEFAULT_SUBJECT = "A full body photography of a beautiful skinny young Korean woman standing by a luxury hotel swimming pool wearing a thong bikini, bare feet on the poolside deck."

DEFAULT_POSE_FOOT = "Both feet together, side by side, flat on the poolside deck, bare feet."

DEFAULT_POSE_LEG = "Both legs straight and close together, standing upright, long slender legs clearly visible."
...
DEFAULT_POSE_BODY = "Body facing slightly to the side at a subtle angle, standing still, hip shifted slightly to one side, posture upright and confident."

DEFAULT_POSE_ARM = "Both arms relaxed and hanging naturally at the sides."

DEFAULT_POSE_HAND = "Both hands relaxed with fingers lightly extended, hanging naturally at the sides."
...
DEFAULT_POSE_HEAD = "Head held upright, tilted very slightly."
