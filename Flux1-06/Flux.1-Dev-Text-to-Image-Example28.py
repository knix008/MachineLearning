...
DEFAULT_SUBJECT = "A full body photography of a beautiful young skinny Korean woman standing in a bright modern airport departure hall, ready to travel, with a carry-on suitcase beside her."

DEFAULT_FACE = "She has a fair, clear complexion and a slim oval-shaped face with a delicate narrow jawline, high cheekbones, and a softly pointed chin. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is gentle with a soft closed-mouth smile, lips lightly pressed together with a subtle upward curve, looking directly at the camera. She has long, voluminous straight jet-black hair, all swept fully back behind her shoulders, not covering the shoulders at all."

DEFAULT_POSE_HEAD = "Head held upright with elegant posture, all hair swept fully back behind the shoulders, shoulders completely exposed and unobstructed."
...
DEFAULT_POSE_FOOT = "Both feet side by side, parallel to each other, toes pointing forward, sneakers clearly shown, feet fully in frame."

DEFAULT_FOOTWEAR = "Clean white canvas sneakers."

DEFAULT_POSE_ARM = "One arm relaxed at her side, the other arm extended downward gripping the handle of a carry-on suitcase standing beside her."

DEFAULT_ARMWEAR = ""

DEFAULT_POSE_HAND = "One hand relaxed at her side with fingers lightly extended, the other hand gripping the suitcase handle naturally."

DEFAULT_POSE_BODY = "Standing upright, body fully facing the camera, torso frontal, posture tall and elegant."

DEFAULT_TOP = "Casual chic travel outfit, light beige oversized blazer over a simple white fitted top, bare collarbone, relaxed and stylish."

DEFAULT_BOTTOM = "High-waisted light blue denim shorts, fitted at the waist, short hemline showing bare legs."

DEFAULT_SETTING = "Bright modern airport departure hall, large glass windows with aircraft visible outside, clean polished floor, departure boards in the background, a sleek navy carry-on suitcase standing upright beside her."

DEFAULT_LIGHTING = "Bright indoor airport lighting, soft even light, face clearly and brightly lit, no harsh shadows."
