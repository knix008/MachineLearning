...
DEFAULT_SUBJECT = "A full body photography of a beautiful skinny young Korean woman walking along a sunny beach wearing a thong bikini, bare feet on the sand."

DEFAULT_POSE_FOOT = "One foot stepping forward, the other foot behind, natural relaxed walking stride on the sand, bare feet."

DEFAULT_POSE_LEG = "Walking pose, one leg stepping forward, the other leg behind, long slender legs clearly visible."

DEFAULT_FACE = "She has a fair, clear complexion and a slim oval-shaped face with a delicate narrow jawline, high cheekbones, and a softly pointed chin. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is cheerful and relaxed, smiling softly, looking slightly toward the camera. She has long straight jet-black hair flowing freely in the sea breeze."

DEFAULT_POSE_BODY = "Body facing slightly to the side in a natural relaxed walking posture, hip swaying naturally with each step, confident and carefree movement."

DEFAULT_POSE_ARM = "Both arms swinging naturally at the sides in a relaxed walking motion."

DEFAULT_POSE_HAND = "Both hands relaxed with fingers lightly extended, swinging naturally at the sides."

DEFAULT_FOOTWEAR = ""

DEFAULT_LEGWEAR = ""

DEFAULT_BOTTOM = "Wearing a tiny white thong bikini bottom, minimal coverage, bare hips fully exposed, string ties at the hips."

DEFAULT_TOP = "Wearing a tiny white triangle bikini top, minimal coverage, thin string ties at the neck and back, bare midriff fully exposed."

DEFAULT_HEADWEAR = ""

DEFAULT_ARMWEAR = ""

DEFAULT_POSE_HEAD = "Head held upright, tilted very slightly, glancing toward the camera with a relaxed smile."
...
DEFAULT_SETTING = "Dazzling sunny beach, bright white sand, clear turquoise ocean water, gentle waves, clear blue sky, warm summer day."
