...
SUBJECT = "A full body photograph of a beautiful slim young Korean woman standing beside a swimming pool, wearing a very small red bikini swimsuit, body facing almost directly forward with only a very slight side turn, with bare feet."
...
BOTTOM = "Very tiny red thong bikini swimsuit with a clean minimal design and smooth stretch fabric with minimal coverage."

TOP = "Very tiny red triangle bikini top with a clean minimal design and smooth stretch fabric with minimal coverage."
...
SETTING = "Outdoor luxury swimming poolside, clear blue pool water nearby, bright summer daylight, soft reflections on the water surface."

CAMERA = "35mm lens, entire figure from head to feet in frame with both feet clearly visible near the bottom of the frame, camera positioned at waist level and below head level, slight upward perspective to lengthen the legs, tack sharp focus."

POSITIVE = "8k, high quality, photorealistic, perfect anatomy, ten fingers, natural skin texture, ten toes, beautiful toes."
