...
# Prefer the clone's uv_unwrapper over any same-named package on PyPI / stale site-packages.
_repo_uv_root = Path(__file__).resolve().parents[2] / "uv_unwrapper"
if _repo_uv_root.is_dir():
    _rp = str(_repo_uv_root)
