...
DEFAULT_QUALITY = "8k resolution, cinematic soft focus, gravure photography style, photorealistic, high quality"
DEFAULT_ANATOMY = "Perfect anatomy, five fingers."
DEFAULT_SUBJECT = "A photorealistic, high-quality cosplay portrait of a young Korean woman with a soft, idol aesthetic, dressed in a blue and white bunny girl outfit."
...
DEFAULT_OUTFIT = "She wears a very small, minimal light pink triangle string bra with extremely thin spaghetti straps and matching light pink micro string panties (thong). She wears tall, upright blue fabric bunny ears with white inner lining and a delicate white headband base, accented with a small white bow. Around her neck is a blue bow tie attached to a white collar. She wears long, white mesh fingerless arm sleeves that extend past her elbows, finished with blue cuffs and small black decorative ribbons. She wears white mesh stockings held up by blue and white ruffled garters adorned with small white bows."
DEFAULT_POSE = "High-kneeling pose: both knees resting on the floor, thighs vertical and perpendicular to the ground, body held tall and upright as if standing but on her knees. The lower legs (shins) are flat behind her, tops of the feet on the floor. Body and torso fully facing the camera directly. Upper body fully upright and straight. Confident and alluring expression directed straight at the camera. Both arms raised, both hands placed behind her head with fingers interlaced, elbows pointing outward to the sides. Hips slightly tilted forward in a sexy, confident pose. Full body visible from head to knees. Glamorous, alluring model pose with sensual energy."
DEFAULT_SETTING = "Minimalist studio setting with a deep dark navy blue solid background. The background is a rich, dark saturated blue color. Softly blurred background (bokeh). The dark blue color applies strictly to the background only and does not affect the subject or outfit colors."
DEFAULT_LIGHTING = ""
DEFAULT_CAMERA = "Portrait composition, full body shot. Sharp focus on face and outfit details. Shallow depth of field, soft bokeh background. Professional studio photography. Shot with an 85mm lens."
...
def combine_prompt_sections(
    quality, anatomy, subject, appearance, outfit, pose, setting, lighting, camera
):
    """Combine separate prompt sections into one final prompt string."""
    sections = [quality, anatomy, subject, appearance, outfit, pose, setting, lighting, camera]
