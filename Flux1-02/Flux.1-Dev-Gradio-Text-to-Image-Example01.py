...
# Outfit
DEFAULT_OUTFIT = "She is wearing only a white bra and white panties, nothing else. A simple white bra covering her chest and matching white panties. Clean white fabric with subtle lace trim detailing. No other clothing, no stockings, no accessories."

# Pose & Action
DEFAULT_POSE = "She is lying flat on a white bed, fully relaxed natural pose. One arm extended naturally straight down along her side, hand resting loosely beside her thigh on the bed. The other arm bent slightly upward, with the index finger of that hand gently and lightly touching her lips in a soft playful gesture. One leg extended straight, the other leg slightly bent at the knee in a natural relaxed position. Entire full body visible from head to toe within the frame, nothing cropped out. Looking up at the camera above."
...
# Anatomy
DEFAULT_ANATOMY = "Perfect anatomy, no extra finger, no missing fingers, no deformed or fused fingers, perfect hand structure, perfect feet structure, perfect body proportion, no extra hands, no extra feet, no distorted body."
