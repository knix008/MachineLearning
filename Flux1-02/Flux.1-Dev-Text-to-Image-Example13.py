...
DEFAULT_SUBJECT = "A photorealistic gravure-style full-body portrait of a beautiful young skinny Korean woman model with a soft, idol aesthetic, wearing a black school shoes on her feet."

DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is soft and gentle, with a subtle, warm smile on her lips, looking directly at the camera. She has long, wavy jet-black hair with thick, straight-cut bangs (fringe) that frame her face."

DEFAULT_POSE = "She is standing naturally facing forward in a bright white room, with her entire body fully visible from head to toe. One arm is relaxed and lowered by her side near her thigh, while the other hand gently holds the end of her loose, flowing hair. Her posture is upright and relaxed, with a gentle, calm expression, looking directly at the camera. She exudes elegance and confidence in a natural way."

DEFAULT_OUTFIT = "She is wearing a classic Korean school uniform: a crisp white blouse with a small necktie, and a short pleated navy skirt. She is also wearing white stockings and black student shoes. Her look is neat and elegant, perfectly embodying the schoolgirl aesthetic."
