...
DEFAULT_QUALITY = ""
DEFAULT_NEGATIVE = "Perfect anatomy, Five fingers, five toes. perfect body structure."
...
DEFAULT_OUTFIT = "Wearing a very small pale pink bra and matching panties. The bra has thin shoulder straps and a simple band, no knots, no ties, no bows. The panties are very small and minimal with thin side straps, extremely low-rise. Plain smooth fabric, no lace, no decorations, no knots. Clean and simple design."
DEFAULT_POSE = "Lying sideways on a sunbed, body fully extended horizontally, both legs stretched out completely straight and elongated. Facing toward the camera. Upper body propped up slightly, resting on one elbow with the hand supporting the head. The other arm resting languidly along the body or draped over the hip. Back arched subtly, chest forward. Sultry heavy-lidded gaze directly into the camera, lips softly parted. Seductive and relaxed beach model pose."
DEFAULT_SETTING = "Sunny beach setting. A white or light-colored sunbed lounger on the sandy beach. Bright blue sea and sky visible in the background. Soft white sand around the sunbed. Tropical beach atmosphere with gentle waves in the distance."
DEFAULT_LIGHTING = "Bright natural sunlight with warm golden tones. Sun illuminating the scene from above creating a sun-kissed glow on the skin. Soft natural shadows. Bright, airy, and warm beach atmosphere."
DEFAULT_CAMERA = "Horizontal landscape composition, full body shot showing the entire figure from head to toe. Camera positioned at sunbed level, pointing straight toward the subject. Sharp focus across the full body. Shot with a 50mm lens."
