...
DEFAULT_SUBJECT = "A photorealistic gravure-style full-body portrait of a beautiful young skinny Korean woman model with a soft, idol aesthetic."
...
DEFAULT_POSE = "She is standing naturally facing forward in a bright white room. One arm is relaxed and lowered by her side near her leg, while the other hand gently holds the end of her loose, flowing hair. Her posture is upright and relaxed, with a gentle, calm expression, looking directly at the camera. She exudes elegance and confidence in a natural way."

DEFAULT_OUTFIT = "She is wearing a very tiny black sheer mesh bra, nearly see-through with minimal coverage. Paired with a very tiny black sheer mesh thong panty in matching fishnet fabric, with thin straps sitting high on her waist. Black fishnet thigh-high stockings with tops complete the look."
...
DEFAULT_CAMERA = "85mm telephoto, chest-level shot, tack-sharp focus on subject, soft bokeh background."
