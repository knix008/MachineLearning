...
DEFAULT_QUALITY = ""
DEFAULT_ANATOMY = "Perfect anatomy,  five fingers, five toes. no missing fingers, no extra fingers, no deformed fingers."
DEFAULT_SUBJECT = "The image is a high-quality, photorealistic portrait of a young Korean woman with a soft, idol aesthetic, standing on a bright sunny beach in a confident fashion model pose."
DEFAULT_APPEARANCE = "She has a fair, clear complexion. She is wearing striking bright blue contact lenses that contrast with her dark hair. Her expression is innocent and curious, looking directly at the camera. She has long, wavy jet-black hair dramatically tossed and swept by the sea wind, strands flying dynamically in the breeze."
DEFAULT_OUTFIT = "Wearing a simple string light pink bikini with minimal coverage. Her skin is smooth and glowing with natural warmth, lightly dusted with fine sand."
DEFAULT_POSE = "Standing upright on the beach in a confident fashion model pose. Weight shifted onto one leg, hip slightly tilted. One hand raised, fingers gently touching her hair. The other arm hanging naturally and relaxed at her side. Full body visible from head to toe. Looking directly at the camera with a serene expression."
DEFAULT_SETTING = "Bright sunny beach at midday. Clear blue ocean with gentle waves in the background. White sandy beach surface. Vibrant, cheerful summer atmosphere."
DEFAULT_LIGHTING = "Bright natural sunlight from above. Clear blue sky, vivid and cheerful daytime lighting. Fresh, energetic, and uplifting atmosphere with vibrant color grading."
DEFAULT_CAMERA = "Eye-level camera angle. Wide full body shot from a distance, entire figure from feet to head fully visible with nothing cropped. Sharp focus across the full body. Professional photography. Shot with a 24mm wide-angle lens."
